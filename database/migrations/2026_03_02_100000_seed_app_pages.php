    ...
    public function up(): void
    {
        $pages = [
            [
                ...
                'title' => 'Eventos',
                'data'  => json_encode([
                    'seo_title'       => 'Próximos Eventos - SOMOS UNN',
                    'seo_description' => 'Confira os próximos eventos SOMOS UNN e não perca a chance de expandir sua rede.',
                    'hero_title'      => 'Próximo Evento SOMOS UNN',
            ...
            [
                ...
                'title' => 'Membros',
                'data'  => json_encode([
                    'seo_title'       => 'Membros - SOMOS UNN',
                    'seo_description' => 'Conheça os empreendedores da comunidade SOMOS UNN.',
                    'hero_title'      => 'Membros SOMOS UNN',
            ...
            [
                ...
                'data'  => json_encode([
                    'seo_title'       => 'Oportunidades de Carreira - SOMOS UNN',
                    'seo_description' => 'Encontre vagas e oportunidades exclusivas para impulsionar sua carreira na SOMOS UNN.',
                    'hero_title'      => 'Descubra seu próximo passo na SOMOS UNN Startups',
            ...
            [
                ...
                'data'  => json_encode([
                    ...
                    'seo_description' => 'Domine as habilidades que transformam mercados com os cursos da SOMOS UNN Academy.',

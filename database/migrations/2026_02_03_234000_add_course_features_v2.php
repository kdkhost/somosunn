...
return new class extends Migration
{
    ...
    {
        Schema::table('courses', function (Blueprint $table) {
            if (Schema::hasColumn('courses', 'is_featured')) $table->dropColumn('is_featured');
            if (Schema::hasColumn('courses', 'certificate_settings')) $table->dropColumn('certificate_settings');
        });

        Schema::table('lessons', function (Blueprint $table) {
            if (Schema::hasColumn('lessons', 'duration')) $table->dropColumn('duration');
        });
    }
};

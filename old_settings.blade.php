...
@section('page_title', 'Configura├º├Áes')
@section('breadcrumb')<li class="breadcrumb-item active">Configura├º├Áes</li>@endsection
        ...
        <div class="card-header p-0 border-bottom-0">
            <ul class="nav nav-tabs" role="tablist">
                ...
                <li class="nav-item"><a class="nav-link" data-toggle="pill" href="#tab-appearance"
                        role="tab">Apar├¬ncia</a></li>
                <li class="nav-item"><a class="nav-link" data-toggle="pill" href="#tab-video" role="tab">V├¡deo
                        Player</a></li>
        ...
        <div class="card-body">
            <div class="tab-content">
                ...
                <div class="tab-pane fade show active" id="tab-geral" role="tabpanel">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group"><label>Endere├ºo</label><input name="company_address"
                                    class="form-control" value="{{ $settings['company_address'] ?? '' }}"></div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group"><label>N├║mero</label><input id="company_number"
                    ...
                    <div class="row mt-3">
                        ...
                        <div class="col-md-4">
                            <label>Logo p├íginas de login/registro</label>
                    ...
                    <div class="row mt-3">
                        <div class="col-md-6">
                            <label>Marca d'├ígua (v├¡deos de cursos)</label>
                    ...
                    <div class="card card-outline card-secondary collapsed-card">
                        <div class="card-header">
                            <h3 class="card-title"><i class="fas fa-shield-alt mr-2"></i>Seguran├ºa (reCAPTCHA v3)</h3>
                        ...
                        <div class="card-body" style="display: none;">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label>Score m├¡nimo (0.0ÔÇô1.0)</label>
                                        <input name="recaptcha_v3_min_score" class="form-control"
                                            ...
                                            placeholder="0.5">
                                        <small class="text-muted">Recomendado: 0.5. Quanto maior, mais r├¡gido.</small>
                                    </div>
                                </div>
                                <div class="col-md-8">
                                    <div class="alert alert-light border mb-0">
                                        <div class="small text-muted">
                                            Usado principalmente em formul├írios p├║blicos (ex.: <code>/contato</code>).
                                            Se ficar vazio, o sistema usa as vari├íveis do <code>.env</code>.
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="card card-outline card-info collapsed-card">
                        <div class="card-header">
                            <h3 class="card-title"><i class="fas fa-cloud mr-2"></i>Armazenamento (S3 compat├¡vel)</h3>
                            <div class="card-tools d-flex align-items-center">
                                <span
                        ...
                        <div class="card-body" style="display: none;">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label>Disco para uploads (v├¡deos/documentos)</label>
                                ...
                                <div class="col-md-8">
                                    <div class="alert alert-light border mb-0">
                                        <div class="small text-muted">
                                            Compat├¡vel com AWS S3, Wasabi, DigitalOcean Spaces, MinIO etc. Para S3
                                            ÔÇ£compat├¡velÔÇØ, preencha <strong>Endpoint</strong> e marque
                                            <strong>Path-style</strong> se necess├írio.
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label>URL p├║blica/CDN (opcional)</label>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <small class="text-muted">Separar por v├¡rgula. Ex:
                ...
                <div class="tab-pane fade" id="tab-appearance" role="tabpanel">
                    <h5 class="text-primary mb-3"><i class="fas fa-home mr-2"></i>Hero (P├ígina Inicial)</h5>
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Opacidade do Degrad├¬ (%)</label>
                                ...
                                <small class="text-muted">Opacidade da camada de degrad├¬ sobre a imagem de fundo
                                    (0-100%).</small>
                            </div>
                            <div class="form-group">
                                <label>Cor do Degrad├¬ (In├¡cio)</label>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label>Intensidade da Pel├¡cula (<span
                        ...
                        <div class="col-md-4">
                            <div class="alert alert-info">
                                <div class="small">
                                    ...
                                    Essas configura├º├Áes afetam as p├íginas de detalhes de <strong>Eventos</strong> e
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Cor Prim├íria (Bot├Áes, Destaques)</label>
                                <div class="input-group colorpicker-element">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Cor Secund├íria (Backgrounds, Detalhes)</label>
                                <div class="input-group colorpicker-element">
                    ...
                    <h5 class="text-primary mb-3"><i class="fas fa-shoe-prints mr-2"></i>Rodap├®</h5>
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label>Texto do Rodap├® (Sobre)</label>
                ...
                <div class="tab-pane fade show active" id="tab-video" role="tabpanel">
                    <h5 class="text-primary mb-3"><i class="fas fa-play-circle mr-2"></i>Player de V├¡deo (Plyr)</h5>

                    <div class="alert alert-info">
                        Configure o player de v├¡deo usado nas aulas/cursos. As op├º├Áes avan├ºadas aceitam o JSON de configura├º├úo do Plyr (qualquer op├º├úo suportada pela biblioteca).
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <small class="text-muted">Define a cor dos bot├Áes/controles (CSS:
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <small class="text-muted">Tempo de avan├ºo/retrocesso nos atalhos.</small>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="custom-control custom-switch custom-switch-off-danger custom-switch-on-success mt-2">
                                ...
                                <label class="custom-control-label" for="video_plyr_disable_context_menu">Bloquear menu do bot├úo direito</label>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row mt-3">
                        <div class="col-md-3">
                            <div class="custom-control custom-switch custom-switch-off-danger custom-switch-on-success">
                                ...
                                <label class="custom-control-label" for="video_plyr_rewind_enabled">Bot├úo Retroceder</label>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="custom-control custom-switch custom-switch-off-danger custom-switch-on-success">
                                ...
                                <label class="custom-control-label" for="video_plyr_fast_forward_enabled">Bot├úo Avan├ºar</label>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="custom-control custom-switch custom-switch-off-danger custom-switch-on-success">
                    ...
                    <div class="row mt-3">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Controles (separados por v├¡rgula)</label>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Menu ÔÇ£Configura├º├ÁesÔÇØ (separado por v├¡rgula)</label>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Velocidades dispon├¡veis (separadas por v├¡rgula)</label>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Velocidade padr├úo</label>
                    ...
                    <div class="form-group">
                        <label>Op├º├Áes avan├ºadas (JSON)</label>
                        ...
                        <small class="text-muted">Se preenchido, o JSON ser├í mesclado ├ás op├º├Áes acima (o JSON tem prioridade).</small>
                    </div>

                    <hr>

                    <h5 class="text-primary mb-3"><i class="fas fa-water mr-2"></i>Marca d'├ígua (Cursos)</h5>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="custom-control custom-switch custom-switch-off-danger custom-switch-on-success mb-3">
                                ...
                                <label class="custom-control-label" for="video_watermark_enabled">Exibir marca d'├ígua no player</label>
                            </div>

                            @if($watermarkUrl)
                                <div class="mb-2">
                                    <img src="{{ $watermarkUrl }}" alt="Marca d'├ígua"
                                        style="max-height: 72px; max-width: 240px;">
                                </div>
                            @else
                                <p class="text-muted mb-2">Nenhuma imagem configurada. Envie em <strong>Geral</strong> ÔåÆ ÔÇ£Marca d'├ígua (v├¡deos de cursos)ÔÇØ.</p>
                            @endif
                        </div>
                        <div class="col-md-6">
                            <div class="custom-control custom-switch custom-switch-off-danger custom-switch-on-success mb-2">
                                ...
                                <label class="custom-control-label" for="video_watermark_text_enabled">Exibir texto din├ómico (anti-pirataria)</label>
                            </div>
                            <div class="form-group">
                                <label>Template do texto</label>
                                <input name="video_watermark_text_template" class="form-control"
                                    value="{{ $settings['video_watermark_text_template'] ?? '{name} ÔÇó {email} ÔÇó #{id}' }}">
                    ...
                    <h5 class="mb-3"><i class="fas fa-bullhorn mr-1"></i> An├║ncios da comunidade</h5>
                    <div class="custom-control custom-switch custom-switch-off-danger custom-switch-on-success mb-2">
                        ...
                        <label class="custom-control-label" for="ads_enabled">Exibir an├║ncios entre postagens</label>
                    </div>
                        ...
                        <div class="card-body">
                            <div class="alert alert-info">
                                ...
                                <ol class="pl-3 mb-0 mt-2 small">
                                    ...
                                    <li>Adicione seu site e aguarde aprova├º├úo.</li>
                                    <li>Crie um bloco de an├║ncios (Display, Feed ou In-article).</li>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <small class="text-muted">Come├ºa com <code>ca-pub-</code></small>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <small class="text-muted">N├║mero do bloco de an├║ncios.</small>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Formato do an├║ncio</label>
                                        <select name="adsense_format" class="form-control">
                                            @php($adsFormat = $settings['adsense_format'] ?? 'auto')
                                            <option value="auto" {{ $adsFormat === 'auto' ? 'selected' : '' }}>Autom├ítico (responsivo)</option>
                                            <option value="fluid" {{ $adsFormat === 'fluid' ? 'selected' : '' }}>Fluido (in-feed)</option>
                                            <option value="rectangle" {{ $adsFormat === 'rectangle' ? 'selected' : '' }}>Ret├óngulo</option>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Posi├º├úo dos an├║ncios</label>
                    ...
                    <div class="form-group">
                        <label>C├│digo HTML/JS personalizado (opcional)</label>
                        <textarea name="ads_code_html" class="form-control" rows="6"
                            placeholder="Cole aqui c├│digo personalizado se n├úo usar AdSense acima">{{ $settings['ads_code_html'] ?? '' }}</textarea>
                        <small class="text-muted">Se preferir, cole c├│digo de outras redes de an├║ncios. Se configurar o AdSense acima, este campo ├® opcional.</small>
                    </div>

                    <hr>

                    <h5 class="mb-3"><i class="fas fa-chart-line mr-1"></i> C├│digos de rastreamento</h5>
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>C├│digo no &lt;head&gt; (GA/GTM/meta pixels)</label>
                                ...
                                <small class="text-muted">Inserido no <code>&lt;head&gt;</code> do site p├║blico.</small>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>C├│digo no &lt;body&gt; (ex.: GTM noscript)</label>
                                <textarea name="tracking_body" class="form-control" rows="6"
                                    placeholder="Cole aqui trechos para o in├¡cio/final do BODY">{{ $settings['tracking_body'] ?? '' }}</textarea>
                                <small class="text-muted">Inserido no <code>&lt;body&gt;</code> do site p├║blico.</small>
                            </div>
                        </div>
                    </div>
                </div>
                
                {{-- Placeholders para abas ausentes (restaura├º├úo posterior do conte├║do completo) --}}
                ...
                <div class="tab-pane fade" id="tab-gateway" role="tabpanel">
                    ...
                    <p class="text-muted">Configure credenciais e op├º├Áes dos gateways suportados (MercadoPago, PagSeguro, etc.).</p>
                    <div class="row">
                        <div class="col-md-6 form-group">
                    ...
                    <small class="text-muted">Se precisar adicionar outros gateways, eu ajusto os campos conforme integra├º├úo existente.</small>
                </div>
                ...
                <div class="tab-pane fade" id="tab-smtp" role="tabpanel">
                    ...
                    <div class="form-group text-right">
                        <button type="button" id="btnTestSmtp" class="btn btn-outline-primary">Testar conex├úo SMTP</button>
                    </div>
                </div>

...
class CompanyController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('panel.admin.companies.index', compact('companies'));
    }

    public function create()
    {
        return view('panel.admin.companies.form', [
            'company' => new Company(),
    ...
    public function store(CompanyRequest $request)
    {
        ...
        return redirect()
            ->route('panel.admin.companies.edit', $company)
    ...
    public function destroy(Company $company)
    {
        ...
        return redirect()
            ->route('panel.admin.companies.index')

...
class SponsorBannerController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('panel.admin.sponsors.banners.index', compact('banners'));
    }

    public function create()
    {
        return view('panel.admin.sponsors.banners.form', [
    ...
    public function store(SponsorBannerRequest $request)
    {
        ...
        return redirect()
            ->route('panel.admin.sponsor-banners.edit', $banner)
    ...
    public function destroy(SponsorBanner $sponsorBanner)
    {
        ...
        return redirect()
            ->route('panel.admin.sponsor-banners.index')

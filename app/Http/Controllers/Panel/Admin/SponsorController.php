...
class SponsorController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('panel.admin.sponsors.index', compact('sponsors'));
    }

    public function create()
    {
        return view('panel.admin.sponsors.form', [
            'sponsor' => new Sponsor(),
    ...
    public function store(SponsorRequest $request)
    {
        ...
        return redirect()
            ->route('panel.admin.sponsors.edit', $sponsor)
    ...
    public function destroy(Sponsor $sponsor)
    {
        ...
        return redirect()
            ->route('panel.admin.sponsors.index')

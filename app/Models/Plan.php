...
class Plan extends Model
{
    ...
    public const FEATURE_LABELS = [
        ...
        'admin.events.coupons.view' => 'Ver cupons de gratuidade de eventos',
        'admin.events.coupons.create' => 'Criar cupons de gratuidade de eventos',
        'admin.events.coupons.edit' => 'Editar cupons de gratuidade de eventos',
        'admin.events.coupons.delete' => 'Excluir cupons de gratuidade de eventos',
        'admin.events.coupons.toggle' => 'Ativar cupons de gratuidade de eventos',

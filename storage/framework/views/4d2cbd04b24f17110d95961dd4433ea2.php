...
<style>
    ...
    .layout-navbar-fixed .wrapper .content-wrapper{
        ...
        padding-top:calc(var(--main-header-height))!important;
    }
...
<body class="hold-transition sidebar-mini layout-fixed layout-navbar-fixed <?php echo e($siteTheme === 'dark' ? 'dark-mode' : ''); ?>">
<div class="wrapper">
...
<script>
    ...
    $(document).on('click','.btn-delete', function(e){
        ...
        Swal.fire({title:'Excluir?', text:'Confirme para apagar definitivamente.', icon:'warning', showCancelButton:true, confirmButtonText:'Sim, excluir', cancelButtonText:'Cancelar'})
            .then((result)=>{ if(result.isConfirmed){ $.post(url, {_method:'DELETE', _token:'<?php echo e(csrf_token()); ?>'}, ()=>{ toastr.success('Excluído'); $.pjax.reload(container);}); }});
    });
...
<?php /**PATH /home/somosunn/public_html/resources/views/admin/layouts/app.blade.php ENDPATH**/ ?>
...
<?php $__env->startSection('page_title', 'Meu Perfil'); ?>
...
<div class="row justify-content-center">
        ...
        <div class="card card-primary card-outline">
            <div class="card-body box-profile">
                <div class="text-center mb-3" id="profile-photo-preview">
                    <?php if($user->photo): ?>
                        <img class="profile-user-img img-fluid img-circle" src="<?php echo e(asset($user->photo)); ?>" alt="Avatar" id="current-photo" style="width: 100px; height: 100px; object-fit: cover;">
                    <?php else: ?>
                ...
                <p class="text-muted text-center">
                    <?php echo e($user->role === 'superadmin' ? 'Super Administrador' : ($user->role === 'admin' ? 'Administrador' : 'Membro')); ?>

                </p>

                <ul class="list-group list-group-unbordered mb-3">
                    <li class="list-group-item">
                        <b>Pontos</b> <a class="float-right"><?php echo e(number_format($user->points ?? 0, 0, ',', '.')); ?></a>
                    </li>
                    <li class="list-group-item">
                        <b>Nível</b> <a class="float-right badge badge-info"><?php echo e(ucfirst($user->level ?? 'Iniciante')); ?></a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <div class="col-md-9">
        <div class="card">
            ...
            <div class="card-body">
                <form class="ajax-form" method="POST" action="<?php echo e(route('admin.profile.update')); ?>" enctype="multipart/form-data" id="profile-form">
                    <?php echo csrf_field(); ?>
                    <div class="tab-content" id="profileTabsContent">
                        ...
                        <div class="tab-pane fade show active" id="personal" role="tabpanel" aria-labelledby="personal-tab">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="inputName" name="name" value="<?php echo e($user->name); ?>" required>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="email" class="form-control" id="inputEmail" name="email" value="<?php echo e($user->email); ?>" required>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control mask-phone" id="inputPhone" name="phone" value="<?php echo e($user->phone); ?>">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control mask-cpf-cnpj" id="inputDoc" name="doc" value="<?php echo e($user->doc); ?>">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="inputOccupation" name="occupation" value="<?php echo e($user->occupation ?? ''); ?>" placeholder="Ex: CEO, Desenvolvedor...">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="inputCompany" name="company" value="<?php echo e($user->company ?? ''); ?>" placeholder="Nome da sua empresa">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="inputSegment" name="segment" value="<?php echo e($user->segment ?? ''); ?>" placeholder="Ex: Tecnologia, Saude, Educacao">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <textarea class="form-control" id="inputInterests" name="interests" rows="3" placeholder="Ex: marketing, vendas, ecommerce, inovacao"><?php echo e($user->interests ?? ''); ?></textarea>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    <!-- Preview -->
                                    <div id="photo-preview" class="mt-2" style="<?php echo e($user->photo ? '' : 'display: none;'); ?>">
                                        <img src="<?php echo e($user->photo ? asset($user->photo) : ''); ?>" class="img-thumbnail" style="max-height: 150px;">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    <!-- Preview Capa -->
                                    <div id="cover-preview" class="mt-2" style="<?php echo e($user->cover_photo ? '' : 'display: none;'); ?>">
                                        <img src="<?php echo e($user->cover_photo ? asset($user->cover_photo) : ''); ?>" class="img-fluid rounded" style="max-height: 150px; width: 100%; object-fit: cover;">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <textarea class="form-control" id="inputBio" name="bio" rows="4" placeholder="Conte um pouco sobre você..."><?php echo e($user->bio); ?></textarea>
                                </div>
                            </div>
                        ...
                        <div class="tab-pane fade" id="address" role="tabpanel" aria-labelledby="address-tab">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control mask-cep" id="inputCep" name="cep" value="<?php echo e($user->cep); ?>">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="inputStreet" name="street" value="<?php echo e($user->street); ?>">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-3">
                                    <input type="text" class="form-control" id="inputNumber" name="number" value="<?php echo e($user->number); ?>">
                                </div>
                                <label for="inputComplement" class="col-sm-2 col-form-label text-right">Complemento</label>
                                <div class="col-sm-4">
                                    <input type="text" class="form-control" id="inputComplement" name="complement" value="<?php echo e($user->complement); ?>" placeholder="Apto, Bloco...">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="inputNeighborhood" name="neighborhood" value="<?php echo e($user->neighborhood); ?>">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" class="form-control" id="inputCity" name="city" value="<?php echo e($user->city); ?>">
                                </div>
                                <label for="inputState" class="col-sm-1 col-form-label text-right">UF</label>
                                <div class="col-sm-2">
                                    <input type="text" class="form-control text-uppercase" id="inputState" name="state" value="<?php echo e($user->state); ?>" maxlength="2">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="tab-pane fade" id="social" role="tabpanel" aria-labelledby="social-tab">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="url" class="form-control" id="inputWebsite" name="website" value="<?php echo e($user->website); ?>" placeholder="https://seusite.com">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="inputFacebook" name="facebook" value="<?php echo e($user->facebook); ?>" placeholder="facebook.com/seuperfil">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="inputInstagram" name="instagram" value="<?php echo e($user->instagram); ?>" placeholder="@seuusuario">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="inputTwitter" name="twitter" value="<?php echo e($user->twitter); ?>" placeholder="@seuusuario">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="url" class="form-control" id="inputLinkedin" name="linkedin" value="<?php echo e($user->linkedin); ?>" placeholder="linkedin.com/in/seuusuario">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="url" class="form-control" id="inputYoutube" name="youtube" value="<?php echo e($user->youtube); ?>" placeholder="youtube.com/c/seucanal">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="form-group">
                                <div class="custom-control custom-switch custom-switch-lg">
                                    <input type="checkbox" class="custom-control-input" id="hideProfile" name="hide_profile" 
                                           <?php echo e($user->hide_profile ? 'checked' : ''); ?>>
                            ...
                            <div class="form-group">
                                <div class="custom-control custom-switch custom-switch-lg">
                                    <input type="checkbox" class="custom-control-input" id="showEmail" name="show_email_public" 
                                           <?php echo e($user->show_email_public ? 'checked' : ''); ?>>
                            ...
                            <div class="form-group">
                                <div class="custom-control custom-switch custom-switch-lg">
                                    <input type="checkbox" class="custom-control-input" id="showPhone" name="show_phone_public" 
                                           <?php echo e($user->show_phone_public ? 'checked' : ''); ?>>
                            ...
                            <div class="form-group">
                                <div class="custom-control custom-switch custom-switch-lg">
                                    <input type="checkbox" class="custom-control-input" id="showAddress" name="show_address_public" 
                                           <?php echo e($user->show_address_public ? 'checked' : ''); ?>>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\Tudo\MEU-SISTEMA\SOMOS_UNN\resources\views\admin\profile\edit.blade.php ENDPATH**/ ?>
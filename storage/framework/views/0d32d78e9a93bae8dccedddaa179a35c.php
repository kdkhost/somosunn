...
<?php $__env->startSection('breadcrumb'); ?>
    <li class="breadcrumb-item"><a href="<?php echo e(route('admin.chat.index')); ?>">Chat</a></li>
        ...
        <div class="col-md-12">
            <div class="card card-primary card-outline direct-chat direct-chat-primary h-100" style="min-height: 600px;">
                <div class="card-header p-2">
                    <a href="<?php echo e(route('admin.chat.index')); ?>" class="btn btn-tool d-md-none"><i
                            class="fas fa-arrow-left"></i> Voltar</a>
                    <h3 class="card-title d-inline-block"><?php echo e($chatOtherUserName); ?></h3>
                                    ...
                                    <?php $__currentLoopData = $conversations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $conv): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <a href="<?php echo e(route('admin.chat.show', $conv->id)); ?>"
                                            ...
                                            <div class="d-flex w-100 align-items-center">
                                                <img src="<?php echo e($cPhoto); ?>" class="img-circle mr-3"
                                                    style="width: 40px; height: 40px; object-fit: cover;">
                                                <div class="flex-grow-1 text-truncate">
                                                    <strong><?php echo e($cName); ?></strong>
                                                    <?php if($conv->unread_count > 0): ?>
                                                        <span
                                                            class="badge badge-primary float-right"><?php echo e($conv->unread_count); ?></span>
                                                    <?php endif; ?>
                                                </div>
                                            </div>
                                        </a>
                        ...
                        <div class="col-md-8 col-12 d-flex flex-column h-100 p-0">
                            ...
                            <div class="direct-chat-messages flex-grow-1 p-4" id="messages-container"
                                ...
                                <?php $__currentLoopData = $messages->reverse(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $msg): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    ?>
                                    <div class="direct-chat-msg <?php echo e($isMe ? 'right' : ''); ?>">
                                        <div class="direct-chat-infos clearfix">
                                            <span
                                                class="direct-chat-name float-<?php echo e($isMe ? 'right' : 'left'); ?>"><?php echo e($msgName); ?></span>
                                            <span
                                                class="direct-chat-timestamp float-<?php echo e($isMe ? 'left' : 'right'); ?>"><?php echo e($msgTime); ?></span>
                                        </div>
                                        <img class="direct-chat-img"
                                            src="<?php echo e($isMe ? (Auth::user()->profile_photo_url ?? asset('img/default-user.svg')) : $chatOtherUserPhoto); ?>"
                                            alt="User">
    ...
    <script>
        $(document).ready(function () {
            ...
            $('#chat-form').on('submit', function (e) {
                ...
                const html = `
                    <div class="direct-chat-msg right">
                        ...
                        <img class="direct-chat-img" src="<?php echo e(Auth::user()->profile_photo_url ?? asset('img/default-user.svg')); ?>" alt="User">
                        <div class="direct-chat-text">
                ...
                fetch('<?php echo e(route("admin.chat.message.store", $conversation->id)); ?>', {
                    method: 'POST',
                    headers: {
            ...
            setInterval(() => {
                ...
                fetch('<?php echo e(route("admin.chat.messages", $conversation->id)); ?>')
                    .then(r => r.json())
                    .then(messages => {
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\Tudo\MEU-SISTEMA\SOMOS_UNN\resources\views\admin\chat\show.blade.php ENDPATH**/ ?>
<?php $__env->startSection('title', 'Próximos Eventos - UNN'); ?>
                            ...
                            <div class="rounded-[32px] overflow-hidden border border-white/20 bg-white/10 backdrop-blur shadow-[0_40px_120px_-60px_rgba(0,0,0,0.65)]">
                                <div class="grid lg:grid-cols-2">
                                    <div class="relative min-h-[260px] lg:min-h-[460px]">
                                        <img src="<?php echo e($featuredEventImage); ?>" alt="Evento UNN" class="absolute inset-0 w-full h-full object-cover">
                                        <div class="absolute inset-0 bg-gradient-to-t from-black/45 via-black/10 to-black/0"></div>

                                        <?php if($featuredEvent->capacity): ?>
                                    ...
                                    <div class="bg-white p-7 sm:p-8 md:p-10">
                                        <h2 class="text-3xl sm:text-4xl font-black text-slate-900 leading-tight">
                                            <?php echo e($featuredEvent->title); ?>

                                        </h2>
                                        <p class="mt-4 text-slate-600 text-base sm:text-lg leading-relaxed">
                                            <?php echo e($featuredEvent->description ?: 'Participe de um encontro exclusivo para empreendedores que buscam crescimento através de conexões estratégicas.'); ?>
                                        ...
                                        <div class="mt-8 space-y-5">
                                            <div class="flex items-start gap-4">
                                                ...
                                                <div>
                                                    <div class="font-bold text-slate-900"><?php echo e($prettyDate); ?></div>
                                                    <div class="text-sm text-slate-500"><?php echo e($prettyWeekday); ?></div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="flex items-start gap-4">
                                                ...
                                                <div>
                                                    <div class="font-bold text-slate-900">
                                                        <?php if($featuredEvent->all_day): ?>
                                                            Dia todo
                                                        <?php elseif($endTime): ?>
                                                            <?php echo e($startTime); ?> às <?php echo e($endTime); ?>
                                                    ...
                                                    <div class="text-sm text-slate-500">
                                                        <?php echo e($durationText ?: 'Horário sujeito a confirmação'); ?>
                                            ...
                                            <div class="flex items-start gap-4">
                                                ...
                                                <div>
                                                    <div class="font-bold text-slate-900"><?php echo e($locationName); ?></div>
                                                    <?php if($addressLine): ?>
                                                        <div class="text-sm text-slate-500"><?php echo e($addressLine); ?></div>
                                                    <?php endif; ?>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="mt-10 flex flex-col sm:flex-row gap-4">
                                            <a href="<?php echo e($isDemo ? '#' : route('events.checkout', $featuredEvent)); ?>"
                                                class="btn-primary text-white px-8 py-4 rounded-xl font-bold inline-flex items-center justify-center gap-3 shadow-lg hover:shadow-xl transition <?php echo e($isDemo ? 'pointer-events-none opacity-60' : ''); ?>">
                                                Inscreva-se agora <i class="fas fa-arrow-right"></i>
                                            </a>
                                            <a href="<?php echo e($isDemo ? '#' : route('events.show', $featuredEvent)); ?>"
                                                class="px-8 py-4 rounded-xl font-bold border-2 border-slate-200 text-slate-700 hover:bg-slate-50 transition inline-flex items-center justify-center <?php echo e($isDemo ? 'pointer-events-none opacity-60' : ''); ?>">
                                                Saiba mais
                                            </a>
                                        </div>
                                    </div>
                ...
                <div class="bg-white rounded-3xl shadow-xl overflow-hidden border border-slate-100">
                    <div class="events-headbar px-6 py-5 border-b border-slate-100 flex items-center justify-between bg-gradient-to-r from-slate-50 to-white">
                        ...
                        <span class="events-total-badge inline-flex items-center gap-2 px-3 py-1 rounded-full text-xs font-bold bg-white border border-slate-200 text-slate-600 shadow-sm">
                            ...
                            <?php echo e($events->count()); ?> <?php echo e($events->count() === 1 ? 'evento' : 'eventos'); ?>
                                        ...
                                        <div class="events-table-row p-5 md:p-6">
                                            <div class="events-col-date min-w-0">
                                                <div class="flex md:block items-center justify-between gap-3">
                                                    <div class="flex items-center gap-3">
                                                        <div class="w-14 text-center rounded-2xl p-2 border border-slate-200 bg-gradient-to-br from-white to-slate-50 shadow-inner">
                                                            <span class="block font-black text-lg leading-none text-slate-900"><?php echo e($startDate ? $startDate->format('d') : '--'); ?></span>
                                                            <span class="block uppercase text-xs font-black text-slate-500"><?php echo e($startDate ? $startDate->translatedFormat('M') : ''); ?></span>
                                                        </div>
                                                        <div class="md:hidden">
                                                            <div class="text-xs font-bold text-slate-700">
                                                                <?php echo e($startDate ? ucfirst($startDate->translatedFormat('l')) : ''); ?>

                                                            </div>
                                                            <div class="text-xs text-slate-500 mt-0.5">
                                                                <i class="far fa-clock mr-1"></i><?php echo e($startDate ? $startDate->format('H:i') : ''); ?>
                                                ...
                                                <div class="hidden md:block text-xs text-slate-500 mt-3">
                                                    <div class="font-bold text-slate-700"><?php echo e($startDate ? ucfirst($startDate->translatedFormat('l')) : ''); ?></div>
                                                    <div class="mt-1"><i class="far fa-clock mr-1"></i><?php echo e($startDate ? $startDate->format('H:i') : ''); ?></div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="flex items-start gap-4">
                                                    <div class="relative w-16 h-16 rounded-2xl overflow-hidden border border-slate-200 bg-slate-50 flex-shrink-0">
                                                        ...
                                                        <?php if($eventImageUrl !== ''): ?>
                                                            <img src="<?php echo e($eventImageUrl); ?>" alt="Imagem do evento" class="absolute inset-0 w-full h-full object-cover z-10" loading="lazy" onerror="this.remove();">
                                                        ...
                                                        <div class="mt-2 flex flex-wrap items-center gap-2">
                                                            <?php if($event->speaker): ?>
                                                                <span class="inline-flex items-center gap-2 px-3 py-1 rounded-full text-xs font-bold bg-slate-100 text-slate-700 border border-slate-200">
                                                                    <i class="fas fa-user-tie text-slate-400"></i><?php echo e($event->speaker); ?>

                                                                </span>
                                                            <?php endif; ?>

                                                            <?php if($hasPrice && $event->current_batch_label): ?>
                                                                <span class="inline-flex items-center gap-2 px-3 py-1 rounded-full text-xs font-black text-white shadow-sm"
                                                                    style="background: var(--unn-azul-1)">
                                                                    <i class="fas fa-tag"></i><?php echo e($event->current_batch_label); ?>
                                            ...
                                            <div class="events-col-location min-w-0">
                                                <div class="text-slate-800 font-bold">
                                                    <i class="fas fa-map-marker-alt text-red-500 mr-1"></i><?php echo e($locationLine); ?>
                                            ...
                                            <div class="events-col-capacity min-w-0">
                                                <?php if($event->capacity): ?>
                                                    <div class="text-sm font-black text-slate-900"><?php echo e($event->capacity); ?></div>
                                            ...
                                            <div class="events-col-price min-w-0">
                                                <?php if($event->current_price > 0 || $event->price > 0): ?>
                                                    <div class="font-black text-slate-900">R$ <?php echo e(number_format($event->current_price ?: $event->price, 2, ',', '.')); ?></div>
                                            ...
                                            <div class="events-col-action md:text-right">
                                                <a href="<?php echo e($isDemo ? '#' : route('events.show', $event->id)); ?>"
                                                    class="events-action-btn inline-flex items-center justify-center gap-2 px-4 py-2 rounded-full text-sm font-black text-white btn-primary shadow-lg hover:shadow-xl transition whitespace-nowrap w-full md:w-auto <?php echo e($isDemo ? 'pointer-events-none opacity-60' : ''); ?>">
                            ...
                            <div class="bg-white rounded-3xl p-7 shadow-lg border border-slate-100">
                                <div class="flex items-start justify-between gap-4">
                                    <div>
                                        <div class="text-sm font-bold text-slate-500">
                                            <?php echo e($startDate ? $startDate->translatedFormat('d \\d\\e M, Y') : 'Data a confirmar'); ?>
                                ...
                                <div class="mt-4 space-y-2 text-sm text-slate-600">
                                    <div class="flex items-center gap-2">
                                        ...
                                        <span class="truncate"><?php echo e($locationLine); ?></span>
                                    </div>
                                    <div class="flex items-center gap-2">
                                ...
                                <div class="mt-6 flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-4">
                                    <div>
                                        <?php if($event->current_price > 0 || $event->price > 0): ?>
                                            <div class="font-black text-slate-900">R$ <?php echo e(number_format($event->current_price ?: $event->price, 2, ',', '.')); ?></div>
                                            <div class="text-xs text-slate-500 mt-0.5"><?php echo e($event->current_batch_label ?? 'Ingresso'); ?></div>
                                        <?php else: ?>
                                            <span class="inline-flex items-center px-3 py-1 rounded-full text-xs font-bold bg-green-100 text-green-700">GRÁTIS</span>
                                        <?php endif; ?>
                                    </div>
                                    <a href="<?php echo e($isDemo ? '#' : route('events.show', $event)); ?>"
                                        class="inline-flex items-center justify-center gap-2 px-4 py-2 rounded-full font-bold text-white btn-primary shadow-md hover:shadow-lg transition w-full sm:w-auto sm:min-w-[150px] <?php echo e($isDemo ? 'pointer-events-none opacity-60' : ''); ?>">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\Tudo\MEU-SISTEMA\SOMOS_UNN\resources\views\events\index.blade.php ENDPATH**/ ?>
<div class="bg-gradient-to-br from-slate-50 to-blue-50 min-h-screen">
    ...
    <section class="py-16 px-6 md:px-12 lg:px-24 bg-white">
        <div class="max-w-7xl mx-auto text-center">
            ...
            <a href="<?php echo e(route('valores')); ?>" class="btn-primary text-white px-8 py-3 rounded-full font-semibold inline-flex items-center gap-2 mt-8">
...
<?php /**PATH G:\Tudo\MEU-SISTEMA\SOMOS_UNN\resources\views\site\institucional\_fallback\manifesto.blade.php ENDPATH**/ ?>
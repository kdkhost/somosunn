...
<?php $__env->startSection('breadcrumb_items'); ?>
    <li class="breadcrumb-item"><a href="<?php echo e(route('admin.courses.index')); ?>">Cursos</a></li>
    <li class="breadcrumb-item active"><?php echo e($course->exists ? 'Editar' : 'Novo'); ?></li>
                    ...
                    <ul class="nav nav-tabs" id="courseTabs" role="tablist">
                        ...
                        <?php if($course->exists): ?>
                            ...
                            <li class="nav-item" id="nav-item-cert"
                                style="<?php echo e($course->is_certificate_enabled ? '' : 'display:none;'); ?>">
                    ...
                    <div class="tab-content" id="courseTabsContent">
                            ...
                            <form method="POST"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-8">
                                        ...
                                        <div class="form-group mb-4">
                                            ...
                                            <textarea name="short_description" class="form-control" rows="3"
                                                ...
                                                maxlength="500"><?php echo e(old('short_description', $course->short_description)); ?></textarea>
                                        ...
                                        <div class="form-group mb-4">
                                            ...
                                            <textarea name="full_description" id="fullDescription"
                                                class="form-control summernote"><?php echo e(old('full_description', $course->full_description)); ?></textarea>
                                        </div>
                                    ...
                                    <div class="col-lg-4">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="form-group mb-3">
                                                    ...
                                                    <select name="status" class="form-control custom-select">
                                                        ...
                                                        <option value="paused" <?php echo e($course->status == 'paused' ? 'selected' : ''); ?>>Vendas Pausadas</option>
                                                    </select>
                                                </div>
                                                ...
                                                <div class="form-group mb-3">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input name="price"
                                                            ...
                                                            value="<?php echo e(old('price', $course->price)); ?>" placeholder="0,00">
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="card-body p-3">
                                                        ...
                                                        <div class="form-group mb-2">
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                <input name="flash_sale_price" class="form-control mask-money"
                                                                    value="<?php echo e(old('flash_sale_price', $course->flash_sale_price)); ?>"
                                                                    placeholder="0,00">
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group mb-0">
                                                            ...
                                                            <input type="datetime-local" name="flash_sale_ends_at"
                                                                class="form-control"
                                                                value="<?php echo e(old('flash_sale_ends_at', $course->flash_sale_ends_at ? $course->flash_sale_ends_at->format('Y-m-d\\TH:i') : '')); ?>">
                                                ...
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input name="author_name" class="form-control"
                                                        value="<?php echo e(old('author_name', $course->author_name ?? Auth::user()->name)); ?>">
                                                </div>

                                                <div class="form-group mb-4">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                            name="is_featured" id="is_featured" value="1" <?php echo e($course->is_featured ? 'checked' : ''); ?>>
                                                ...
                                                <div class="form-group mb-4">
                                                    ...
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                            ...
                                                            <?php echo e($course->video_block_download ? 'checked' : ''); ?>>
                                                        <label class="custom-control-label font-weight-bold"
                                                    ...
                                                    <div class="custom-control custom-switch mt-3">
                                                        <input type="checkbox" class="custom-control-input"
                                                            ...
                                                            value="1" <?php echo e($course->video_floating_enabled ? 'checked' : ''); ?>>
                                                        <label class="custom-control-label font-weight-bold"
                                                    ...
                                                    <div class="custom-control custom-switch mt-3">
                                                        <input type="checkbox" class="custom-control-input"
                                                            ...
                                                            value="1" <?php echo e($course->is_certificate_enabled ? 'checked' : ''); ?>>
                                                        <label class="custom-control-label font-weight-bold"
                                                            for="is_certificate_enabled">Habilitar Certificado</label>
                                                    </div>

                                                    <div class="row mt-3" id="video_floating_size_group"
                                                        style="<?php echo e($course->video_floating_enabled ? '' : 'display:none;'); ?>">
                                                        <div class="col-6">
                                                            ...
                                                            <input type="number" min="260" max="960"
                                                                ...
                                                                value="<?php echo e(old('video_floating_width', $course->video_floating_width ?? 420)); ?>">
                                                        </div>
                                                        <div class="col-6">
                                                            ...
                                                            <input type="number" min="160" max="720"
                                                                ...
                                                                value="<?php echo e(old('video_floating_height', $course->video_floating_height ?? 236)); ?>">
                                                        </div>
                                                        <div class="col-12">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="input-group mb-2">
                                                        <input type="text" class="form-control form-control-sm" id="courseLink"
                                                            value="<?php echo e(route('courses.show', $course->slug ?: $course->id)); ?>"
                                                            readonly>
                                        ...
                                        <?php if(!$course->exists && !(Auth::user() && (Auth::user()->isAdmin() || Auth::user()->role === 'superadmin'))): ?>
                                            <div class="alert alert-info mt-3 text-center">
                                                <i class="fas fa-info-circle"></i> Salve para liberar a aba de Aulas.
                                            </div>
                                        <?php elseif(!$course->exists && Auth::user() && (Auth::user()->isAdmin() || Auth::user()->role === 'superadmin')): ?>
                            ...
                            <div class="tab-pane fade" id="lessons" role="tabpanel" aria-labelledby="lessons-tab">
                                    ...
                                    <script>
                                        document.addEventListener('DOMContentLoaded', function () {
                                            ...
                                            btnNovaAula.addEventListener('click', function (e) {
                                                ...
                                                const courseId = <?php echo e($course->exists ? $course->id : 'null'); ?>;
                                                if (courseId) {
                                ...
                                <div id="lessons-list">
                                    <?php $__empty_1 = true; $__currentLoopData = $course->lessons; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lesson): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <div class="lesson-item shadow-sm" data-id="<?php echo e($lesson->id); ?>">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div>
                                                    <div class="font-weight-bold" style="font-size: 1.05rem;">
                                                        <span class="text-muted mr-1">#<?php echo e($lesson->order); ?></span>
                                                        <?php echo e($lesson->title); ?>

                                                    </div>
                                                    <div class="mt-1">
                                                        <span
                                                            class="badge badge-light border"><?php echo e(gmdate("H:i:s", $lesson->duration)); ?></span>
                                                        <?php if($lesson->is_free_preview): ?> <span class="badge badge-info">Preview
                                                        Grátis</span> <?php endif; ?>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="lesson-actions">
                                                <button type="button" class="btn btn-sm btn-outline-primary btn-edit-lesson"
                                                    data-id="<?php echo e($lesson->id); ?>" title="Editar"><i class="fas fa-edit"></i></button>
                                                <form action="<?php echo e(route('courses.lessons.destroy', [$course, $lesson])); ?>"
                        ...
                        <?php if($course->exists): ?>
                            <div class="tab-pane fade" id="certificate" role="tabpanel" aria-labelledby="cert-tab">
                                <form id="certForm" method="POST" action="<?php echo e(route('admin.courses.update', $course)); ?>"
                                    enctype="multipart/form-data">
                                    <?php echo csrf_field(); ?>
                                                ...
                                                <div class="card-body bg-dark d-flex justify-content-center align-items-center p-4"
                                                    ...
                                                    <div id="cert-canvas"
                                                        ...
                                                        <?php if($course->certificate_bg): ?>
                                                            <img src="<?php echo e(asset($course->certificate_bg)); ?>" id="cert-bg-img"
                                                        ...
                                                        <div id="cert-grid-overlay"
                                                            style="position:absolute; top:0; left:0; width:100%; height:100%; z-index:5; pointer-events:none; display:none;"></div>
                                            ...
                                            <div class="card shadow-sm border-0">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <input type="hidden" name="is_certificate_enabled"
                                                        value="<?php echo e($course->is_certificate_enabled ? '1' : '0'); ?>"
                                                    ...
                                                    <div class="form-group">
                                                        <label class="small text-muted text-uppercase font-weight-bold">Ajuste do Fundo</label>
                                                        ...
                                                        <small class="text-muted">Mantém consistência entre editor e PDF</small>
                                                    </div>

                                                    <div class="border rounded p-2 mb-3 bg-light">
                                                        <div class="small text-muted text-uppercase font-weight-bold mb-2">Ferramentas</div>

                                                        <div class="custom-control custom-switch mb-2">
                                                            <input type="checkbox" class="custom-control-input" id="cert-grid-enabled">
                                                            <label class="custom-control-label" for="cert-grid-enabled">Mostrar grade</label>
                                                        </div>
                                                        ...
                                                        <div class="custom-control custom-switch mb-2">
                                                            <input type="checkbox" class="custom-control-input" id="cert-snap-enabled" checked>
                                                            <label class="custom-control-label" for="cert-snap-enabled">Snap na grade</label>
                                                        </div>

                                                        <div class="form-group mb-2">
                                                            <label class="small text-muted mb-0">Passo do snap</label>
                                                            <select id="cert-snap-step" class="form-control form-control-sm">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group">
                                                            <input type="text" class="form-control bg-light"
                                                                value="<?php echo e($course->total_hours > 0 ? $course->total_hours . 'h' : 'Adicione aulas para calcular'); ?>"
                                                                readonly>
                                                            <div class="input-group-append">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <?php if($course->instructor_signature): ?>
                                                            <div class="mt-2">
                                                                <img src="<?php echo e(asset($course->instructor_signature)); ?>"
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" name="certificate_title"
                                                            ...
                                                            value="<?php echo e($course->certificate_settings['title'] ?? 'CERTIFICATE OF ACHIEVEMENT'); ?>"
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <textarea class="form-control" name="presentation_text"
                                                            ...
                                                            placeholder="This certificate is proudly present to"><?php echo e($course->certificate_settings['presentation_text'] ?? $course->default_presentation_text); ?></textarea>
                                                    ...
                                                    <h6 class="small text-muted text-uppercase font-weight-bold mb-3">Camadas</h6>
...
<?php $__env->startPush('scripts'); ?>
    ...
    <script>
        ...
        function updateDropzoneUrl(lessonId) {
            if (myDropzone) {
                myDropzone.options.url = '/courses/<?php echo e($course->id); ?>/lessons/' + lessonId + '/attachments';
            }
        }

        function fetchLessonDetails(lessonId) {
            $.get('/courses/<?php echo e($course->id); ?>/lessons/' + lessonId + '/details', function (data) {
                renderAttachments(data.attachments, lessonId);
            });
        }

        const allowedDocumentExtensions = <?php echo json_encode($allowedDocExtensions, 15, 512) ?>;
        const dropzoneAcceptedFiles = <?php echo json_encode($dropzoneAcceptedFiles, 15, 512) ?>;
        const dropzoneMaxFilesize = <?php echo e($dropzoneMaxFilesizeMb); ?>;
        ...
        window.renameAttachment = function (lessonId, attId, currentName) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: '/courses/<?php echo e($course->id); ?>/lessons/' + lessonId + '/attachments/' + attId,
                        type: 'PUT',
                        data: { name: result.value, _token: '<?php echo e(csrf_token()); ?>' },
        ...
        $(document).ready(function () {
            ...
            $('.btn-edit-lesson').on('click', function () {
                ...
                $.get('/courses/<?php echo e($course->id); ?>/lessons/' + id + '/details', function (data) {
            ...
            $('#btnSaveLesson').on('click', function (e) {
                ...
                let url = '/courses/<?php echo e($course->id); ?>/lessons';
                if (id) url += '/' + id;
            ...
            $('form[enctype="multipart/form-data"]').on('submit', function (e) {
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        setTimeout(function () {
                            window.location.href = "<?php echo e(route('admin.courses.index')); ?>";
                        }, 500);
                    },
                    error: function (xhr) {
    ...
    <script>
        ...
        $(document).ready(function () {
            if ('<?php echo e($course->exists); ?>' == '') return;

            // Initial Settings from DB (legacy map or schema v2 document)
            let rawCertSettings = <?php echo $course->certificate_settings ? json_encode($course->certificate_settings) : '{}'; ?>;
            ...
            const instructorSignatureUrl = "<?php echo e($course->instructor_signature ? asset($course->instructor_signature) : ''); ?>";
            ...
            const defaultTags = {
                ...
                'author_name': { x: 30, y: 90, text: '<?php echo e($course->author_name ?? "Instrutor"); ?>', fontSize: 18, color: '#333333', fontWeight: 'bold', fontFamily: 'Arial, sans-serif', zIndex: 10 },
                'workload_hours': { x: 70, y: 90, text: 'Carga Horária: <?php echo e($course->total_hours); ?>h', fontSize: 14, color: '#666666', fontWeight: 'normal', fontFamily: 'Arial, sans-serif', zIndex: 10 },
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\Tudo\MEU-SISTEMA\SOMOS_UNN\resources\views\admin\courses\form.blade.php ENDPATH**/ ?>
<?php $__env->startSection('title','Instalação concluída - UNN'); ?>
...
<section class="min-h-screen w-full bg-gradient-to-b from-slate-900 via-purple-900 to-black text-white overflow-hidden relative">
    ...
    <div class="max-w-5xl mx-auto px-6 py-24 relative z-10 space-y-10">
        <div class="text-center space-y-4">
            ...
            <p class="text-gray-300">O portal agora compartilha o mesmo banco de dados do site, os rankings estão prontos e o superadmin <strong><?php echo e($admin->email); ?></strong> já tem acesso total.</p>
        </div>
        ...
        <div class="grid gap-6 md:grid-cols-3">
            <?php $__currentLoopData = [
                ...
                <article class="bg-white/10 border border-white/10 rounded-3xl p-6 backdrop-blur shadow-2xl hover:border-purple-300 transition">
                    ...
                    <p class="text-sm text-gray-300"><?php echo e($item['detail']); ?></p>
                </article>
        ...
        <div class="rounded-3xl border border-white/20 bg-black/50 p-6 text-xs text-gray-400 space-y-2">
            <p>© <?php echo e(date('Y')); ?> Kdkhost Soluções. Todos os direitos reservados.</p>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\Tudo\MEU-SISTEMA\SOMOS_UNN\resources\views\install\success.blade.php ENDPATH**/ ?>
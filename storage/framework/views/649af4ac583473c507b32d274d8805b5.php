        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <input type="text" name="pwa_short_name" class="form-control"
                    value="<?php echo e($settings['pwa_short_name'] ?? config('app.name')); ?>" placeholder="Ex: UNN">
            ...
            <div class="form-group">
                ...
                <div class="input-group colorpicker-element">
                    <input type="text" name="pwa_theme_color" class="form-control"
                        value="<?php echo e($settings['pwa_theme_color'] ?? '#0C6BF7'); ?>">
                    <div class="input-group-append">
                        <span class="input-group-text"><i class="fas fa-square"
                                style="color: <?php echo e($settings['pwa_theme_color'] ?? '#0C6BF7'); ?>"></i></span>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="form-group">
                ...
                <div class="input-group colorpicker-element">
                    <input type="text" name="pwa_background_color" class="form-control"
                        value="<?php echo e($settings['pwa_background_color'] ?? '#FFFFFF'); ?>">
                    <div class="input-group-append">
                        <span class="input-group-text"><i class="fas fa-square"
                                style="color: <?php echo e($settings['pwa_background_color'] ?? '#FFFFFF'); ?>"></i></span>
                    </div>
                </div>
            </div>
        </div>
        <div class="col-md-6">
            <div class="form-group">
                ...
                <select name="pwa_display" class="form-control">
                    <option value="standalone" <?php echo e(($settings['pwa_display'] ?? 'standalone') == 'standalone' ? 'selected' : ''); ?>>Standalone (App Nativo - Recomendado)</option>
                    <option value="fullscreen" <?php echo e(($settings['pwa_display'] ?? 'standalone') == 'fullscreen' ? 'selected' : ''); ?>>Fullscreen (Tela Cheia)</option>
                    <option value="minimal-ui" <?php echo e(($settings['pwa_display'] ?? 'standalone') == 'minimal-ui' ? 'selected' : ''); ?>>Minimal UI (Com controles básicos)</option>
                    <option value="browser" <?php echo e(($settings['pwa_display'] ?? 'standalone') == 'browser' ? 'selected' : ''); ?>>Browser (Aba Normal)</option>
                </select>
            </div>
        </div>
    </div>
        ...
        <div class="col-md-3 col-sm-6">
            <div class="form-group text-center">
                ...
                <div class="upload-box" data-remove-input="#remove_pwa_icon_192"
                    data-existing-url="<?php echo e($getUrl('pwa_icon_192')); ?>">
                    ...
                    <div class="upload-preview mb-2">
                        <?php if($url = $getUrl('pwa_icon_192')): ?>
                    ...
                    <button type="button"
                        class="btn btn-sm btn-outline-danger upload-remove <?php echo e($getUrl('pwa_icon_192') ? '' : 'd-none'); ?>"><i
        ...
        <div class="col-md-3 col-sm-6">
            <div class="form-group text-center">
                ...
                <div class="upload-box" data-remove-input="#remove_pwa_icon_512"
                    data-existing-url="<?php echo e($getUrl('pwa_icon_512')); ?>">
                    ...
                    <div class="upload-preview mb-2">
                        <?php if($url = $getUrl('pwa_icon_512')): ?>
                            <img src="<?php echo e($url); ?>" class="img-fluid rounded border">
                        <?php else: ?>
                            <div class="text-muted p-4 border rounded bg-light">
                    ...
                    <button type="button" class="btn btn-sm btn-outline-primary upload-btn"><i
                            class="fas fa-upload"></i> Selecionar</button>
                    <button type="button"
                        class="btn btn-sm btn-outline-danger upload-remove <?php echo e($getUrl('pwa_icon_512') ? '' : 'd-none'); ?>"><i
                            class="fas fa-trash"></i></button>
                </div>
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <div class="upload-box" data-remove-input="#remove_pwa_banner"
                    data-existing-url="<?php echo e($getUrl('pwa_banner')); ?>" style="height: auto;">
                    ...
                    <div class="upload-preview mb-2 text-center">
                        <?php if($url = $getUrl('pwa_banner')): ?>
                            <img src="<?php echo e($url); ?>" class="img-fluid rounded border" style="max-height: 200px;">
                        <?php else: ?>
                    ...
                    <div class="text-center">
                        ...
                        <button type="button"
                            class="btn btn-sm btn-outline-danger upload-remove <?php echo e($getUrl('pwa_banner') ? '' : 'd-none'); ?>"><i
                                class="fas fa-trash"></i></button>
                    </div>
                </div>
            </div>
...
</div><?php /**PATH G:\Tudo\MEU-SISTEMA\SOMOS_UNN\resources\views\admin\settings\partials\pwa.blade.php ENDPATH**/ ?>
            ...
            <tr>
                <td align="center">
                    <div style="background-color: #ffffff; max-width: 600px; padding: 0px; border-radius: 8px; box-shadow: 0 4px 6px rgba(0,0,0,0.1); overflow: hidden;">
                        <div style="background: linear-gradient(135deg, <?php echo e($primaryColor); ?> 0%, <?php echo e($secondaryColor); ?> 100%); padding: 30px 20px; text-align: center;">
                            <img src="<?php echo e($logoUrl); ?>" alt="<?php echo e($siteName); ?>" style="max-height: 60px; max-width: 200px;">
                        </div>
                        ...
                        <div style="background-color: #f8f9fa; padding: 20px; text-align: center; color: #777777; font-size: 12px; border-top: 1px solid #eeeeee;">
                            <p style="margin: 0;">&copy; <?php echo e($year); ?> <?php echo e($siteName); ?>. Todos os direitos reservados.</p>
                        </div>
                    </div>
                </td>
            </tr>
...
<?php /**PATH G:\Tudo\MEU-SISTEMA\SOMOS_UNN\resources\views\emails\layouts\system.blade.php ENDPATH**/ ?>
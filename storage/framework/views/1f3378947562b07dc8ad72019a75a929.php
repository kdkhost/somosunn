...
<?php $__env->startSection('title', 'Pagamento via Pix'); ?>
...
<div class="min-h-screen bg-slate-50 pt-32 pb-20 px-4">
    <div class="max-w-2xl mx-auto bg-white rounded-3xl shadow-xl p-8 text-center">
        ...
        <div class="mb-8 p-4 border-2 border-dashed border-gray-200 rounded-xl inline-block bg-slate-50">
            <img src="data:image/png;base64,<?php echo e($qr_code_base64); ?>" alt="QR Code Pix" class="w-64 h-64 mx-auto">
        </div>

        <div class="max-w-md mx-auto mb-8">
            <label class="block text-sm font-bold text-gray-700 mb-2">Pix Copia e Cola</label>
            <div class="flex gap-2">
                <input type="text" value="<?php echo e($qr_code); ?>" id="pixCode" readonly class="w-full bg-gray-50 border border-gray-200 rounded-lg px-4 py-3 text-sm text-gray-600 focus:outline-none">
        ...
        <a href="<?php echo e(route('subscription.success', $order->id)); ?>" class="inline-flex items-center gap-2 text-blue-600 font-bold hover:underline">
...
setInterval(() => {
    ...
    // fetch('/api/orders/<?php echo e($order->id); ?>/status')...
}, 5000);
</script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\Tudo\MEU-SISTEMA\SOMOS_UNN\resources\views\site\subscription\pix.blade.php ENDPATH**/ ?>
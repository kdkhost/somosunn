<?php $__env->startSection('title', 'Eventos e Reuniões'); ?>
<?php $__env->startSection('page_title', 'Calendário de Eventos'); ?>
    ...
    <style>
        ...
        :root {
            --unn-calendar-primary:
                <?php echo e($buttonColor); ?>

            ;
            --unn-calendar-primary-hover:
                <?php echo e($buttonColorHover); ?>
...
<?php $__env->startSection('content'); ?>
    <div class="row">
        <div class="col-md-3">
            ...
            <?php if(auth()->user()->isAdmin() || auth()->user()->hasPermission('events.create')): ?>
                <div class="card">
                    <div class="card-header">
                    ...
                    <div class="card-body">
                        <div id="external-events" class="external-events">
                            <?php $__currentLoopData = $calendarTemplates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tpl): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="external-event" data-title="<?php echo e($tpl['title']); ?>" data-color="<?php echo e($tpl['color']); ?>"
                                    style="background:<?php echo e($tpl['color']); ?>;">
                        ...
                        <div class="form-check mt-2">
                            <input type="checkbox" class="form-check-input" id="drop-remove" <?php echo e($defaultRemoveAfterDrop ? 'checked' : ''); ?>>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="color-chooser mb-3" id="new-event-colors">
                            <?php $__currentLoopData = $calendarQuickColors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $idx => $color): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <span class="color-item <?php echo e($idx === 0 ? 'active' : ''); ?>" data-color="<?php echo e($color); ?>"
    ...
    <div class="modal fade" id="calendarSettingsModal" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <form id="calendarSettingsForm" action="<?php echo e(route('admin.events.calendar.settings')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select name="initial_view" class="form-control">
                                        <option value="dayGridMonth" <?php echo e($initialView === 'dayGridMonth' ? 'selected' : ''); ?>>
                                            Mês</option>
                                        <option value="timeGridWeek" <?php echo e($initialView === 'timeGridWeek' ? 'selected' : ''); ?>>
                                            Semana</option>
                                        <option value="timeGridDay" <?php echo e($initialView === 'timeGridDay' ? 'selected' : ''); ?>>Dia
                                        </option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select name="first_day" class="form-control">
                                        <option value="0" <?php echo e($firstDay === 0 ? 'selected' : ''); ?>>Domingo</option>
                                        <option value="1" <?php echo e($firstDay === 1 ? 'selected' : ''); ?>>Segunda</option>
                                        <option value="2" <?php echo e($firstDay === 2 ? 'selected' : ''); ?>>Terça</option>
                                        <option value="3" <?php echo e($firstDay === 3 ? 'selected' : ''); ?>>Quarta</option>
                                        <option value="4" <?php echo e($firstDay === 4 ? 'selected' : ''); ?>>Quinta</option>
                                        <option value="5" <?php echo e($firstDay === 5 ? 'selected' : ''); ?>>Sexta</option>
                                        <option value="6" <?php echo e($firstDay === 6 ? 'selected' : ''); ?>>Sábado</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-4">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="color" name="button_color" class="form-control" value="<?php echo e($buttonColor); ?>">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="color" name="event_text_color" class="form-control"
                                        value="<?php echo e($eventTextColor); ?>">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select name="default_remove_after_drop" class="form-control">
                                        <option value="0" <?php echo e(!$defaultRemoveAfterDrop ? 'selected' : ''); ?>>Não</option>
                                        <option value="1" <?php echo e($defaultRemoveAfterDrop ? 'selected' : ''); ?>>Sim</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="form-group mb-0">
                                    ...
                                    <div class="custom-control custom-checkbox d-inline-block mr-3">
                                        <input type="checkbox" class="custom-control-input" id="cal-weekends"
                                            name="weekends" value="1" <?php echo e($weekends ? 'checked' : ''); ?>>
                                    ...
                                    <div class="custom-control custom-checkbox d-inline-block">
                                        <input type="checkbox" class="custom-control-input" id="cal-weeknumbers"
                                            name="week_numbers" value="1" <?php echo e($weekNumbers ? 'checked' : ''); ?>>
                        ...
                        <div class="row">
                                ...
                                <div id="quickColorsList">
                                    <?php $__currentLoopData = $calendarQuickColors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $idx => $color): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="form-row align-items-center mb-2 calendar-color-row">
                                            <div class="col-10">
                                                <input type="color" class="form-control" name="quick_colors[<?php echo e($idx); ?>]"
                            ...
                            <div class="col-md-6">
                                ...
                                <div id="templatesList">
                                    <?php $__currentLoopData = $calendarTemplates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $idx => $tpl): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="form-row align-items-center mb-2 calendar-template-row">
                                            <div class="col-7">
                                                <input type="text" class="form-control" name="templates[<?php echo e($idx); ?>][title]"
                                                    value="<?php echo e($tpl['title']); ?>" placeholder="Título">
                                            </div>
                                            <div class="col-3">
                                                <input type="color" class="form-control" name="templates[<?php echo e($idx); ?>][color]"
                                                    value="<?php echo e($tpl['color']); ?>">
                                            </div>
                                            <div class="col-2 text-right">
    ...
    <script>
        (function () {
            function initAdminEventsCalendar() {
                ...
                var selectedQuickColor = '<?php echo e($calendarQuickColors[0] ?? '#007BFF'); ?>';
                var eventTextColor = '<?php echo e($eventTextColor); ?>';
                var recentLimit = <?php echo e($recentLimit); ?>;
                var feedUrl = '<?php echo e(route("admin.events.feed")); ?>';
                var canCreateEvents = <?php echo json_encode(auth()->user()->isAdmin() || auth()->user()->hasPermission('events.create'), 15, 512) ?>;
                var canEditEvents = <?php echo json_encode(auth()->user()->isAdmin() || auth()->user()->hasPermission('events.edit'), 15, 512) ?>;
                ...
                if (externalEventsEl && typeof DraggableCtor === 'function') {
                    new DraggableCtor(externalEventsEl, {
                        ...
                        eventData: function (eventEl) {
                            ...
                            var color = eventEl.getAttribute('data-color') || '<?php echo e($buttonColor); ?>';
                            return {
                                title: title,
                ...
                var calendar = new FullCalendar.Calendar(calendarEl, {
                    ...
                    defaultView: '<?php echo e($initialView); ?>',
                    firstDay: <?php echo e($firstDay); ?>,
                    weekends: <?php echo e($weekends ? 'true' : 'false'); ?>,
                    weekNumbers: <?php echo e($weekNumbers ? 'true' : 'false'); ?>,
                    height: 'auto',
                    contentHeight: 700,
                    events: feedUrl,
                ...
                $('#address').on('input', function () {
                    ...
                    debounceTimer = setTimeout(function () {
                        var bias = '<?php echo e($companyLocation ?? ""); ?>';
                ...
                $('#eventForm').on('submit', function (e) {
                    ...
                    const url = id ? '/admin/events/' + id : '<?php echo e(route("admin.events.store")); ?>';
                ...
                $('#btnAddTemplate').on('click', function () {
                    ...
                    var row = $(
                        ...
                        '<div class="col-3"><input type="color" class="form-control" name="templates[' + idx + '][color]" value="<?php echo e($buttonColor); ?>"></div>' +
                ...
                $('#btnAddQuickColor').on('click', function () {
                    ...
                    var row = $(
                        '<div class="form-row align-items-center mb-2 calendar-color-row">' +
                        '<div class="col-10"><input type="color" class="form-control" name="quick_colors[' + idx + ']" value="<?php echo e($buttonColor); ?>"></div>' +
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\Tudo\MEU-SISTEMA\SOMOS_UNN\resources\views\admin\events\calendar.blade.php ENDPATH**/ ?>
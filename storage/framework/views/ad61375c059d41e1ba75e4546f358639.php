        ...
        <table class="table table-striped">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="<?php echo e(route('admin.mailtemplates.edit', $t)); ?>" class="btn btn-sm btn-secondary">Editar</a>
                        <a href="#" onclick="preview(<?php echo e($t->id); ?>)" class="btn btn-sm btn-info">Pré-visualizar</a>
                        <form action="<?php echo e(route('admin.mailtemplates.destroy', $t)); ?>" method="POST" style="display:inline">
                            <?php echo csrf_field(); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/somosunn/public_html/resources/views/admin/mailtemplates/index.blade.php ENDPATH**/ ?>
...
<?php $__env->startSection('page_title', 'Fontes Personalizadas'); ?>
<?php $__env->startSection('breadcrumb'); ?><li class="breadcrumb-item active">Fontes</li><?php $__env->stopSection(); ?>
        ...
        <div class="card-body">
            ...
            <div class="table-responsive">
                <table class="table table-hover mb-0">
                    ...
                    <tbody>
                        <?php $__empty_1 = true; $__currentLoopData = $fonts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $font): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr id="font-<?php echo e($font->id); ?>">
                                <td>
                                    <strong><?php echo e($font->name); ?></strong>
                                    <div class="d-md-none small text-muted">
                                        <?php echo e($font->font_family); ?>

                                    </div>
                                </td>
                                <td class="d-none d-md-table-cell">
                                    <span style="font-family: <?php echo e($font->font_family); ?>;"><?php echo e($font->font_family); ?></span>
                                </td>
                                <td class="d-none d-lg-table-cell">
                                    <?php if($font->type === 'google_link'): ?>
                                ...
                                <td class="d-none d-lg-table-cell"><?php echo e(optional($font->uploader)->name ?? 'Sistema'); ?></td>
                                <td class="d-none d-md-table-cell">
                                    <small><?php echo e($font->created_at->format('d/m/Y')); ?></small>
                                </td>
                                <td class="text-right">
                                    <button class="btn btn-sm btn-outline-danger btn-delete-font" data-id="<?php echo e($font->id); ?>"
                                        data-name="<?php echo e($font->name); ?>">
    ...
    <script>
        $(document).ready(function () {
            ...
            $('#fontForm').on('submit', function (e) {
                ...
                $.ajax({
                    url: '<?php echo e(route("admin.fonts.store")); ?>',
                    type: 'POST',
                    data: formData,
                    processData: false,
                    contentType: false,
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\Tudo\MEU-SISTEMA\SOMOS_UNN\resources\views\admin\fonts\index.blade.php ENDPATH**/ ?>
    ...
    <div class="form-group mb-4">
        <div class="custom-control custom-switch custom-switch-lg custom-switch-off-danger custom-switch-on-success">
            ...
            <input type="checkbox" class="custom-control-input" id="video_player_enabled" name="video_player_enabled"
                value="1" <?php echo e(($settings['video_player_enabled'] ?? 1) ? 'checked' : ''); ?>>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group colorpicker-element">
                            <input name="video_plyr_color" class="form-control"
                                value="<?php echo e($settings['video_plyr_color'] ?? ($settings['site_color_primary'] ?? '#1F5EDB')); ?>">
                            <div class="input-group-append">
                                <span class="input-group-text"><i class="fas fa-square"
                                        style="color: <?php echo e($settings['video_plyr_color'] ?? ($settings['site_color_primary'] ?? '#1F5EDB')); ?>"></i></span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-6 form-group">
                            ...
                            <input type="number" name="video_plyr_seek_time" class="form-control"
                                value="<?php echo e($settings['video_plyr_seek_time'] ?? '10'); ?>">
                        </div>
                        <div class="col-6 form-group">
                            <label>Volume Inicial (0.0 - 1.0)</label>
                            <input type="number" step="0.1" min="0" max="1" name="video_plyr_volume"
                                class="form-control" value="<?php echo e($settings['video_plyr_volume'] ?? '0.8'); ?>">
                        </div>
                    </div>
                        ...
                        <div class="col-6">
                            <div
                                ...
                                <input type="checkbox" class="custom-control-input" id="video_plyr_autoplay"
                                    name="video_plyr_autoplay" value="1" <?php echo e(($settings['video_plyr_autoplay'] ?? 0) ? 'checked' : ''); ?>>
                            ...
                            <div
                                ...
                                <input type="checkbox" class="custom-control-input" id="video_plyr_muted"
                                    name="video_plyr_muted" value="1" <?php echo e(($settings['video_plyr_muted'] ?? 0) ? 'checked' : ''); ?>>
                        ...
                        <div class="col-6">
                            <div
                                ...
                                <input type="checkbox" class="custom-control-input" id="video_plyr_click_to_play"
                                    name="video_plyr_click_to_play" value="1" <?php echo e(($settings['video_plyr_click_to_play'] ?? 1) ? 'checked' : ''); ?>>
                            ...
                            <div
                                ...
                                <input type="checkbox" class="custom-control-input" id="video_plyr_disable_context_menu"
                                    name="video_plyr_disable_context_menu" value="1" <?php echo e(($settings['video_plyr_disable_context_menu'] ?? 1) ? 'checked' : ''); ?>>
            ...
            <div class="card card-outline card-secondary h-100">
                ...
                <div class="card-body">
                    <div class="form-group mb-0">
                        ...
                        ?>
                        <input type="hidden" name="video_plyr_controls" value="<?php echo e(implode(',', $currentControls)); ?>">
                        <div class="row">
                            <?php $__currentLoopData = $availableControls; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $control): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="col-md-6 mb-2">
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input plyr-control-checkbox"
                                            id="control_<?php echo e($control); ?>" value="<?php echo e($control); ?>" <?php echo e(in_array($control, $currentControls) ? 'checked' : ''); ?>>
                                        <label class="custom-control-label small"
                                            for="control_<?php echo e($control); ?>"><?php echo e(ucfirst($control)); ?></label>
                                    </div>
                                </div>
                ...
                <div class="col-md-6">
                    <div class="custom-control custom-switch custom-switch-off-danger custom-switch-on-success mb-3">
                        ...
                        <input type="checkbox" class="custom-control-input" id="video_watermark_enabled"
                            name="video_watermark_enabled" value="1" <?php echo e(($settings['video_watermark_enabled'] ?? 0) ? 'checked' : ''); ?>>
                    ...
                    <div class="upload-box" data-remove-input="#remove_watermark_image"
                        data-existing-url="<?php echo e($getUrl('watermark_image')); ?>">
                        ...
                        <div class="upload-preview mb-2 text-center">
                            <?php if($url = $getUrl('watermark_image')): ?>
                                <img src="<?php echo e($url); ?>" class="img-fluid" style="max-height: 50px;">
                            <?php else: ?>
                        ...
                        <div class="text-center">
                            ...
                            <button type="button"
                                class="btn btn-sm btn-outline-danger upload-remove <?php echo e($getUrl('watermark_image') ? '' : 'd-none'); ?>"><i
                ...
                <div class="col-md-6">
                    <div class="custom-control custom-switch custom-switch-off-danger custom-switch-on-success mb-3">
                        ...
                        <input type="checkbox" class="custom-control-input" id="video_watermark_text_enabled"
                            name="video_watermark_text_enabled" value="1" <?php echo e(($settings['video_watermark_text_enabled'] ?? 0) ? 'checked' : ''); ?>>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="video_watermark_text_template" class="form-control"
                            value="<?php echo e($settings['video_watermark_text_template'] ?? '{name} - {email}'); ?>">
                    ...
                    <div class="row">
                        <div class="col-6 form-group">
                            ...
                            <input type="number" step="0.1" name="video_watermark_opacity" class="form-control"
                                value="<?php echo e($settings['video_watermark_opacity'] ?? '0.5'); ?>">
                        </div>
                        <div class="col-6 form-group">
                            <label>Posição</label>
                            <select name="video_watermark_position" class="form-control">
                                <option value="top-right" <?php echo e(($settings['video_watermark_position'] ?? 'top-right') === 'top-right' ? 'selected' : ''); ?>>Topo Dir</option>
                                <option value="top-left" <?php echo e(($settings['video_watermark_position'] ?? '') === 'top-left' ? 'selected' : ''); ?>>Topo Esq</option>
                                <option value="bottom-right" <?php echo e(($settings['video_watermark_position'] ?? '') === 'bottom-right' ? 'selected' : ''); ?>>Inf Dir</option>
                                <option value="bottom-left" <?php echo e(($settings['video_watermark_position'] ?? '') === 'bottom-left' ? 'selected' : ''); ?>>Inf Esq</option>
                            </select>
                        </div>
                    </div>
                </div>
        ...
        <div class="collapse mt-2" id="advancedJson">
            <div class="form-group">
                <textarea name="video_plyr_options_json" class="form-control code-editor"
                    rows="5"><?php echo e($settings['video_plyr_options_json'] ?? ''); ?></textarea>
...
<?php $__env->stopPush(); ?><?php /**PATH G:\Tudo\MEU-SISTEMA\SOMOS_UNN\resources\views\admin\settings\partials\player.blade.php ENDPATH**/ ?>
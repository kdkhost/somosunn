            ...
            <div class="col mb-4">
                <div class="plan-card position-relative">
                    ...
                    <div class="plan-header">
                        ...
                        <?php if(auth()->check() && auth()->user()->can('settings.view')): ?>
                            <span class="badge plan-badge badge-light"><?php echo e($plan->is_active ? 'Ativo' : 'Inativo'); ?></span>
                        <?php endif; ?>
                    </div>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/somosunn/public_html/resources/views/admin/plans/index.blade.php ENDPATH**/ ?>
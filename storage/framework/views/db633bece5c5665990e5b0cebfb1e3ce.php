...
<?php $__env->startSection('title', \App\Models\SiteContent::getValue($cmsSlug, 'title', 'Como Funciona - UNN')); ?>
    ...
    <div class="bg-gradient-to-br from-slate-50 to-blue-50 min-h-screen">
            ...
            <div class="max-w-5xl mx-auto">
                <div class="space-y-12">
                    <?php $__currentLoopData = $steps; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $idx => $step): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        ?>
                        <div class="flex flex-col <?php echo e($wrapClass); ?> gap-6 md:gap-8 items-center">
                            ...
                            <div class="flex-1 bg-white rounded-3xl p-6 md:p-8 shadow-lg">
                                <h3 class="text-2xl font-bold text-gray-900 mb-3"><?php echo e($step['title'] ?? ''); ?></h3>
                                <p class="text-gray-600 mb-4">
                                    <?php echo e($step['text'] ?? ''); ?>

                                </p>
                                <ul class="space-y-2 text-gray-600">
                                    <?php $__currentLoopData = ['bullet_1','bullet_2','bullet_3']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bKey): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <?php if(!empty($step[$bKey])): ?>
                                            <li>
                                                <i class="fas fa-check mr-2" style="color: var(--unn-azul-1)"></i>
                                                <?php echo e($step[$bKey]); ?>
        ...
        <section class="py-16 px-6 md:px-12 lg:px-24 bg-white">
            <div class="max-w-7xl mx-auto">
                <h2 class="text-3xl font-black text-gray-900 mb-4 text-center"><?php echo e($plansTitle); ?></h2>
                <p class="text-gray-600 text-center mb-12 max-w-2xl mx-auto">
                    <?php echo e($plansSubtitle); ?>
                ...
                <div class="grid md:grid-cols-3 gap-8">
                    <?php $__currentLoopData = $plans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $plan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        ?>
                        <div class="rounded-3xl p-6 md:p-8 text-center <?php echo e($boxClass); ?>" <?php if($featured): ?> style="--tw-ring-color: var(--unn-azul-1)" <?php endif; ?>>
                            ...
                            <?php endif; ?>
                            <h3 class="text-xl font-bold text-gray-900 mb-2"><?php echo e($plan['title'] ?? ''); ?></h3>
                            <p class="text-4xl font-black mb-4" style="color: <?php echo e($featured ? 'var(--unn-azul-1)' : 'inherit'); ?>">
                                <?php echo e($price); ?><?php if($period !== ''): ?><span class="text-lg text-gray-500"><?php echo e($period); ?></span><?php endif; ?>
                            </p>
                            <p class="text-gray-500 mb-6"><?php echo e($plan['tagline'] ?? ''); ?></p>
                            <ul class="text-left space-y-3 mb-8">
                                <?php $__currentLoopData = ['feature_1','feature_2','feature_3','feature_4']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $fKey): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php if(!empty($plan[$fKey])): ?>
                                        <li class="flex items-center gap-2 text-gray-600">
                                            <i class="fas fa-check text-green-500"></i> <?php echo e($plan[$fKey]); ?>
                            ...
                            ?>
                            <a href="<?php echo e($buttonUrl); ?>" class="<?php echo e($btnClass); ?>" <?php if(!$featured): ?> style="border-color: var(--unn-azul-1); color: var(--unn-azul-1)" <?php endif; ?>>
                                <?php echo e($plan['button_text'] ?? 'Saiba mais'); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\Tudo\MEU-SISTEMA\SOMOS_UNN\resources\views\site\institucional\como-funciona.blade.php ENDPATH**/ ?>
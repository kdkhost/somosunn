            ...
            <div class="grid lg:grid-cols-2 gap-8 md:gap-12 items-center">
                <div>
                    ...
                    <div class="flex flex-wrap gap-4">
                        <a href="<?php echo e(route('register')); ?>" class="btn-primary text-white px-8 py-4 rounded-full font-bold inline-flex items-center gap-2 shadow-lg hover:shadow-xl transition">
                            <i class="fas fa-rocket"></i> Fazer parte
                        </a>
                        <a href="<?php echo e(route('manifesto')); ?>" class="bg-white text-gray-700 px-8 py-4 rounded-full font-bold inline-flex items-center gap-2 shadow-lg hover:shadow-xl transition">
...
<?php /**PATH G:\Tudo\MEU-SISTEMA\SOMOS_UNN\resources\views\site\institucional\_fallback\sobre.blade.php ENDPATH**/ ?>
<?php $__env->startSection('title', 'Cursos - UNN'); ?>
                            ...
                            <div class="rounded-[32px] overflow-hidden border border-white/20 bg-white/10 backdrop-blur shadow-[0_40px_120px_-60px_rgba(0,0,0,0.65)]">
                                <div class="grid lg:grid-cols-2">
                                    <div class="relative min-h-[260px] md:min-h-[320px]">
                                        <img src="<?php echo e($featuredImage ?: $fallbackFeaturedImage); ?>"
                                            alt="<?php echo e($featured->title ?? 'Curso'); ?>"
                                        ...
                                        <?php if(($featured->is_demo ?? false) === true): ?>
                                    ...
                                    <div class="p-8 md:p-10 bg-white">
                                        <div class="flex items-start justify-between gap-4">
                                            <div>
                                                <h2 class="text-2xl sm:text-3xl font-black text-slate-900 leading-tight">
                                                    <?php echo e($featured->title ?? 'Curso'); ?>

                                                </h2>
                                                <p class="mt-3 text-slate-600">
                                                    <?php echo e($featured->short_description ?? 'Aprenda com conteúdo objetivo e aplicável no seu dia a dia.'); ?>
                                                ...
                                                ?>
                                                <?php if($featuredReviewsCount > 0): ?>
                                                    <div class="mt-3 flex items-center gap-2 text-sm">
                                                        <span class="font-bold text-slate-900"><?php echo e(number_format($featuredAvgRating, 1, ',', '.')); ?></span>
                                                        <div class="flex items-center gap-0.5 text-yellow-400">
                                                            <?php for($i = 1; $i <= 5; $i++): ?>
                                                                <?php if($i <= floor($featuredAvgRating)): ?>
                                                                    <i class="fas fa-star text-xs"></i>
                                                                <?php elseif($i - $featuredAvgRating < 1): ?>
                                                        ...
                                                        <span class="text-slate-500">(<?php echo e($featuredReviewsCount); ?> <?php echo e($featuredReviewsCount === 1 ? 'avaliação' : 'avaliações'); ?>)</span>
                                                    </div>
                                                <?php endif; ?>
                                            </div>
                                            <?php if($featuredIsPaused): ?>
                                        ...
                                        <div class="mt-6 grid sm:grid-cols-3 gap-3">
                                            <div class="rounded-2xl bg-slate-50 border border-slate-100 p-4">
                                                ...
                                                <p class="text-slate-900 font-black mt-1"><?php echo e($featuredDurationLabel); ?></p>
                                            </div>
                                            <div class="rounded-2xl bg-slate-50 border border-slate-100 p-4">
                                                <p class="text-xs font-bold text-slate-500 uppercase tracking-wider">Instrutor</p>
                                                <p class="text-slate-900 font-black mt-1"><?php echo e($featuredAuthor); ?></p>
                                            </div>
                                            <div class="rounded-2xl bg-slate-50 border border-slate-100 p-4">
                                                <p class="text-xs font-bold text-slate-500 uppercase tracking-wider">Investimento</p>
                                                <p class="text-slate-900 font-black mt-1">
                                                    <?php echo e($featuredPrice > 0 ? 'R$ '.number_format($featuredPrice, 2, ',', '.') : 'Gratuito'); ?>
                                        ...
                                        <div class="mt-8 flex flex-col sm:flex-row gap-3">
                                            <a href="<?php echo e($featuredShowUrl); ?>"
                                            ...
                                            <?php elseif($featuredHasAccess): ?>
                                                <a href="<?php echo e($featuredShowUrl); ?>"
                                                    class="px-8 py-4 rounded-xl font-bold btn-primary shadow-lg hover:shadow-xl transition inline-flex items-center justify-center <?php echo e($isDemo ? 'pointer-events-none opacity-60' : ''); ?>">
                                                    Acessar curso
                                                </a>
                                            <?php else: ?>
                                                <a href="<?php echo e($featuredCheckoutUrl); ?>"
                                                    class="px-8 py-4 rounded-xl font-bold btn-primary shadow-lg hover:shadow-xl transition inline-flex items-center justify-center <?php echo e($isDemo ? 'pointer-events-none opacity-60' : ''); ?>">
                                                    Comprar agora
                                                </a>
                                            <?php endif; ?>
                ...
                <div class="bg-white rounded-3xl shadow-xl overflow-hidden">
                    <div class="px-6 py-5 border-b border-slate-100 flex items-center justify-between">
                        ...
                        <span class="text-sm text-gray-500">
                            <?php echo e($totalCount); ?> <?php echo e($totalCount === 1 ? 'curso' : 'cursos'); ?>

                        </span>
                    </div>

                    <?php if($coursesCollection->isEmpty()): ?>
                    ...
                    <?php else: ?>
                        <div class="p-6 md:p-8">
                            <div class="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
                                <?php $__currentLoopData = $coursesCollection; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $course): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php
                                    ...
                                    <div class="bg-white rounded-3xl border border-slate-100 shadow-sm hover:shadow-lg transition overflow-hidden">
                                        <div class="relative h-44 bg-slate-100 overflow-hidden">
                                            <?php if($thumbUrl): ?>
                                                <img src="<?php echo e($thumbUrl); ?>" alt="<?php echo e($course->title ?? 'Curso'); ?>" class="absolute inset-0 w-full h-full object-cover">
                                            ...
                                            <div class="absolute top-4 left-4 flex flex-wrap gap-2">
                                                <?php if(($course->is_demo ?? false) === true): ?>
                                                ...
                                                <?php endif; ?>
                                                <?php if(($course->is_featured ?? false) === true): ?>
                                                    <span class="inline-flex items-center gap-2 rounded-full bg-white/90 text-slate-700 px-3 py-1 text-[11px] font-black uppercase tracking-wider">
                                        ...
                                        <div class="p-6">
                                            <h4 class="text-lg font-black text-slate-900 leading-snug">
                                                <?php echo e($course->title ?? 'Curso'); ?>

                                            </h4>
                                            <p class="mt-2 text-sm text-slate-600">
                                                <?php echo e(Str::limit((string) ($course->short_description ?? 'Sem descrição.'), 110)); ?>
                                            ...
                                            <?php if($reviewsCount > 0): ?>
                                                <div class="mt-3 flex items-center gap-2 text-sm">
                                                    <span class="font-bold text-slate-900"><?php echo e(number_format($avgRating, 1, ',', '.')); ?></span>
                                                    <div class="flex items-center gap-0.5 text-yellow-400">
                                                        <?php for($i = 1; $i <= 5; $i++): ?>
                                                    ...
                                                    <span class="text-slate-500">(<?php echo e($reviewsCount); ?>)</span>
                                                </div>
                                            <?php endif; ?>

                                            <div class="mt-4 flex items-center justify-between text-sm text-slate-500">
                                                <span class="inline-flex items-center gap-2">
                                                    <i class="far fa-clock"></i> <?php echo e($durationLabel); ?>
                                            ...
                                            <div class="mt-3 text-xs text-slate-500">
                                                <i class="fas fa-user-circle mr-1"></i> <?php echo e($author); ?>

                                            </div>

                                            <div class="mt-6 flex flex-col sm:flex-row gap-3">
                                                <a href="<?php echo e($courseShowUrl); ?>"
                                                    class="w-full flex-1 px-4 py-3 rounded-xl font-bold border-2 border-slate-200 text-slate-700 hover:bg-slate-50 transition inline-flex items-center justify-center whitespace-nowrap <?php echo e($isDemo ? 'pointer-events-none opacity-60' : ''); ?>">
                                                    Saiba mais
                                                </a>
                                                ...
                                                <?php elseif($hasAccess): ?>
                                                    <a href="<?php echo e($courseShowUrl); ?>"
                                                        class="w-full flex-1 px-4 py-3 rounded-xl font-bold btn-primary shadow-md hover:shadow-lg transition inline-flex items-center justify-center whitespace-nowrap <?php echo e($isDemo ? 'pointer-events-none opacity-60' : ''); ?>">
                                                        Acessar
                                                    </a>
                                                <?php else: ?>
                                                    <a href="<?php echo e($courseCheckoutUrl); ?>"
                                                        class="w-full flex-1 px-4 py-3 rounded-xl font-bold btn-primary shadow-md hover:shadow-lg transition inline-flex items-center justify-center whitespace-nowrap <?php echo e($isDemo ? 'pointer-events-none opacity-60' : ''); ?>">
                                                        Comprar
                                                    </a>
                                                <?php endif; ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\Tudo\MEU-SISTEMA\SOMOS_UNN\resources\views\courses\index.blade.php ENDPATH**/ ?>
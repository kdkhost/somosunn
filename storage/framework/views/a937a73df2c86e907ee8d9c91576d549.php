                    ...
                    <div class="row align-items-center">
                        <div class="col-auto">
                            ...
                            <?php else: ?>
                                <div class="rounded-circle bg-primary d-flex align-items-center justify-content-center border border-light elevation-2"
                                    ...
                                    <?php echo e($user ? substr($user->name ?? '', 0, 1) : '?'); ?>

                                </div>
                            <?php endif; ?>
                        </div>
                        <div class="col">
                            <h2 class="h4 font-weight-bold mb-1">Olá, <?php echo e($user?->name); ?>!</h2>
                        ...
                        <div class="col-md-auto mt-3 mt-md-0 text-md-right">
                            <div class="badge badge-light p-2 px-3 shadow-sm">
                                ...
                                <span class="font-weight-bold text-primary"><?php echo e($roleLabel); ?></span>
                            </div>
                            <div class="mt-3">
                                <a href="<?php echo e(route('admin.users.index')); ?>" class="btn btn-sm btn-light mr-2">
                                    <i class="fas fa-users mr-1"></i> Usuários
                                </a>
                                <a href="<?php echo e(route('admin.plans.index')); ?>" class="btn btn-sm btn-outline-light mr-2">
                                    <i class="fas fa-crown mr-1"></i> Planos
                                </a>
                                <a href="<?php echo e(route('admin.settings', ['group' => 'general'])); ?>" class="btn btn-sm btn-outline-light">
    ...
    <div class="row">
        <div class="col-lg-3 col-sm-6 col-12">
            <div class="small-box bg-success">
                <div class="inner">
                    <h3>R$ <?php echo e(number_format((float) $totalRevenue, 2, ',', '.')); ?></h3>
                    <p>Receita (Total)</p>
                </div>
        ...
        <div class="col-lg-3 col-sm-6 col-12">
            <div class="small-box bg-info">
                <div class="inner">
                    <h3>R$ <?php echo e(number_format((float) $monthRevenue, 2, ',', '.')); ?></h3>
                    <p>Receita (Mês)</p>
                </div>
        ...
        <div class="col-lg-3 col-sm-6 col-12">
            <div class="small-box bg-warning">
                <div class="inner">
                    <h3><?php echo e((int) $pendingOrders); ?></h3>
        ...
        <div class="col-lg-3 col-sm-6 col-12">
            <div class="small-box bg-primary">
                <div class="inner">
                    <h3><?php echo e((int) $activeSubscriptions); ?></h3>
                    <p>Assinaturas Ativas</p>
                </div>
                <div class="icon"><i class="fas fa-sync-alt"></i></div>
                <a href="<?php echo e(route('admin.plans.index')); ?>" class="small-box-footer">
    ...
    <div class="row">
        <div class="col-lg-3 col-sm-6 col-12">
            <div class="small-box bg-danger">
                <div class="inner">
                    <h3>R$ <?php echo e(number_format((float) $refundedAmount, 2, ',', '.')); ?></h3>
                    <p>Reembolsos</p>
                </div>
        ...
        <div class="col-lg-3 col-sm-6 col-12">
            <div class="small-box bg-secondary">
                <div class="inner">
                    <h3><?php echo e((int) $issuedInvoices); ?></h3>
                    <p>Faturas (Emitidas/Rascunho)</p>
                </div>
                <div class="icon"><i class="fas fa-file-invoice"></i></div>
                <a href="<?php echo e(route('admin.invoices.index')); ?>" class="small-box-footer">
        ...
        <div class="col-lg-3 col-sm-6 col-12">
            <div class="small-box bg-warning">
                <div class="inner">
                    <h3><?php echo e((int) $totalUsers); ?></h3>
        ...
        <div class="col-lg-3 col-sm-6 col-12">
            <div class="small-box bg-info">
                <div class="inner">
                    <h3><?php echo e((int) $totalOrders); ?></h3>
        ...
        <div class="row">
            <div class="col-lg-3 col-sm-6 col-12">
                <div class="small-box bg-dark">
                    <div class="inner">
                        <h3><?php echo e((int) $activePlans); ?></h3>
                        <p>Planos (Ativos)</p>
                    </div>
            ...
            <div class="col-lg-3 col-sm-6 col-12">
                <div class="small-box bg-danger">
                    <div class="inner">
                        <h3><?php echo e((int) $overdueInvoices); ?></h3>
            ...
            <div class="col-lg-3 col-sm-6 col-12">
                <div class="small-box bg-danger">
                    <div class="inner">
                        <h3><?php echo e((int) $failedOrders); ?></h3>
            ...
            <div class="col-lg-3 col-sm-6 col-12">
                <div class="small-box bg-success">
                    <div class="inner">
                        <h3>R$ <?php echo e(number_format((float) $todayRevenue, 2, ',', '.')); ?></h3>
                        <p>Receita (Hoje)</p>
                    </div>
                    ...
                    <div class="card-body p-0">
                        <div class="table-responsive">
                            <table class="table table-striped mb-0">
                                ...
                                <tbody>
                                    <?php $__empty_1 = true; $__currentLoopData = $topSellers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <tr>
                                            <td><?php echo e($row['seller_name'] ?? '-'); ?></td>
                                            <td class="text-right"><?php echo e((int) ($row['orders_count'] ?? 0)); ?></td>
                                            <td class="text-right">
                                                R$ <?php echo e(number_format((float) ($row['total_amount'] ?? 0), 2, ',', '.')); ?>
                                    ...
                                    <?php $__empty_1 = true; $__currentLoopData = $recentOrders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                ?>
                                                <span class="badge badge-<?php echo e($badge); ?>"><?php echo e(strtoupper($st ?: 'N/A')); ?></span>
                                            </td>
                                            <td class="text-right">
                                                R$ <?php echo e(number_format((float) $order->total_amount, 2, ',', '.')); ?>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\Tudo\MEU-SISTEMA\SOMOS_UNN\resources\views\admin\dashboard.blade.php ENDPATH**/ ?>
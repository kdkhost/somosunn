...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Admin - UNN'); ?></title>
    <link rel="icon" href="<?php echo e($faviconUrl); ?>" type="image/svg+xml">
...
<body
    class="<?php echo e($isSuperAdmin ? 'hold-transition sidebar-mini layout-fixed layout-navbar-fixed' : 'bg-slate-50 min-h-screen'); ?> <?php echo e($siteTheme === 'dark' ? 'dark-mode' : ''); ?>">
    ...
    <?php if(session()->has('impersonator_id')): ?>
        <div id="impersonation-badge"
            ...
            <span class="text-truncate mr-2"><?php echo e(auth()->user()->name); ?></span>
            <a href="<?php echo e(route('admin.impersonate.stop')); ?>" class="btn btn-xs btn-danger">Sair</a>
    ...
    <?php if($isSuperAdmin): ?>
        <div class="wrapper">
            <?php if($preloaderEnabled && (!auth()->check() || !auth()->user()->isAdmin())): ?>
                <div class="preloader flex-column justify-content-center align-items-center">
                    <img class="animation__shake" src="<?php echo e($preloaderImage); ?>" alt="UNN" height="80" width="80">
                </div>
            <?php endif; ?>
            ...
            <div class="content-wrapper">
                <?php if(View::hasSection('page_title') || View::hasSection('breadcrumb')): ?>
                    <div class="content-header">
                        <div class="container-fluid">
                            <div class="d-flex justify-content-between align-items-center py-2">
                                <h1 class="m-0 h4"><?php echo $__env->yieldContent('page_title'); ?></h1>
                                <ol class="breadcrumb mb-0">
                                    <li class="breadcrumb-item"><a href="<?php echo e(route('admin.dashboard')); ?>" data-pjax>Home</a></li>
                                    <?php if (! empty(trim($__env->yieldContent('breadcrumb_items')))): ?>
                                        <?php echo $__env->yieldContent('breadcrumb_items'); ?>
                                    <?php else: ?>
                                        <li class="breadcrumb-item active"><?php echo $__env->yieldContent('page_title'); ?></li>
                                    <?php endif; ?>
                                </ol>
                            </div>
                        </div>
                        ...
                        <?php if(View::hasSection('page_title')): ?>
                            <div class="bg-white rounded-3xl shadow-sm border border-slate-100 p-6 mb-6">
                                <div class="flex items-center justify-between gap-4">
                                    <div>
                                        <h1 class="text-2xl md:text-3xl font-extrabold text-slate-900"><?php echo $__env->yieldContent('page_title'); ?></h1>
    ...
    <?php echo $__env->make('admin.partials.chat-widget', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php /**PATH G:\Tudo\MEU-SISTEMA\SOMOS_UNN\resources\views\admin\layouts\app.blade.php ENDPATH**/ ?>
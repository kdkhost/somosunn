            ...
            <div class="row">
                <div class="col-md-12 mb-3">
                    ...
                    <select name="mercadopago_env" class="form-control gateway-env-select" data-gateway="mercadopago">
                        <option value="sandbox" <?php echo e(($settings['mercadopago_env'] ?? 'sandbox') == 'sandbox' ? 'selected' : ''); ?>>Sandbox (Ambiente de Testes)</option>
                        <option value="production" <?php echo e(($settings['mercadopago_env'] ?? 'sandbox') == 'production' ? 'selected' : ''); ?>>Produção (Ambiente Real)</option>
                    </select>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-md-6 form-group">
                        ...
                        <input type="text" name="mercadopago_sandbox_public_key" class="form-control"
                            value="<?php echo e($settings['mercadopago_sandbox_public_key'] ?? ''); ?>">
                    </div>
                    <div class="col-md-6 form-group">
                        <label>Access Token (Sandbox)</label>
                        <input type="text" name="mercadopago_sandbox_access_token" class="form-control"
                            value="<?php echo e($settings['mercadopago_sandbox_access_token'] ?? ''); ?>">
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-md-6 form-group">
                        ...
                        <input type="text" name="mercadopago_prod_public_key" class="form-control"
                            value="<?php echo e($settings['mercadopago_prod_public_key'] ?? ''); ?>">
                    </div>
                    <div class="col-md-6 form-group">
                        <label>Access Token (Produção)</label>
                        <input type="text" name="mercadopago_prod_access_token" class="form-control"
                            value="<?php echo e($settings['mercadopago_prod_access_token'] ?? ''); ?>">
                    </div>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="input-group">
                    <input type="text" class="form-control bg-white" readonly
                        value="<?php echo e(route('api.webhooks.mercadopago')); ?>">
    ...
    <div class="card card-outline card-warning collapsed-card mb-4">
        ...
        <div class="card-body" style="display: none;">
            <div class="row">
                <div class="col-md-6 form-group">
                    ...
                    <input type="email" name="pagseguro_email" class="form-control"
                        value="<?php echo e($settings['pagseguro_email'] ?? ''); ?>">
                </div>
                <div class="col-md-6 form-group">
                    <label>Ambiente de Execução</label>
                    <select name="pagseguro_env" class="form-control gateway-env-select" data-gateway="pagseguro">
                        <option value="sandbox" <?php echo e(($settings['pagseguro_env'] ?? 'sandbox') == 'sandbox' ? 'selected' : ''); ?>>Sandbox (Testes)</option>
                        <option value="production" <?php echo e(($settings['pagseguro_env'] ?? 'sandbox') == 'production' ? 'selected' : ''); ?>>Produção</option>
                    </select>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-md-12 form-group">
                        ...
                        <input type="text" name="pagseguro_sandbox_token" class="form-control"
                            value="<?php echo e($settings['pagseguro_sandbox_token'] ?? ''); ?>">
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-md-12 form-group">
                        ...
                        <input type="text" name="pagseguro_prod_token" class="form-control"
                            value="<?php echo e($settings['pagseguro_prod_token'] ?? ''); ?>">
                    </div>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="input-group">
                    <input type="text" class="form-control bg-white" readonly
                        value="<?php echo e(route('api.webhooks.pagseguro')); ?>">
                    <div class="input-group-append">
                        <button class="btn btn-outline-secondary" type="button"
                            onclick="navigator.clipboard.writeText(this.parentElement.previousElementSibling.value); toastr.success('Copiado!')"><i
                                class="fas fa-copy"></i> Copiar</button>
    ...
    <div class="form-group mb-4">
        <div class="custom-control custom-switch custom-switch-lg custom-switch-off-danger custom-switch-on-success">
            ...
            <input type="checkbox" class="custom-control-input" id="gateway_transparent_checkout"
                name="gateway_transparent_checkout" value="1" <?php echo e(($settings['gateway_transparent_checkout'] ?? 0) ? 'checked' : ''); ?>>
    ...
    <div class="row">
        <div class="col-md-4 form-group">
            ...
            <div class="input-group">
                <input type="number" step="0.01" name="gateway_installment_tax" class="form-control"
                    value="<?php echo e($settings['gateway_installment_tax'] ?? '0.00'); ?>">
                <div class="input-group-append">
        ...
        <div class="col-md-4 form-group">
            ...
            <input type="number" name="gateway_max_installments_no_interest" class="form-control"
                value="<?php echo e($settings['gateway_max_installments_no_interest'] ?? '1'); ?>">
        </div>
        <div class="col-md-4 form-group">
            <label>Repassar Taxas ao Cliente?</label>
            <select name="gateway_pass_tax_to_client" class="form-control">
                <option value="0" <?php echo e(($settings['gateway_pass_tax_to_client'] ?? 0) == 0 ? 'selected' : ''); ?>>Não (Empresa
                    absorve taxas)</option>
                <option value="1" <?php echo e(($settings['gateway_pass_tax_to_client'] ?? 0) == 1 ? 'selected' : ''); ?>>Sim (Cliente
                    paga taxas)</option>
            </select>
        </div>
    </div>
...
<?php $__env->stopPush(); ?><?php /**PATH G:\Tudo\MEU-SISTEMA\SOMOS_UNN\resources\views\admin\settings\partials\gateway.blade.php ENDPATH**/ ?>
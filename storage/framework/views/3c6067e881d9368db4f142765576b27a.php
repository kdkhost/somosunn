...
<?php $__env->startSection('title', 'Comunidade - UNN'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <div class="bg-gray-100 min-h-screen <?php echo e($isAdminContext ? 'pt-0' : 'pt-4'); ?>">
        <div class="<?php echo e($isAdminContext ? 'mx-auto px-0' : 'max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'); ?>">
            <div class="<?php echo e($isAdminContext ? 'grid grid-cols-1 gap-6' : 'grid grid-cols-1 md:grid-cols-12 gap-6'); ?>">
                            ...
                            <?php if(auth()->guard()->check()): ?>
                                <div class="flex items-center gap-3 mb-6">
                                    <div class="rounded-full w-10 h-10 overflow-hidden flex-shrink-0">
                                        <img src="<?php echo e($authAvatar); ?>" alt="Avatar" class="w-10 h-10 object-cover"
                ...
                <!-- Centro -->
                <div class="<?php echo e($isAdminContext ? 'space-y-6' : 'md:col-span-6 space-y-6'); ?>">
                    <div id="feed-panel" class="space-y-6">
                        <?php if(auth()->guard()->check()): ?>
                            <div class="bg-white rounded-lg shadow p-4">
                                <form id="post-form" action="<?php echo e(route('social.post.store')); ?>" method="POST" enctype="multipart/form-data">
                                    <?php echo csrf_field(); ?>
                        ...
                        <?php $__empty_1 = true; $__currentLoopData = $posts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $post): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            ...
                            <?php if($adsEnabled && $loop->iteration % $adsenseFrequency === 0): ?>
                                <div class="bg-white rounded-lg shadow p-4 ad-container">
                                    <?php if($hasAdsense): ?>
                                        <ins class="adsbygoogle"
                                             style="display:block"
                                             data-ad-client="<?php echo e($adsensePublisherId); ?>"
                                             data-ad-slot="<?php echo e($adsenseSlotId); ?>"
                                             data-ad-format="<?php echo e($adsenseFormat); ?>"
                                             data-full-width-responsive="true"></ins>
                                        <script>(adsbygoogle = window.adsbygoogle || []).push({});</script>
                                    <?php elseif(!empty($adsCode)): ?>
                                        <?php echo $adsCode; ?>
                            ...
                            <div class="flex items-center justify-between border-b border-gray-100 pb-3 mb-4">
                                <div class="flex items-center gap-3">
                                    <div class="w-10 h-10 rounded-full overflow-hidden bg-gray-100" id="conversation-avatar-wrap">
                                        <img id="conversation-avatar" src="<?php echo e(asset('img/default-user.svg')); ?>" alt="Avatar"
                                ...
                                <?php if(!empty($recommendedUsers) && $recommendedUsers->isNotEmpty()): ?>
                                    ...
                                    <?php $__currentLoopData = $recommendedUsers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <div class="flex items-center justify-between gap-3">
                                            <div class="flex items-center gap-3">
                                                <a class="rounded-full w-10 h-10 overflow-hidden flex-shrink-0" href="<?php echo e(route('social.profile', $user->id)); ?>">
                                                    <img src="<?php echo e($user->profile_photo_url); ?>" alt="Avatar"
                                                        class="w-10 h-10 object-cover"
                                                        onerror="this.onerror=null;this.src='<?php echo e(asset('img/default-user.svg')); ?>';">
                                                </a>
                                                <div>
                                                    <a href="<?php echo e(route('social.profile', $user->id)); ?>" class="text-sm font-semibold text-gray-800 hover:text-blue-600">
                                            ...
                                            <div class="text-right">
                                                ...
                                                <?php elseif($isPending && $isRequester): ?>
                                                    <div class="text-[11px] text-gray-400">Pendente <?php echo e($pendingTime); ?></div>
                                                    <button type="button"
                        ...
                        <div id="right-conversation-info" class="bg-white rounded-lg shadow p-4 sticky top-24 hidden">
                            <div class="flex flex-col items-center text-center mb-4">
                                <div class="w-20 h-20 rounded-full overflow-hidden bg-gray-100 mb-3">
                                    <img id="conversation-info-avatar" src="<?php echo e(asset('img/default-user.svg')); ?>" alt="Avatar"
...
<?php echo $__env->make($extends ?? 'layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\Tudo\MEU-SISTEMA\SOMOS_UNN\resources\views\social\feed.blade.php ENDPATH**/ ?>
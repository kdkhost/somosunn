<?php $__env->startSection('title', 'UNN - Networking Premium'); ?>
        ...
        <div class="grid lg:grid-cols-2 gap-16 items-center">
            <div class="animate-fadeInUp">
                ...
                <div class="flex flex-col sm:flex-row gap-4">
                    <a href="<?php echo e(route('register')); ?>" class="btn-primary text-white px-10 py-4 rounded-lg font-semibold text-lg relative z-10">Quero fazer parte <i class="fas fa-arrow-right ml-2"></i></a>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/somosunn/public_html/resources/views/site/premium.blade.php ENDPATH**/ ?>
...
<?php $__env->startSection('title', 'Assinar Plano ' . $plan->name); ?>
    ...
    <div class="max-w-6xl mx-auto">
        <div class="grid lg:grid-cols-3 gap-8">
            ...
            <div class="lg:col-span-1">
                <div class="bg-white rounded-2xl shadow-lg p-6 sticky top-32">
                    ...
                    <div class="flex items-center gap-4 mb-6">
                        <?php if($plan->image): ?>
                            <img src="<?php echo e(asset($plan->image)); ?>" alt="<?php echo e($plan->name); ?>" class="w-16 h-16 rounded-lg object-cover">
                        <?php else: ?>
                        ...
                        <?php endif; ?>
                        <div>
                            <h4 class="font-bold text-gray-900"><?php echo e($plan->name); ?></h4>
                            <p class="text-sm text-gray-500">Assinatura <?php echo e($plan->period); ?> dias</p>
                        </div>
                    </div>
                    ...
                    <div class="border-t border-gray-100 py-4 space-y-2">
                        <div class="flex justify-between text-gray-600">
                            <span>Subtotal</span>
                            <span>R$ <?php echo e(number_format($plan->price, 2, ',', '.')); ?></span>
                        </div>
                    ...
                    <div class="border-t border-gray-100 pt-4 mb-6">
                        <div class="flex justify-between items-center">
                            ...
                            <span class="text-2xl font-black text-blue-600">R$ <?php echo e(number_format($plan->price, 2, ',', '.')); ?></span>
                        </div>
                    </div>
            ...
            <div class="lg:col-span-2">
                <form action="<?php echo e(route('subscription.process', $plan->id)); ?>" method="POST" id="paymentForm">
                    <?php echo csrf_field(); ?>
                    ...
                    <?php if(($plan->price ?? 0) > 0 && !($paymentConfigured ?? false)): ?>
                    ...
                    <div class="bg-white rounded-2xl shadow-lg p-6 md:p-8 mb-8">
                        ...
                        <div class="grid md:grid-cols-2 gap-6">
                            <div class="md:col-span-2">
                                ...
                                <input type="text" name="name" value="<?php echo e(old('name')); ?>" class="w-full rounded-lg border-gray-300 focus:border-blue-500 focus:ring-blue-500" required>
                            </div>
                            
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-2">E-mail</label>
                                <input type="email" name="email" value="<?php echo e(old('email')); ?>" class="w-full rounded-lg border-gray-300 focus:border-blue-500 focus:ring-blue-500" required>
                            </div>

                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-2">CPF</label>
                                <input type="text" name="cpf" value="<?php echo e(old('cpf')); ?>" class="w-full rounded-lg border-gray-300 focus:border-blue-500 focus:ring-blue-500" placeholder="000.000.000-00" required>
                            </div>

                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-2">Celular</label>
                                <input type="text" name="phone" value="<?php echo e(old('phone')); ?>" class="w-full rounded-lg border-gray-300 focus:border-blue-500 focus:ring-blue-500" required>
                            </div>
                    ...
                    <div class="bg-blue-50 border border-blue-100 rounded-2xl p-6 mb-8 flex items-center justify-between">
                        <div class="flex items-center gap-4">
                            ...
                            <div>
                                <p class="font-bold text-gray-900">Logado como <?php echo e(Auth::user()->name); ?></p>
                    ...
                    <div class="bg-white rounded-2xl shadow-lg p-6 md:p-8">
                        ...
                        <div id="creditCardForm" class="space-y-6">
                            ...
                            <input type="hidden" name="transaction_amount" id="transaction_amount" value="<?php echo e($plan->price); ?>">
                        ...
                        <button type="submit"
                            ...
                            <?php echo e((($plan->price ?? 0) > 0 && !($paymentConfigured ?? false)) ? 'disabled' : ''); ?>>
...
<?php if(($paymentConfigured ?? false) && ($plan->price ?? 0) > 0): ?>
    ...
    const renderCardPaymentBrick = async (bricksBuilder) => {
        const settings = {
            initialization: {
                ...
                payer: {
                    email: "<?php echo e(Auth::check() ? Auth::user()->email : 'test@test.com'); ?>", // Pre-fill if logged in
                },
            },
            customization: {
                visual: {
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\Tudo\MEU-SISTEMA\SOMOS_UNN\resources\views\site\subscription\checkout.blade.php ENDPATH**/ ?>
<?php $__env->startSection('title', 'Painel do Membro - UNN'); ?>
...
<?php $__env->startSection('panel_content'); ?>
        ...
        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <div class="min-w-0">
                <div class="flex items-center gap-3 flex-wrap">
                    <h1 class="text-2xl md:text-3xl font-extrabold text-slate-900 truncate">Olá, <?php echo e($user?->name); ?>!</h1>
                    <?php if($roleLabel): ?>
                        <span class="inline-flex items-center rounded-full bg-slate-900/5 px-3 py-1 text-xs font-extrabold text-slate-700">
                            <i class="fas fa-shield-alt mr-2 opacity-70"></i> <?php echo e($roleLabel); ?>
                ...
                <p class="text-slate-600 mt-1">
                    ...
                    <?php else: ?>
                        <?php echo e($plan?->name ? 'Plano ativo: ' . $plan->name : 'Você ainda não possui um plano ativo.'); ?>

                    <?php endif; ?>
                </p>
            </div>
            <div class="flex flex-wrap gap-3">
                <a href="<?php echo e(route('panel.profile.edit')); ?>"
                ...
                <?php if(!$isSuperadminUser): ?>
                    <a href="<?php echo e(route('panel.admin')); ?>"
    ...
    <?php if(!$profileComplete && !$roleLabel): ?>
        ...
        <div class="bg-white rounded-3xl shadow-sm border border-slate-100 p-5">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <div class="text-3xl font-extrabold text-slate-900 mt-1"><?php echo e($coursesCount); ?></div>
                </div>
            ...
            <div class="mt-4 text-sm text-slate-600">
                <?php if($canAccessCourses): ?>
                    Acesse seus cursos em <a class="text-[#1F5EDB] font-bold hover:underline" href="<?php echo e(route('courses.index')); ?>">Cursos</a>.
                <?php else: ?>
        ...
        <div class="bg-white rounded-3xl shadow-sm border border-slate-100 p-5">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <div class="text-3xl font-extrabold text-slate-900 mt-1"><?php echo e($ordersPaidCount); ?></div>
                </div>
            ...
            <div class="mt-4 text-sm text-slate-600">
                Total: <span class="font-extrabold text-slate-900">R$ <?php echo e(number_format($ordersPaidTotal, 2, ',', '.')); ?></span>
            </div>
        </div>
        ...
        <div class="bg-white rounded-3xl shadow-sm border border-slate-100 p-5">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <div class="text-3xl font-extrabold text-slate-900 mt-1"><?php echo e($sellerPaidCount); ?></div>
                </div>
            ...
            <div class="mt-4 text-sm text-slate-600">
                Líquido: <span class="font-extrabold text-slate-900">R$ <?php echo e(number_format($sellerNetTotal, 2, ',', '.')); ?></span>
            </div>
            <?php if($canSellOnMarketplace): ?>
                <div class="mt-3">
            ...
            <div class="bg-white rounded-3xl shadow-sm border border-slate-100 p-5 md:col-span-2 xl:col-span-4">
                <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                    ...
                    <div class="flex flex-wrap gap-3">
                        ...
                        <a href="<?php echo e(route('panel.admin', ['to' => 'settings/general'])); ?>"
                            class="inline-flex items-center justify-center rounded-full border border-slate-200 px-5 py-2.5 text-sm font-bold text-slate-700 hover:bg-slate-100 transition">
                            <i class="fas fa-cogs mr-2"></i> Configurações
                        </a>
                        <a href="<?php echo e(route('panel.admin', ['to' => 'settings/gateway'])); ?>"
                            class="inline-flex items-center justify-center rounded-full border border-slate-200 px-5 py-2.5 text-sm font-bold text-slate-700 hover:bg-slate-100 transition">
                            <i class="fas fa-credit-card mr-2"></i> Gateway
                        </a>
                        <a href="<?php echo e(route('panel.admin', ['to' => 'mailtemplates'])); ?>"
                            class="inline-flex items-center justify-center rounded-full border border-slate-200 px-5 py-2.5 text-sm font-bold text-slate-700 hover:bg-slate-100 transition">
...
<?php echo $__env->make('panel.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\Tudo\MEU-SISTEMA\SOMOS_UNN\resources\views\panel\dashboard.blade.php ENDPATH**/ ?>
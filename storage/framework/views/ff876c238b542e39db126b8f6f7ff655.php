<div class="card-body">
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <input type="text" name="hero_title" class="form-control form-control-lg"
                    value="<?php echo e($settings['hero_title'] ?? 'Transforme sua carreira'); ?>">
            </div>
            <div class="form-group">
                <label>Subtítulo</label>
                <textarea name="hero_subtitle" class="form-control"
                    rows="3"><?php echo e($settings['hero_subtitle'] ?? 'Junte-se a milhares de membros e aprenda com os melhores.'); ?></textarea>
            </div>
        </div>
        <div class="col-md-6">
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input name="site_bg_gradient_opacity" type="number" min="0" max="100" class="form-control"
                            value="<?php echo e($settings['site_bg_gradient_opacity'] ?? 85); ?>">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <div class="input-group colorpicker-element">
                            <input name="site_bg_gradient_start" class="form-control"
                                value="<?php echo e($settings['site_bg_gradient_start'] ?? '#000000'); ?>">
                            <div class="input-group-append">
                                <span class="input-group-text"><i class="fas fa-square"
                                        style="color: <?php echo e($settings['site_bg_gradient_start'] ?? '#000000'); ?>"></i></span>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="row">
        <div class="col-md-6 form-group">
            ...
            <input name="events_hero_bg_blur_px" type="number" class="form-control"
                value="<?php echo e($settings['events_hero_bg_blur_px'] ?? 64); ?>">
        ...
        <div class="col-md-6 form-group">
            ...
            <input name="events_hero_film_strength_percent" type="number" min="0" max="100" class="form-control"
                value="<?php echo e($settings['events_hero_film_strength_percent'] ?? 100); ?>">
    ...
    <div class="row">
        <div class="col-md-3 form-group">
            ...
            <select name="site_theme" class="form-control">
                <option value="light" <?php echo e(($settings['site_theme'] ?? 'light') === 'light' ? 'selected' : ''); ?>>Light
                    (Claro)</option>
                <option value="dark" <?php echo e(($settings['site_theme'] ?? '') === 'dark' ? 'selected' : ''); ?>>Dark (Escuro)
                </option>
            </select>
        </div>
        <div class="col-md-3 form-group">
            ...
            <div class="input-group colorpicker-element">
                <input name="site_color_primary" class="form-control"
                    value="<?php echo e($settings['site_color_primary'] ?? '#007bff'); ?>">
                <div class="input-group-append">
                    <span class="input-group-text"><i class="fas fa-square"
                            style="color: <?php echo e($settings['site_color_primary'] ?? '#007bff'); ?>"></i></span>
                </div>
            </div>
        </div>
        <div class="col-md-3 form-group">
            ...
            <div class="input-group colorpicker-element">
                <input name="site_color_secondary" class="form-control"
                    value="<?php echo e($settings['site_color_secondary'] ?? '#6c757d'); ?>">
                <div class="input-group-append">
                    <span class="input-group-text"><i class="fas fa-square"
                            style="color: <?php echo e($settings['site_color_secondary'] ?? '#6c757d'); ?>"></i></span>
                </div>
            </div>
        </div>
        <div class="col-md-3 form-group">
            ...
            <input name="site_font_family" class="form-control"
                value="<?php echo e($settings['site_font_family'] ?? 'Inter, sans-serif'); ?>">
    ...
    <div class="form-group">
        ...
        <textarea name="footer_text" class="form-control" rows="2"><?php echo e($settings['footer_text'] ?? ''); ?></textarea>
    </div>
    ...
    <div class="form-group mb-4">
        <div class="custom-control custom-switch custom-switch-lg">
            ...
            <input type="checkbox" class="custom-control-input" id="auth_visual_animation_enabled"
                name="auth_visual_animation_enabled" value="1" <?php echo e(($settings['auth_visual_animation_enabled'] ?? 1) ? 'checked' : ''); ?>>
        ...
        <div class="col-md-3 form-group">
            <div class="custom-control custom-switch">
                ...
                <input type="checkbox" class="custom-control-input" id="auth_visual_animation_login"
                    name="auth_visual_animation_login" value="1" <?php echo e(($settings['auth_visual_animation_login'] ?? 1) ? 'checked' : ''); ?>>
        ...
        <div class="col-md-3 form-group">
            <div class="custom-control custom-switch">
                ...
                <input type="checkbox" class="custom-control-input" id="auth_visual_animation_register"
                    name="auth_visual_animation_register" value="1" <?php echo e(($settings['auth_visual_animation_register'] ?? 1) ? 'checked' : ''); ?>>
        ...
        <div class="col-md-3 form-group">
            <div class="custom-control custom-switch">
                ...
                <input type="checkbox" class="custom-control-input" id="auth_visual_animation_password_email"
                    name="auth_visual_animation_password_email" value="1" <?php echo e(($settings['auth_visual_animation_password_email'] ?? 1) ? 'checked' : ''); ?>>
        ...
        <div class="col-md-3 form-group">
            <div class="custom-control custom-switch">
                ...
                <input type="checkbox" class="custom-control-input" id="auth_visual_animation_password_reset"
                    name="auth_visual_animation_password_reset" value="1" <?php echo e(($settings['auth_visual_animation_password_reset'] ?? 1) ? 'checked' : ''); ?>>
    ...
    <div class="form-group">
        <div class="custom-control custom-switch custom-switch-lg">
            <input type="checkbox" class="custom-control-input" id="preloader_enabled" name="preloader_enabled"
                value="1" <?php echo e(($settings['preloader_enabled'] ?? 0) ? 'checked' : ''); ?>>
        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                <div class="upload-box" data-remove-input="#remove_preloader_image"
                    data-existing-url="<?php echo e($getUrl('preloader_image')); ?>">
                    ...
                    <div class="upload-preview mb-2">
                        <?php if($url = $getUrl('preloader_image')): ?>
                            <img src="<?php echo e($url); ?>" class="img-fluid" style="max-height: 64px;">
                        <?php else: ?>
                    ...
                    <button type="button"
                        class="btn btn-sm btn-outline-danger upload-remove <?php echo e($getUrl('preloader_image') ? '' : 'd-none'); ?>"><i
...
<?php /**PATH G:\Tudo\MEU-SISTEMA\SOMOS_UNN\resources\views\admin\settings\partials\appearance.blade.php ENDPATH**/ ?>
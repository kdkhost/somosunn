...
<div class="min-h-screen bg-slate-50 pt-28 pb-20 px-4">
    <div class="max-w-4xl mx-auto">
        <a href="<?php echo e(route('courses.show', $course->slug ?: $course->id)); ?>" class="inline-flex items-center gap-2 text-gray-600 hover:text-blue-700 mb-6">
        ...
        <div class="grid md:grid-cols-3 gap-8">
            <div class="md:col-span-1">
                <div class="bg-white rounded-2xl shadow-lg p-6 sticky top-28">
                    ...
                    <p class="font-bold text-gray-900"><?php echo e($course->title); ?></p>
                    <p class="text-sm text-gray-500 mt-1">
                        <i class="fas fa-user-circle mr-1"></i>
                        <?php echo e($course->author_name ?? optional($course->creator)->name ?? 'Instrutor'); ?>
            ...
            <div class="md:col-span-2">
                <div class="bg-white rounded-2xl shadow-lg p-6 md:p-8">
                    ...
                    <form action="<?php echo e(route('checkout.process', $course)); ?>" method="POST" class="space-y-6">
                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\Tudo\MEU-SISTEMA\SOMOS_UNN\resources\views\checkout\index.blade.php ENDPATH**/ ?>
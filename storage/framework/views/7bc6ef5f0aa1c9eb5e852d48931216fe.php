<?php $__env->startSection('title', 'Pagamento Pendente - ' . ($event?->title ?? 'Evento')); ?>
        ...
        <div class="bg-white rounded-2xl shadow-lg p-8">
            <div class="flex items-start gap-4">
                ...
                <div class="flex-1">
                    <h1 class="text-2xl font-black text-gray-900">
                        <?php echo e($isPaid ? 'Pagamento aprovado' : 'Pagamento pendente'); ?>
            ...
            <?php if(!$isPaid): ?>
                <div class="bg-yellow-50 border border-yellow-200 text-yellow-800 p-4 rounded-xl mt-6">
                    ...
                    Se você escolheu Pix ou boleto, finalize o pagamento no provedor. Esta página atualiza automaticamente.
                </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\Tudo\MEU-SISTEMA\SOMOS_UNN\resources\views\events\payment\pending.blade.php ENDPATH**/ ?>
<div class="bg-gradient-to-br from-slate-50 to-blue-50 min-h-screen">
    ...
    <section class="py-16 px-6 md:px-12 lg:px-24">
        <div class="max-w-7xl mx-auto">
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <?php $__currentLoopData = $fundadores; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $fundador): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="bg-white rounded-3xl shadow-lg overflow-hidden text-center">
                    ...
                    <div class="flex justify-center -mt-12">
                        <div class="w-24 h-24 rounded-full border-4 border-white shadow-lg btn-primary flex items-center justify-center text-white text-2xl font-bold">
                            <?php echo e($fundador['initials']); ?>

                        </div>
                    </div>
                    <div class="p-6">
                        <h3 class="text-xl font-bold text-gray-900 mb-1"><?php echo e($fundador['name']); ?></h3>
                        <p class="text-sm mb-3" style="color: var(--unn-azul-1)"><?php echo e($fundador['role']); ?></p>
                        <p class="text-gray-600 text-sm"><?php echo e($fundador['bio']); ?></p>
                    </div>
                </div>
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-6">
                ...
                <div class="text-center">
                    <div class="w-20 h-20 rounded-full btn-primary flex items-center justify-center text-white text-xl font-bold mx-auto mb-3">
                        <?php echo e($membro['initials']); ?>

                    </div>
                    <h4 class="font-bold text-gray-900 text-sm"><?php echo e($membro['name']); ?></h4>
                    <p class="text-xs text-gray-500"><?php echo e($membro['role']); ?></p>
                </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
        </div>
    ...
    <section class="py-16 px-6 md:px-12 lg:px-24" style="background: linear-gradient(135deg, var(--unn-azul-1), var(--unn-azul-3))">
        <div class="max-w-4xl mx-auto text-center text-white">
            ...
            <a href="<?php echo e(route('contato')); ?>" class="inline-flex items-center gap-2 bg-white px-8 py-4 rounded-full font-bold hover:bg-blue-50 transition" style="color: var(--unn-azul-1)">
...
<?php /**PATH G:\Tudo\MEU-SISTEMA\SOMOS_UNN\resources\views\site\institucional\_fallback\quem-somos.blade.php ENDPATH**/ ?>
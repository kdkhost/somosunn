<div class="bg-white rounded-3xl p-6 md:p-8 shadow-2xl">
    ...
    <form id="contact-form" action="<?php echo e(route('contato.send')); ?>" method="POST" class="space-y-6">
        <?php echo csrf_field(); ?>
        ...
        <div>
            ...
            <input type="text" name="name" required
                   ...
                   placeholder="Seu nome" value="<?php echo e(old('name')); ?>">
        </div>
        ...
        <div>
            ...
            <input type="email" name="email" required
                   class="w-full px-4 py-3 border border-gray-200 rounded-xl focus:ring-2 focus:border-transparent transition"
                   style="--tw-ring-color: var(--unn-azul-1)"
                   placeholder="seu@email.com" value="<?php echo e(old('email')); ?>">
        </div>
        ...
        <div>
            ...
            <select name="subject" required
                ...
                <option value="duvidas" <?php echo e(old('subject') === 'duvidas' ? 'selected' : ''); ?>>Dúvidas sobre a plataforma</option>
                <option value="parcerias" <?php echo e(old('subject') === 'parcerias' ? 'selected' : ''); ?>>Propostas de parceria</option>
                <option value="suporte" <?php echo e(old('subject') === 'suporte' ? 'selected' : ''); ?>>Suporte técnico</option>
                <option value="comercial" <?php echo e(old('subject') === 'comercial' ? 'selected' : ''); ?>>Departamento comercial</option>
                <option value="imprensa" <?php echo e(old('subject') === 'imprensa' ? 'selected' : ''); ?>>Assessoria de imprensa</option>
        ...
        <div>
            ...
            <textarea name="message" id="contact-message" rows="5" required minlength="10" maxlength="4000"
                      ...
                      style="--tw-ring-color: var(--unn-azul-1)"
                      placeholder="Como podemos ajudar? (mínimo 10 caracteres)"><?php echo e(old('message')); ?></textarea>
...
<?php /**PATH G:\Tudo\MEU-SISTEMA\SOMOS_UNN\resources\views\site\institucional\partials\contact-form.blade.php ENDPATH**/ ?>
<div class="card-body">
    ...
    <div class="form-group">
        ...
        <textarea name="site_description" class="form-control" rows="3"
            placeholder="Breve descrição do seu negócio para aparecer nos resultados de busca..."><?php echo e($settings['site_description'] ?? ''); ?></textarea>
        <small class="form-text text-muted">Recomendado: entre 150 e 160 caracteres.</small>
    </div>

    <div class="form-group">
        <label>Palavras-Chave (Meta Keywords)</label>
        <input type="text" name="site_keywords" class="form-control" value="<?php echo e($settings['site_keywords'] ?? ''); ?>"
    ...
    <div class="row">
        <div class="col-md-6 form-group">
            ...
            <div class="upload-box" data-remove-input="#remove_seo_og_image"
                data-existing-url="<?php echo e($getUrl('seo_og_image')); ?>">
                ...
                <div class="upload-preview mb-2 text-center">
                    <?php if($url = $getUrl('seo_og_image')): ?>
                ...
                <div class="text-center">
                    ...
                    <button type="button"
                        class="btn btn-sm btn-outline-danger upload-remove <?php echo e($getUrl('seo_og_image') ? '' : 'd-none'); ?>"><i
        ...
        <div class="col-md-6 form-group">
            ...
            <div class="upload-box" data-remove-input="#remove_seo_twitter_image"
                data-existing-url="<?php echo e($getUrl('seo_twitter_image')); ?>">
                ...
                <div class="upload-preview mb-2 text-center">
                    <?php if($url = $getUrl('seo_twitter_image')): ?>
                        <img src="<?php echo e($url); ?>" class="img-fluid rounded border"
                            style="max-height: 200px; width: 100%; object-fit: cover;">
                    <?php else: ?>
                        <div class="text-muted p-5 border rounded bg-light">
                ...
                <div class="text-center">
                    <button type="button" class="btn btn-sm btn-outline-primary upload-btn"><i
                            class="fas fa-upload"></i> Selecionar Imagem</button>
                    <button type="button"
                        class="btn btn-sm btn-outline-danger upload-remove <?php echo e($getUrl('seo_twitter_image') ? '' : 'd-none'); ?>"><i
                            class="fas fa-trash"></i></button>
                </div>
            </div>
        </div>
    ...
    <div class="row">
        <div class="col-md-6 form-group">
            ...
            <textarea name="tracking_head" class="form-control code-editor" rows="6"
                placeholder="<!-- Google Tag Manager / Analytics / Facebook Pixel -->"><?php echo e($settings['tracking_head'] ?? ''); ?></textarea>
        ...
        <div class="col-md-6 form-group">
            ...
            <textarea name="tracking_body" class="form-control code-editor" rows="6"
                placeholder="<!-- Chat Scripts / NoScript Tags -->"><?php echo e($settings['tracking_body'] ?? ''); ?></textarea>
            <small class="form-text text-muted">Insira scripts que podem ser carregados no final da página.</small>
        </div>
    </div>
</div><?php /**PATH G:\Tudo\MEU-SISTEMA\SOMOS_UNN\resources\views\admin\settings\partials\seo.blade.php ENDPATH**/ ?>
...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', \App\Models\Setting::get('seo_meta_title') ?: config('app.name', 'UNN')); ?></title>
    <?php
    ...
    <?php endif; ?>
    <meta name="robots" content="<?php echo e(trim($__env->yieldContent('meta_robots')) ?: $seoRobots); ?>">
    ...
    <?php endif; ?>
    <meta property="og:type" content="<?php echo e(trim($__env->yieldContent('og_type')) ?: 'website'); ?>">
    <meta property="og:url" content="<?php echo e($canonical); ?>">
    <meta property="og:site_name" content="<?php echo e(\App\Models\Setting::get('app_name') ?: config('app.name', 'UNN')); ?>">
    <?php if($metaImage !== ''): ?>
        <meta property="og:image" content="<?php echo e($metaImage); ?>">
    <?php endif; ?>

    
    <meta name="twitter:card" content="<?php echo e(trim($__env->yieldContent('twitter_card')) ?: 'summary_large_image'); ?>">
    <?php if($seoTwitterSite !== ''): ?>
        <meta name="twitter:site" content="<?php echo e($seoTwitterSite); ?>">
    <?php endif; ?>
    <meta name="twitter:title" content="<?php echo e($metaTitle); ?>">
    <?php if($metaDescription !== ''): ?>
        <meta name="twitter:description" content="<?php echo e($metaDescription); ?>">
    <?php endif; ?>
    <?php if($seoTwitterImage !== ''): ?>
        <meta name="twitter:image" content="<?php echo e(trim($__env->yieldContent('twitter_image')) ?: $seoTwitterImage); ?>">
    <?php endif; ?>

    <?php if($seoGoogleVerification !== ''): ?>
        <meta name="google-site-verification" content="<?php echo e($seoGoogleVerification); ?>">
    <?php endif; ?>
    ...
    <?php if($adsEnabled && $adsensePublisherId !== ''): ?>
        <script async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=<?php echo e($adsensePublisherId); ?>"
    ...
    <?php endif; ?>
    <meta name="theme-color" content="<?php echo e($pwaTheme); ?>">
    ...
    <?php if($videoPlayerEnabled): ?>
        <link rel="stylesheet" href="<?php echo e(asset('vendor/plyr/plyr.css')); ?>">
    <?php endif; ?>
    ...
    <style>
        * {
        ...
        :root {
            ...
            --unn-text: #0f172a;
            <?php if($videoPlayerEnabled): ?>
                --plyr-color-main: <?php echo e($videoPlyrColor); ?>;
                --plyr-range-fill-background: <?php echo e($videoPlyrColor); ?>;
                --plyr-video-control-background-hover: <?php echo e($videoPlyrColor); ?>;
                --plyr-audio-control-background-hover: <?php echo e($videoPlyrColor); ?>;
                --plyr-control-toggle-checked-background: <?php echo e($videoPlyrColor); ?>;
                --plyr-focus-visible-color: <?php echo e($videoPlyrColor); ?>;
                --plyr-font-family: 'Inter', sans-serif;
                --plyr-menu-background: rgba(15, 23, 42, 0.92);
                --plyr-menu-color: #ffffff;
                --plyr-tooltip-background: <?php echo e($videoPlyrColor); ?>;
        ...
        body {
            ...
            <?php if($bgImage): ?>
                background: linear-gradient(<?php echo e($rgbaColor); ?>, <?php echo e($rgbaColor); ?>), url('<?php echo e(asset($bgImage)); ?>');
        ...
        <?php if($videoPlayerEnabled): ?>
            ...
            .plyr--full-ui input[type=range] {
                color: var(--plyr-color-main, <?php echo e($videoPlyrColor); ?>);
            }

            .plyr__control--overlaid {
                background: var(--plyr-color-main, <?php echo e($videoPlyrColor); ?>);
            }
...
<body class="bg-slate-50 min-h-screen">
    ...
    <?php if(session()->has('impersonator_id')): ?>
        <div id="impersonation-badge"
            ...
            <a href="<?php echo e(route('admin.impersonate.stop')); ?>"
    ...
    <?php $showNavigation = $showNavigation ?? true; ?>
    <?php if($showNavigation): ?>
        <?php echo $__env->make('partials.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <?php endif; ?>

    <main class="<?php echo e($showNavigation ? 'pt-20 lg:pt-24' : 'pt-0'); ?> min-h-[calc(100vh-80px)]">
        <?php echo $__env->yieldContent('content'); ?>
    </main>

    <?php echo $__env->renderWhen(true, 'partials.footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path'])); ?>
    ...
    <script>
        ...
        <?php if(auth()->guard()->check()): ?>
            window.refreshNotifications = function() {
                fetch('<?php echo e(route("connection.notifications")); ?>')
                    .then(r => r.json())
                    .then(data => {
    ...
    <?php if($videoPlayerEnabled): ?>
        <script>
            ...
            window.UNN.videoPlayer = <?php echo $videoPlayerConfigJson; ?>;
        </script>
        <script src="<?php echo e(asset('vendor/plyr/plyr.polyfilled.js')); ?>"></script>
        <script>
            (function () {
    ...
    <?php echo $__env->make('partials.floating-chat', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                ...
                modal.innerHTML = `
                                <div class="bg-white rounded-2xl shadow-2xl max-w-sm w-full p-8 text-center relative transform transition-all scale-100">
                                    <div class="flex justify-center mb-6">
                                        <img src="<?php echo e($logo); ?>" alt="Logo" class="h-16 object-contain">
                                    </div>
...
<?php /**PATH G:\Tudo\MEU-SISTEMA\SOMOS_UNN\resources\views\layouts\app.blade.php ENDPATH**/ ?>
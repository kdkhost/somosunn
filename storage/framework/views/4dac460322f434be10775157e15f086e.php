<?php $__env->startSection('title', 'Planos Premium - UNN'); ?>
...
<?php $__env->startPush('styles'); ?>
    <?php if($testimonialsCarouselEnabled): ?>
    ...
    <div class="bg-gradient-to-br from-slate-50 to-blue-50 min-h-screen">
        ...
        <section class="py-16 px-6 md:px-12 lg:px-24" id="planos">
            <div class="max-w-7xl mx-auto">
                ...
                <div class="grid md:grid-cols-<?php echo e(min(3, $plans->count() ?: 1)); ?> gap-8">
                    <?php $__empty_1 = true; $__currentLoopData = $plans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $plan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <div class="bg-white rounded-3xl p-6 md:p-8 shadow-lg <?php echo e($plan->highlight ? 'shadow-2xl ring-2 relative' : ''); ?>"
                            style="<?php echo e($plan->highlight ? '--tw-ring-color: var(--unn-azul-1)' : ''); ?>">
                            ...
                            <div class="mb-2">
                                <?php if($plan->price > 0): ?>
                                    <span class="text-5xl font-black" style="color: var(--unn-azul-1)">R$
                                        <?php echo e(number_format($plan->price, 0, ',', '.')); ?></span>
                                    <span class="text-gray-500">/<?php echo e($plan->period); ?></span>
                                <?php else: ?>
                            ...
                            <?php if($plan->description): ?>
                                <p class="text-gray-500 mb-8"><?php echo e($plan->description); ?></p>
                            <?php else: ?>
                                <p class="text-gray-500 mb-8">&nbsp;</p>
                            <?php endif; ?>

                            <ul class="space-y-4 mb-8">
                                <?php $benefits = is_array($plan->benefits) ? $plan->benefits : json_decode($plan->benefits ?? '[]', true); ?>
                            ...
                            <a href="<?php echo e($plan->price > 0 ? route('subscription.checkout', ['plan' => $plan->id]) : route('register')); ?>"
                                class="block w-full text-center py-4 rounded-xl font-bold transition <?php echo e($plan->highlight ? 'btn-primary text-white shadow-lg hover:shadow-xl' : 'border-2 hover:bg-slate-50'); ?>"
                                style="<?php echo e(!$plan->highlight ? 'border-color: var(--unn-azul-1); color: var(--unn-azul-1)' : ''); ?>">
                                <?php echo e($plan->price > 0 ? 'Assinar ' . ($plan->name) : 'Começar grátis'); ?>
                    ...
                    <?php $__currentLoopData = $benefits; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $benefit): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="flex items-start gap-4">
                            <div class="w-12 h-12 btn-primary rounded-xl flex items-center justify-center shrink-0">
                                <i class="fas fa-<?php echo e($benefit['icon']); ?> text-white"></i>
                            </div>
                            <div>
                                <h3 class="font-bold text-gray-900 mb-1"><?php echo e($benefit['title']); ?></h3>
                                <p class="text-sm text-gray-600"><?php echo e($benefit['desc']); ?></p>
                            </div>
                        </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
                        ...
                        <table class="w-full min-w-[760px]">
                            <thead>
                                <tr class="border-b border-gray-100">
                                    ...
                                    <?php $__currentLoopData = $comparePlans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $plan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <th class="text-center p-6 <?php echo e($plan->highlight ? 'font-black' : 'text-gray-500 font-bold'); ?>"
                                            style="<?php echo e($plan->highlight ? 'background: var(--unn-azul-1); color: white' : ''); ?>">
                            ...
                            <tbody class="text-sm">
                                <?php $__currentLoopData = $comparisonRows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr class="border-b border-gray-50">
                                        <td class="p-4 text-gray-700"><?php echo e($row['label']); ?></td>
                                        <?php $__currentLoopData = $comparePlans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $plan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <?php
                                                $isHighlighted = (bool) ($plan->highlight ?? false);
                                                $cellStyle = $isHighlighted ? 'background: var(--unn-azul-1)10' : '';
                                            ?>
                                            <td class="text-center p-4" style="<?php echo e($cellStyle); ?>">
                                                <?php if($row['type'] === 'permission'): ?>
                                                    <?php
                                                ...
                                                <?php elseif($row['type'] === 'boolean'): ?>
                                                    ...
                                                    <?php else: ?>
                                                        <i class="fas fa-times text-gray-300"></i>
                                                    <?php endif; ?>
                                                <?php elseif($row['type'] === 'mentorship_group'): ?>
                                                    <?php
                                                    ...
                                                    ?>
                                                    <?php if($val !== ''): ?>
                                                        <span class="<?php echo e($isHighlighted ? 'font-bold text-slate-900' : 'text-gray-700'); ?>"><?php echo e($val); ?></span>
                                                    <?php else: ?>
                                                        <i class="fas fa-times text-gray-300"></i>
                                                    <?php endif; ?>
                                                <?php else: ?>
        ...
        <section class="py-16 px-6 md:px-12 lg:px-24 bg-white">
            <div class="max-w-7xl mx-auto">
                ...
                <?php if($carouselEnabled): ?>
                    <div class="unn-testimonials-swiper swiper" data-unn-testimonials-carousel='<?php echo json_encode($carouselConfig, 15, 512) ?>'>
                        <div class="swiper-wrapper">
                            <?php $__currentLoopData = $displayTestimonials; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $testimonial): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php
                                ...
                                <div class="swiper-slide">
                                    <div class="bg-slate-50 rounded-3xl p-8 relative h-full flex flex-col">
                                        ...
                                        <div class="flex gap-1 mb-4">
                                            <?php for($i = 1; $i <= 5; $i++): ?>
                                                <i class="fas fa-star <?php echo e(($rating !== null && $i <= $rating) ? 'text-yellow-500' : 'text-slate-300'); ?>"></i>
                                            <?php endfor; ?>
                                        </div>
                                        <p class="text-gray-600 mb-6 italic">"<?php echo e($text); ?>"</p>
                                        <div class="flex items-center gap-4 mt-auto">
                                            ...
                                            <div>
                                                <p class="font-bold text-gray-900"><?php echo e($name); ?></p>
                                                <?php if($role): ?>
                                                    <p class="text-sm text-gray-500"><?php echo e($role); ?></p>
                                                <?php endif; ?>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <?php if($carouselShowDots): ?>
                            <div class="swiper-pagination"></div>
                        <?php endif; ?>
                        <?php if($carouselShowArrows): ?>
                ...
                <div class="max-w-3xl mx-auto mt-10 bg-white rounded-3xl shadow-lg p-8 border border-slate-100">
                    ...
                    <?php if(auth()->guard()->check()): ?>
                        <form action="<?php echo e(route('testimonials.store')); ?>" method="POST" class="mt-6 space-y-4">
                            <?php echo csrf_field(); ?>
                            <div>
                                ...
                                <div class="flex items-center gap-4 flex-wrap">
                                    ...
                                    <div class="unn-star-rating" role="radiogroup" aria-label="Avaliação por estrelas">
                                        <?php for($i = 5; $i >= 1; $i--): ?>
                                            <input type="radio" id="testimonial-rating-<?php echo e($i); ?>" name="rating"
                                                value="<?php echo e($i); ?>" <?php echo e((string) $oldRating === (string) $i ? 'checked' : ''); ?>>
                                            <label for="testimonial-rating-<?php echo e($i); ?>" title="<?php echo e($i); ?>/5">
                                    ...
                                    <div class="text-sm text-gray-500">
                                        <input type="radio" id="testimonial-rating-none" name="rating" value=""
                                            <?php echo e($oldRating === null ? 'checked' : ''); ?> class="sr-only">
                    ...
                    <?php else: ?>
                        <div class="mt-6 flex flex-col sm:flex-row gap-3">
                            <a href="<?php echo e(route('login')); ?>" class="btn-primary text-white px-6 py-3 rounded-xl font-bold inline-flex items-center justify-center gap-2">
                                <i class="fas fa-right-to-bracket"></i>
                                Entrar para enviar
                            </a>
                            <a href="<?php echo e(route('register')); ?>" class="px-6 py-3 rounded-xl font-bold border-2 inline-flex items-center justify-center gap-2"
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.faq-section','data' => ['context' => 'premium']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['context' => 'premium']); ?>
            ...
            <div class="max-w-4xl mx-auto text-center text-white">
                ...
                <div class="flex flex-col sm:flex-row gap-4 justify-center">
                    <a href="<?php echo e($ctaHref); ?>"
                        ...
                        <?php if($ctaPlan): ?>
                            <?php if((float) $ctaPlan->price > 0): ?>
                                Assinar <?php echo e($ctaPlan->name); ?> - R$ <?php echo e(number_format($ctaPlan->price, 0, ',', '.')); ?>/<?php echo e($ctaPlan->period); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\Tudo\MEU-SISTEMA\SOMOS_UNN\resources\views\site\premium.blade.php ENDPATH**/ ?>
<?php $__env->startSection('title', 'Marketplace - UNN'); ?>
    ...
    <div class="max-w-7xl mx-auto">
        <div class="bg-white rounded-3xl border border-slate-100 shadow-sm p-5 md:p-6">
            <div class="flex flex-col lg:flex-row gap-4 lg:items-center lg:justify-between">
                ...
                <form method="GET" action="<?php echo e(route('marketplace.index')); ?>" class="flex-1 max-w-3xl">
                    <div class="relative">
                        <i class="fas fa-search absolute left-4 top-1/2 -translate-y-1/2 text-slate-400"></i>
                        <input type="text" name="q" value="<?php echo e($q); ?>" placeholder="Buscar cursos, mentorias e eventos..."
                    ...
                    <?php if($q !== ''): ?>
                        <div class="mt-2 flex items-center justify-between gap-3 text-xs text-slate-500">
                            <span><?php echo e($totalResults); ?> resultado(s) para "<?php echo e($q); ?>"</span>
                            <a href="<?php echo e(route('marketplace.index')); ?>" class="font-bold text-blue-700 hover:text-blue-800">Limpar busca</a>
                        </div>
                    <?php endif; ?>
                </form>
            ...
            <div class="mt-4 flex flex-wrap gap-2">
                <?php $__currentLoopData = $chips; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $chip): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <a href="<?php echo e($chip['href']); ?>"
                        ...
                        <i class="<?php echo e($chip['icon']); ?> text-slate-400"></i> <?php echo e($chip['label']); ?>

                    </a>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>

                <a href="<?php echo e(route('courses.index')); ?>" class="inline-flex items-center gap-2 rounded-full px-4 py-2 text-sm font-bold text-white btn-primary">
        ...
        <div class="mt-6">
            <div class="bg-white rounded-3xl border border-slate-100 shadow-sm overflow-hidden">
                    <?php if($marketplaceHeroEnabled): ?>
                        <div class="relative" data-marketplace-hero data-animation="<?php echo e($marketplaceHeroAnimation); ?>"
                            data-autoplay="<?php echo e($marketplaceHeroAutoplay ? 1 : 0); ?>" data-interval="<?php echo e($marketplaceHeroIntervalMs); ?>">
                            <?php if($marketplaceHeroAnimation === 'fade'): ?>
                                <div class="relative min-h-[280px] md:min-h-[340px]">
                                    <?php $__currentLoopData = $marketplaceHeroSlides; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $idx => $slide): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="mp-hero-slide absolute inset-0 transition-opacity duration-700 ease-out <?php echo e($idx === 0 ? 'opacity-100' : 'opacity-0 pointer-events-none'); ?>"
                                            aria-hidden="<?php echo e($idx === 0 ? 'false' : 'true'); ?>">
                                            <div class="relative min-h-[280px] md:min-h-[340px]">
                                                <?php if(($slide['image'] ?? '') !== ''): ?>
                                                    <img src="<?php echo e($slide['image']); ?>" alt=""
                                                    ...
                                                    <?php if(($slide['button_text'] ?? '') !== '' && ($slide['button_url'] ?? '') !== ''): ?>
                                                        <div class="mt-6">
                                                            <a href="<?php echo e($slide['button_url']); ?>"
                                                                ...
                                                                <i class="fas fa-shopping-bag"></i> <?php echo e($slide['button_text']); ?>
                            ...
                            <?php else: ?>
                                <div class="overflow-hidden">
                                    <div class="mp-hero-track flex transition-transform duration-700 ease-out will-change-transform">
                                        <?php $__currentLoopData = $marketplaceHeroSlides; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $idx => $slide): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="mp-hero-slide w-full shrink-0" aria-hidden="<?php echo e($idx === 0 ? 'false' : 'true'); ?>">
                                                <div class="relative min-h-[280px] md:min-h-[340px]">
                                                    <?php if(($slide['image'] ?? '') !== ''): ?>
                                                        <img src="<?php echo e($slide['image']); ?>" alt=""
                                                            class="absolute inset-0 w-full h-full object-cover">
                            ...
                            <?php if(count($marketplaceHeroSlides) > 1): ?>
                                ...
                                <div class="absolute bottom-4 left-1/2 -translate-x-1/2 flex items-center gap-2 rounded-full bg-black/30 px-3 py-2 backdrop-blur">
                                    <?php $__currentLoopData = $marketplaceHeroSlides; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $idx => $slide): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <button type="button" data-hero-dot="<?php echo e($idx); ?>"
                                            class="w-2.5 h-2.5 rounded-full <?php echo e($idx === 0 ? 'bg-white' : 'bg-white/40'); ?>"
                                            aria-label="Ir para o slide <?php echo e($idx + 1); ?>"></button>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </div>
                            <?php endif; ?>
                        </div>
                    ...
                    <div class="lg:col-span-9">
                        <div class="relative" data-hscroll data-scroll-amount="420">
                            ...
                            <div class="mp-hscroll flex gap-4 overflow-x-auto scroll-smooth snap-x snap-mandatory pb-2 px-1" data-hscroll-container>
                                <?php $__currentLoopData = $storeCategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <a href="<?php echo e($cat['href']); ?>"
                                        ...
                                        <div class="w-12 h-12 rounded-2xl bg-white border border-slate-200 text-blue-700 flex items-center justify-center">
                                            <i class="<?php echo e($cat['icon']); ?> text-lg"></i>
                                        </div>
                                        <div class="min-w-0">
                                            <div class="font-black text-slate-900 leading-tight truncate"><?php echo e($cat['label']); ?></div>
                                            <div class="text-sm text-slate-500"><?php echo e($cat['count']); ?> item(ns)</div>
                                        </div>
        ...
        <?php if($flashDeals->count() > 0): ?>
            <section id="marketplace-flash-deals" class="mt-10">
                ...
                <div class="relative" data-hscroll data-scroll-amount="420">
                    ...
                    <div class="mp-hscroll flex gap-4 overflow-x-auto scroll-smooth snap-x snap-mandatory pb-2 px-1" data-hscroll-container>
                        <?php $__currentLoopData = $flashDeals->take(8); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $deal): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <a href="<?php echo e($deal['url']); ?>" class="block">
                                <div class="aspect-[16/9] bg-slate-100 relative">
                                    <?php if(($deal['image_url'] ?? '') !== ''): ?>
                                        <img src="<?php echo e($deal['image_url']); ?>" alt="<?php echo e($deal['title']); ?>" class="w-full h-full object-cover">
                                    <?php else: ?>
                            ...
                            <div class="p-4">
                                ...
                                <div class="mt-2 flex items-center justify-between gap-2">
                                    <div class="text-lg font-black text-slate-900" data-price-current>
                                        <?php echo e($deal['sale'] > 0 ? 'R$ ' . number_format($deal['sale'], 2, ',', '.') : 'Gratuito'); ?>

                                    </div>
                                    <?php if(($deal['original'] ?? 0) > ($deal['sale'] ?? 0)): ?>
                                        <div class="text-sm font-bold text-slate-400 line-through" data-price-original>
                                            R$ <?php echo e(number_format((float) $deal['original'], 2, ',', '.')); ?>
                                ...
                                <div class="mt-3 inline-flex items-center gap-2 rounded-full bg-slate-900 text-white px-3 py-1 text-xs font-black"
                                    data-flash-sale data-ends-at-ms="<?php echo e((int) ($deal['ends_at_ms'] ?? 0)); ?>"
                                    data-original="<?php echo e((float) ($deal['original'] ?? 0)); ?>"
                                    data-sale="<?php echo e((float) ($deal['sale'] ?? 0)); ?>">
                                    <i class="<?php echo e($deal['icon']); ?>"></i>
        ...
        <section id="marketplace-courses" class="mt-10">
            <div class="flex items-end justify-between gap-4 mb-4">
                ...
                <a href="<?php echo e(route('courses.index')); ?>" class="text-sm font-black text-blue-700 hover:text-blue-800">Ver todos</a>
            </div>
            ...
            <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
                <?php $__empty_1 = true; $__currentLoopData = $courses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $course): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    ...
                    <div class="group bg-white rounded-3xl border border-slate-100 shadow-sm hover:shadow-md transition overflow-hidden" data-product-card>
                        <a href="<?php echo e(route('courses.show', $showParam)); ?>" class="block">
                            <div class="aspect-[16/9] bg-slate-100 relative">
                                <?php if($thumbUrl !== ''): ?>
                                ...
                                <?php if($shareUrl !== ''): ?>
                                    <button type="button"
                                        ...
                                        onclick="event.preventDefault(); event.stopPropagation(); navigator.clipboard.writeText(<?php echo json_encode($shareUrl, 15, 512) ?>); toastr.success('Link copiado!');">
                            ...
                            <div class="p-4">
                                ...
                                <div class="text-xs text-slate-500 truncate mt-1">
                                    Produzido e comercializado por: <?php echo e($sellerName); ?>

                                </div>

                                <?php if(!empty($course->short_description)): ?>
                                    <div class="text-sm text-slate-600 mt-2">
                                        <?php echo e(\Illuminate\Support\Str::limit(strip_tags((string) $course->short_description), 90)); ?>
                                ...
                                <div class="mt-3 flex items-end justify-between gap-3">
                                    <div>
                                        ...
                                        <div class="flex items-end gap-2">
                                            ...
                                            <?php if($flashActive && $regularPrice > 0): ?>
                                        ...
                                        <?php if($flashActive && $flashEndsAtMs > 0): ?>
                                            <div class="mt-2 inline-flex items-center gap-2 rounded-full border border-rose-200 bg-rose-50 px-3 py-1 text-xs font-black text-rose-800"
                                                data-flash-sale
                                                data-ends-at-ms="<?php echo e($flashEndsAtMs); ?>"
                                                data-original="<?php echo e(number_format($regularPrice, 2, '.', '')); ?>"
                                                data-sale="<?php echo e(number_format($price, 2, '.', '')); ?>">
                                                <i class="fas fa-bolt"></i>
                        ...
                        <div class="px-4 pb-4 flex gap-2">
                            <a href="<?php echo e(route('courses.show', $showParam)); ?>"
                            ...
                            <?php elseif($buyEnabled): ?>
                                <a href="<?php echo e(route('checkout.show', $course->id)); ?>"
                                    class="flex-1 inline-flex items-center justify-center rounded-2xl btn-primary px-4 py-2 text-sm font-black text-white shadow-md">
                                    Comprar
                                </a>
                            <?php else: ?>
        ...
        <section id="marketplace-mentorships" class="mt-12">
            <div class="flex items-end justify-between gap-4 mb-4">
                ...
                <a href="<?php echo e(route('mentorships.index')); ?>" class="text-sm font-black text-blue-700 hover:text-blue-800">Ver todos</a>
            </div>

            <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
                <?php $__empty_1 = true; $__currentLoopData = $mentorships; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mentorship): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <?php
                    ...
                    <div class="group bg-white rounded-3xl border border-slate-100 shadow-sm hover:shadow-md transition overflow-hidden" data-product-card>
                        <a href="<?php echo e(route('mentorships.show', $mentorship)); ?>" class="block">
                            <div class="aspect-[16/9] bg-slate-100 relative">
                                <?php if($imageUrl !== ''): ?>
                                    <img src="<?php echo e($imageUrl); ?>" alt="<?php echo e($mentorship->title); ?>" class="w-full h-full object-cover">
                                <?php else: ?>
                            ...
                            <div class="p-4">
                                ...
                                <div class="text-xs text-slate-500 truncate mt-1">
                                    Produzido e comercializado por: <?php echo e($mentorName); ?>
                        ...
                        <div class="px-4 pb-4 flex gap-2">
                            <a href="<?php echo e(route('mentorships.show', $mentorship)); ?>"
                                class="flex-1 inline-flex items-center justify-center rounded-2xl border border-slate-200 px-4 py-2 text-sm font-black text-slate-700 hover:bg-slate-50 transition">
                                Ver
                            </a>
        ...
        <section id="marketplace-events" class="mt-12">
            <div class="flex items-end justify-between gap-4 mb-4">
                ...
                <a href="<?php echo e(route('events.index')); ?>" class="text-sm font-black text-blue-700 hover:text-blue-800">Ver todos</a>
            </div>
                ...
                <?php $__empty_1 = true; $__currentLoopData = $events; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $event): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    ...
                    <div class="group bg-white rounded-3xl border border-slate-100 shadow-sm hover:shadow-md transition overflow-hidden" data-product-card>
                        <a href="<?php echo e(route('events.show', $event)); ?>" class="block">
                            <div class="aspect-[16/9] bg-slate-100 relative">
                                <?php if($imageUrl !== ''): ?>
                                    <img src="<?php echo e($imageUrl); ?>" alt="<?php echo e($event->title); ?>" class="w-full h-full object-cover">
                                <?php else: ?>
                                    <div class="w-full h-full flex items-center justify-center text-slate-300">
                                        <i class="fas fa-image text-4xl"></i>
                                    </div>
                            ...
                            <div class="p-4">
                                ...
                                <div class="text-xs text-slate-500 truncate mt-1">
                                    <?php echo e($dateLabel ? ('Data: ' . $dateLabel) : ($event->location ?? 'Evento')); ?>
                        ...
                        <div class="px-4 pb-4 flex gap-2">
                            ...
                            <?php if($buyEnabled): ?>
                                <a href="<?php echo e(route('events.checkout', $event)); ?>"
                                    class="flex-1 inline-flex items-center justify-center rounded-2xl btn-primary px-4 py-2 text-sm font-black text-white shadow-md">
                                    <?php echo e($price > 0 ? 'Comprar' : 'Reservar'); ?>
        ...
        <?php if($testimonials->count() > 0): ?>
            <section id="marketplace-testimonials" class="mt-12">
                ...
                <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
                    <?php $__currentLoopData = $testimonials->take(6); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $t): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php
                            ...
                            <div class="flex items-start justify-between gap-3">
                                <div class="min-w-0">
                                    <div class="font-black text-slate-900 truncate">
                                        <?php echo e($t->author_name ?: 'Cliente'); ?>

                                    </div>
                                    <?php if(!empty($t->author_title)): ?>
                                        <div class="text-sm text-slate-500 truncate"><?php echo e($t->author_title); ?></div>
                                    <?php endif; ?>
                                </div>

                                <div class="shrink-0 flex items-center gap-1 text-amber-400" aria-label="Avaliação">
                                    <?php for($i = 1; $i <= 5; $i++): ?>
                                        <i class="<?php echo e($i <= $rating ? 'fas' : 'far'); ?> fa-star text-sm"></i>
                                    <?php endfor; ?>
                                </div>
                            </div>
            ...
            <div class="grid md:grid-cols-2">
                <div class="p-6 md:p-8">
                    ...
                    <div class="mt-2 text-2xl md:text-3xl font-black text-slate-900 leading-tight">
                        <?php echo e($marketplaceExitTitle); ?>

                    </div>
                    <div class="mt-3 text-slate-600">
                        <?php echo e($marketplaceExitText); ?>

                    </div>

                    <?php if($marketplaceExitCoupon !== ''): ?>
                        <div class="mt-5 rounded-2xl border border-emerald-200 bg-emerald-50 p-4">
                            ...
                            <div class="mt-2 flex items-center gap-2">
                                <div class="flex-1 font-black text-emerald-900 bg-white rounded-xl border border-emerald-200 px-4 py-2">
                                    <?php echo e($marketplaceExitCoupon); ?>

                                </div>
                                <button type="button" data-exit-copy data-code="<?php echo e($marketplaceExitCoupon); ?>"
                    ...
                    <div class="mt-6 flex flex-col sm:flex-row gap-2">
                        <?php if($marketplaceExitButtonUrl !== ''): ?>
                            <a href="<?php echo e($marketplaceExitButtonUrl); ?>"
                                ...
                                <i class="fas fa-tags"></i> <?php echo e($marketplaceExitButtonText !== '' ? $marketplaceExitButtonText : 'Ver ofertas'); ?>
                ...
                <div class="bg-slate-50 border-t md:border-t-0 md:border-l border-slate-100">
                    <?php if($marketplaceExitImage !== ''): ?>
                        <img src="<?php echo e($marketplaceExitImage); ?>" alt="Oferta" class="w-full h-full object-cover">
                    <?php else: ?>
...
<?php $__env->startPush('scripts'); ?>
    <script>
        (function () {
            const mpEventsPopupEnabled = <?php echo json_encode((bool) $marketplaceEventsPopupEnabled, 15, 512) ?>;
            const mpEventsPopupIntervalMs = <?php echo json_encode((int) $marketplaceEventsPopupIntervalMs, 15, 512) ?>;
            const mpEventsPopupMaxPerSession = <?php echo json_encode((int) $marketplaceEventsPopupMaxPerSession, 15, 512) ?>;
            const mpUpcomingEvents = <?php echo json_encode($eventsPopupItems, 15, 512) ?>;
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\Tudo\MEU-SISTEMA\SOMOS_UNN\resources\views\marketplace\index.blade.php ENDPATH**/ ?>
...
<?php $__env->startSection('title', 'Chat - UNN'); ?>

<?php if(($extends ?? 'layouts.app') === 'admin.layouts.app'): ?>
    <?php $__env->startSection('page_title', 'Chat'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <div class="<?php echo e($isAdminContext ? 'px-0 py-2' : 'max-w-6xl mx-auto px-0 sm:px-4 py-2 sm:py-6'); ?> h-[calc(100vh-120px)] sm:h-[calc(100vh-160px)] md:h-[calc(100vh-180px)] min-h-[400px]">
        <div class="bg-white rounded-none sm:rounded-lg shadow-xl overflow-hidden flex h-full border-0 sm:border border-gray-200">
            ...
            <div class="hidden md:flex w-1/3 border-r border-gray-200 flex-col bg-white">
                <div class="p-4 border-b border-gray-200 bg-gray-50 flex justify-between items-center">
                    ...
                    <a href="<?php echo e(route($routeNamePrefix . '.index')); ?>" class="text-xs text-blue-600">Voltar</a>
                </div>
                ...
                <div class="flex-1 overflow-y-auto" id="conversations-list">
                    <?php $__currentLoopData = $conversations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $conv): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        ?>
                        <a href="<?php echo e(route($routeNamePrefix . '.show', $conv->id)); ?>" data-conversation-id="<?php echo e($conv->id); ?>"
                            class="block p-3 hover:bg-blue-50 transition border-b border-gray-100 <?php echo e(isset($conversation) && $conversation->id == $conv->id ? 'bg-blue-50 border-blue-200' : ''); ?>">
                            <div class="flex items-center gap-2">
                                <img src="<?php echo e($otherUserPhoto); ?>" alt="<?php echo e($otherUserName); ?>"
                                    class="w-9 h-9 rounded-full object-cover flex-shrink-0"
                                    onerror="this.onerror=null;this.src='<?php echo e(asset('img/default-user.svg')); ?>'">
                                <div class="flex-1 min-w-0">
                                    <h4 class="text-sm font-semibold text-gray-900 truncate"><?php echo e($otherUserName); ?>
            ...
            <!-- Chat Area -->
                ...
                <div class="p-3 sm:p-4 border-b border-gray-200 bg-white flex items-center justify-between shadow-sm z-10 sticky top-0">
                    <div class="flex items-center gap-2 sm:gap-3">
                        <a href="<?php echo e(route($routeNamePrefix . '.index')); ?>" class="md:hidden text-gray-500 hover:text-gray-700 p-1">
                            <i class="fas fa-arrow-left text-lg"></i>
                        </a>
                        <img src="<?php echo e($chatOtherUserPhoto); ?>" alt="<?php echo e($chatOtherUserName); ?>"
                            class="w-9 h-9 sm:w-10 sm:h-10 rounded-full object-cover"
                            onerror="this.onerror=null;this.src='<?php echo e(asset('img/default-user.svg')); ?>'">
                        <div>
                            <h4 class="font-bold text-gray-900 text-sm sm:text-base"><?php echo e($chatOtherUserName); ?></h4>
                ...
                <div class="flex-1 overflow-y-auto p-4 space-y-4" id="messages-container">
                    <?php $__currentLoopData = $messages->reverse(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $msg): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="flex <?php echo e($msg->user_id == Auth::id() ? 'justify-end' : 'justify-start'); ?>">
                            <div
                                class="max-w-[75%] rounded-2xl px-4 py-2 shadow-sm text-sm <?php echo e($msg->user_id == Auth::id() ? 'bg-blue-600 text-white rounded-br-none' : 'bg-white text-gray-800 rounded-bl-none border border-gray-100'); ?>">
                                <p><?php echo e($msg->body); ?></p>
                                <div
                                    class="text-[10px] mt-1 opacity-70 <?php echo e($msg->user_id == Auth::id() ? 'text-blue-100' : 'text-gray-400'); ?> text-right">
                ...
                <div class="p-2 sm:p-4 bg-white border-t border-gray-200 sticky bottom-0">
                    <form id="chat-form" class="flex items-center gap-1 sm:gap-2">
                        ...
                        <div class="relative">
                            ...
                            <?php echo $__env->make('partials.emoji-picker', ['pickerId' => 'chat'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                        </div>
        ...
        <?php $__env->startPush('scripts'); ?>
            <script>
                document.getElementById('chat-form').addEventListener('submit', function (e) {
                    ...
                    // Ajax send
                    fetch('<?php echo e(route($routeNamePrefix . ".message.store", $conversation->id)); ?>', {
                        method: 'POST',
                        headers: {
                ...
                setInterval(() => {
                    ...
                    fetch('<?php echo e(route($routeNamePrefix . ".messages", $conversation->id)); ?>')
                    ...
                    fetch('<?php echo e(route($routeNamePrefix . ".list")); ?>')
                        .then(r => r.json())
                        .then(conversations => {
...
<?php echo $__env->make($extends ?? 'layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\Tudo\MEU-SISTEMA\SOMOS_UNN\resources\views\chat\show.blade.php ENDPATH**/ ?>
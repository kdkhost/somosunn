...
<?php
    ...
    $eventMaterials = $event->exists ? $event->materials()->latest('id')->get() : collect();
?>
            ...
            <div class="tab-content" id="event-tabs-content">
                ...
                <div class="tab-pane fade show active" id="general" role="tabpanel" aria-labelledby="general-tab">
                    <form method="POST" enctype="multipart/form-data"
                        action="<?php echo e($event->exists ? route('admin.events.update', $event) : route('admin.events.store')); ?>">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="form-group mb-2">
                            ...
                            <div class="upload-box" data-max-size="5242880"
                                data-existing-url="<?php echo e($event->image ? asset('storage/' . $event->image) : ''); ?>"
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group mb-2"><label>Local (Nome do Local)</label><input name="location"
                                        class="form-control" value="<?php echo e(old('location', $event->location)); ?>"></div>
                                <div class="form-group mb-2"><label>Endereço Completo</label>
                                    <div class="input-group"><input name="address" id="addressInput" class="form-control"
                                            value="<?php echo e(old('address', $event->address)); ?>">
                                ...
                                <div class="form-group mb-2"><label>Latitude</label><input name="latitude" id="latInput"
                                        class="form-control" value="<?php echo e(old('latitude', $event->latitude)); ?>" readonly></div>
                                <div class="form-group mb-2"><label>Longitude</label><input name="longitude" id="lngInput"
                                        class="form-control" value="<?php echo e(old('longitude', $event->longitude)); ?>" readonly>
                                </div>
                                <input type="hidden" name="published" value="0">
                                <div class="form-check mb-2">
                                    <input type="checkbox" name="published" value="1" class="form-check-input" <?php echo e(old('published', $event->published) ? 'checked' : ''); ?>>
                        ...
                        <div class="card border-0 shadow-sm mt-4">
                            <div class="card-header bg-white border-bottom-0">
                                <h6 class="mb-1 font-weight-bold">
                                    <i class="fas fa-folder-open text-primary mr-1"></i> Materiais da palestra/evento
                                </h6>
                            ...
                            <div class="card-body">
                                <form action="<?php echo e(route('admin.events.materials.upload', $event)); ?>" method="POST"
                                    class="dropzone" id="eventMaterialsDropzone">
                                    <?php echo csrf_field(); ?>
                                </form>
                                <ul class="attachment-list mt-3" id="eventMaterialsList">
                                    <?php $__empty_1 = true; $__currentLoopData = $eventMaterials; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $material): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <?php
                                        ...
                                        ?>
                                        <li class="attachment-item" id="event-material-<?php echo e($material->id); ?>" data-material-item="1">
                                            <div class="d-flex align-items-center">
                                                <i class="fas <?php echo e($materialIcon); ?> attachment-icon"></i>
                                                <div>
                                                    <div class="font-weight-bold"
                                                        id="event-material-name-<?php echo e($material->id); ?>"><?php echo e($material->file_name); ?></div>
                                                    <small class="text-muted"><?php echo e($materialSize); ?> &bull; <?php echo e($materialBadge); ?></small>
                                                </div>
                                            </div>
                                            <div class="btn-group btn-group-sm">
                                                <a href="<?php echo e(route('events.materials.download', [$event, $material])); ?>"
                                                    class="btn btn-outline-primary" target="_blank" rel="noopener"
                                                    title="Baixar">
                                                    <i class="fas fa-download"></i>
                                                </a>
                                                <button type="button" class="btn btn-outline-secondary js-rename-event-material"
                                                    data-id="<?php echo e($material->id); ?>"
                                                    data-name="<?php echo e($material->file_name); ?>"
                                                    title="Renomear">
                                                    <i class="fas fa-pen"></i>
                                                </button>
                                                <button type="button" class="btn btn-outline-danger js-delete-event-material"
                                                    data-id="<?php echo e($material->id); ?>"
                                                    title="Excluir">
                                    ...
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                        <li class="attachment-item text-muted justify-content-center" id="event-material-empty">
                    ...
                    <?php else: ?>
                        <div class="alert alert-info mt-4 mb-0">
                            Salve o evento para habilitar o envio de materiais com arrasta e solta.
                        </div>
                    <?php endif; ?>
                </div>
                ...
                <div class="tab-pane fade" id="certificate" role="tabpanel" aria-labelledby="cert-tab">
                    ...
                    <?php else: ?>
                        <form id="certForm" method="POST" action="<?php echo e(route('admin.events.update', $event)); ?>"
                                    ...
                                    <div class="card shadow-sm border-0">
                                        ...
                                        <div class="card-body bg-dark d-flex justify-content-center align-items-center p-4"
                                            ...
                                            <div id="cert-canvas"
                                                ...
                                                <?php if($event->certificate_bg): ?>
                                                    <img src="<?php echo e(asset($event->certificate_bg)); ?>" id="cert-bg-img"
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="form-group custom-control custom-switch mb-4">
                                                <input type="checkbox" class="custom-control-input" id="is_certificate_enabled"
                                                    name="is_certificate_enabled" value="1" <?php echo e($event->is_certificate_enabled ? 'checked' : ''); ?>>
                                            ...
                                            <div class="form-group mt-3">
                                                <label class="small text-muted text-uppercase font-weight-bold">Assinatura do
                                                    Organizador</label>
                                                <?php if($event->instructor_signature): ?>
                                                    <div class="mb-2 text-center border p-2 bg-light rounded">
                                                        <img src="<?php echo e(asset($event->instructor_signature)); ?>"
                                            ...
                                            <div class="mt-4">
                                                ...
                                                <div class="list-group list-group-flush border rounded overflow-hidden">
                                                    <?php $__currentLoopData = ['student_name' => 'Nome do Participante', 'course_name' => 'Nome do Evento', 'completion_date' => 'Data do Evento', 'certificate_code' => 'Cód. Validação', 'author_name' => 'Organizador', 'workload_hours' => 'Carga Horária', 'title' => 'Título do Certificado', 'presentation_text' => 'Texto de Apresentação', 'instructor_signature' => 'Assinatura do Organizador', 'platform_logo' => 'Logo UNN']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tag => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <div
...
<?php $__env->startPush('scripts'); ?>
    ...
    <script>
        $(document).ready(function () {
            // Map Logic
            var initialLat = <?php echo e($event->latitude ?? '-23.5505'); ?>;
            var initialLng = <?php echo e($event->longitude ?? '-46.6333'); ?>;
            var zoom = <?php echo e($event->latitude ? 15 : 10); ?>;
            var map = L.map('map').setView([initialLat, initialLng], zoom);
            L.tileLayer('https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png', { attribution: '&copy; OpenStreetMap contributors' }).addTo(map);
            var marker;
            if (<?php echo e($event->latitude ? 'true' : 'false'); ?>) marker = L.marker([initialLat, initialLng]).addTo(map);
            ...
            // Certificate Logic
            if ('<?php echo e($event->exists); ?>' == '') return;
            let rawCertSettings = <?php echo $event->certificate_settings ? json_encode($event->certificate_settings) : 'null'; ?>;
            ...
            const instructorSignatureUrl = "<?php echo e($event->instructor_signature ? asset($event->instructor_signature) : ''); ?>";
            ...
            const defaultTags = {
                ...
                'course_name': { x: 50, y: 55, text: '<?php echo e($event->title); ?>', fontSize: 24, color: '#333333', fontWeight: 'bold', fontFamily: 'Arial, sans-serif' },
                'completion_date': { x: 50, y: 65, text: 'Participou em: <?php echo e($event->start_at ? $event->start_at->format("d/m/Y") : "01/01/2026"); ?>', fontSize: 16, color: '#555555', fontWeight: 'normal', fontFamily: 'Arial, sans-serif' },
...
<?php if($event->exists): ?>
    <?php $__env->startPush('scripts'); ?>
        ...
        <script>
            (function () {
            const dropzoneElement = document.getElementById('eventMaterialsDropzone');
            const listElement = document.getElementById('eventMaterialsList');
            ...
            const uploadUrl = <?php echo json_encode(route('admin.events.materials.upload', $event), 512) ?>;
            const renameUrlTemplate = <?php echo json_encode(route('admin.events.materials.rename', [$event->id, '__MATERIAL_ID__'])) ?>;
            const deleteUrlTemplate = <?php echo json_encode(route('admin.events.materials.destroy', [$event->id, '__MATERIAL_ID__'])) ?>;
            const downloadUrlTemplate = <?php echo json_encode(route('events.materials.download', [$event->id, '__MATERIAL_ID__'])) ?>;
            ...
            function updateEmptyState() {
                const emptyItem = document.getElementById('event-material-empty');
                ...
                if (!emptyItem) {
                    ...
                    placeholder.id = 'event-material-empty';
            ...
            function buildMaterialItem(material, downloadUrl) {
                ...
                return `
                    <li class="attachment-item" id="event-material-${material.id}" data-material-item="1">
                        <div class="d-flex align-items-center">
                            <i class="fas ${icon} attachment-icon"></i>
                            <div>
                                <div class="font-weight-bold" id="event-material-name-${material.id}">${safeName}</div>
                        ...
                        <div class="btn-group btn-group-sm">
                            ...
                            <button type="button" class="btn btn-outline-secondary js-rename-event-material" data-id="${material.id}" data-name="${safeName}" title="Renomear">
                                <i class="fas fa-pen"></i>
                            </button>
                            <button type="button" class="btn btn-outline-danger js-delete-event-material" data-id="${material.id}" title="Excluir">
                                <i class="fas fa-trash"></i>
                            </button>
                        </div>
                    </li>
            ...
            listElement.addEventListener('click', function (event) {
                const renameButton = event.target.closest('.js-rename-event-material');
                if (renameButton) {
                    ...
                    Swal.fire({
                        ...
                        $.ajax({
                            ...
                            success: function () {
                                const title = document.getElementById('event-material-name-' + materialId);
                                if (title) {
                ...
                const deleteButton = event.target.closest('.js-delete-event-material');
                if (!deleteButton) {
                    return;
                }
                ...
                Swal.fire({
                    ...
                    $.ajax({
                        ...
                        success: function () {
                            const item = document.getElementById('event-material-' + materialId);
                            if (item) {
                                item.remove();
                            }
                            updateEmptyState();
            ...
            const dz = new Dropzone('#eventMaterialsDropzone', {
                url: uploadUrl,
                paramName: 'file',
                headers: {
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\Tudo\MEU-SISTEMA\SOMOS_UNN\resources\views\admin\events\form.blade.php ENDPATH**/ ?>
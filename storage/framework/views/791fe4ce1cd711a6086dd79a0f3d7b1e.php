        ...
        <div class="max-w-7xl mx-auto">
            ...
            <div class="grid md:grid-cols-3 gap-8">
                ...
                <div class="bg-slate-50 rounded-3xl p-6 md:p-8 text-center">
                    ...
                    <a href="<?php echo e(route('register')); ?>" class="block w-full py-3 border-2 rounded-xl font-semibold transition hover:bg-gray-100" style="border-color: var(--unn-azul-1); color: var(--unn-azul-1)">
                        Começar grátis
                    </a>
                </div>
                ...
                <div class="bg-white rounded-3xl p-6 md:p-8 text-center shadow-2xl ring-2 relative" style="--tw-ring-color: var(--unn-azul-1)">
                    ...
                    <a href="<?php echo e(route('premium')); ?>" class="block w-full py-3 btn-primary text-white rounded-xl font-semibold shadow-lg hover:shadow-xl transition">
                        Assinar Premium
                    </a>
                </div>
                ...
                <div class="bg-slate-50 rounded-3xl p-6 md:p-8 text-center">
                    ...
                    <a href="<?php echo e(route('contato')); ?>" class="block w-full py-3 border-2 rounded-xl font-semibold transition hover:bg-gray-100" style="border-color: var(--unn-azul-1); color: var(--unn-azul-1)">
                        Falar com vendas
                    </a>
                </div>
            </div>
...
<?php /**PATH G:\Tudo\MEU-SISTEMA\SOMOS_UNN\resources\views\site\institucional\_fallback\como-funciona.blade.php ENDPATH**/ ?>
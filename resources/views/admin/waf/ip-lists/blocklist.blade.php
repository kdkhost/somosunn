...
@section('title', 'WAF - IP Blocklist')
...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0"><i class="fas fa-ban text-danger"></i> WAF - IP Blocklist</h1>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="container-fluid">
        ...
        @if(!$hasTable)
            <div class="alert alert-warning">
                ...
                Tabela <code>waf_ip_blocklist</code> nao encontrada. Execute <code>php artisan migrate</code>.
            </div>
        @else
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="card card-outline card-danger">
                        ...
                        <div class="card-body">
                            <form method="POST" action="{{ route('admin.waf.blocklist.store') }}">
                                @csrf
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="reason" class="form-control form-control-sm"
                                           placeholder="Motivo do bloqueio" value="{{ old('reason') }}">
                                </div>
                                <div class="form-group">
                                    ...
                                    <small class="text-muted">Deixe vazio para bloqueio permanente.</small>
                                </div>
                ...
                <div class="col-md-8">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">IPs Bloqueados</h3>
                            <div class="card-tools">
                                <form method="GET" action="{{ route('admin.waf.blocklist.index') }}" class="input-group input-group-sm" style="width:250px;">
                                ...
                                <tbody>
                                    @forelse($entries as $entry)
                                        <tr>
                                            ...
                                            <td><span class="badge badge-{{ $entry->auto_generated ? 'info' : 'secondary' }}">{{ $entry->source ?? 'manual' }}</span></td>
                                    ...
                                    @empty
                                        <tr>
                                            <td colspan="7" class="text-center text-muted py-4">Nenhum IP bloqueado.</td>
                                        </tr>
                                    @endforelse
                                </tbody>
                            </table>

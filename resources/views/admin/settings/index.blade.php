                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane fade" id="tab-video" role="tabpanel">
                        ...
                        <div class="alert alert-info">
                            Configure o player de vídeo usado nas aulas/cursos. As opções avançadas aceitam o JSON de configuração do Plyr.
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="custom-control custom-switch custom-switch-off-danger custom-switch-on-success mt-2">
                                    ...
                                    <label class="custom-control-label" for="video_plyr_click_to_play">Clique p/ tocar</label>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="custom-control custom-switch custom-switch-off-danger custom-switch-on-success mt-2">
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col-md-3">
                                <div class="custom-control custom-switch custom-switch-off-danger custom-switch-on-success">
                                    ...
                                    <label class="custom-control-label" for="video_plyr_volume_enabled">Controle Volume</label>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="custom-control custom-switch custom-switch-off-danger custom-switch-on-success mb-2">
                                    ...
                                    <label class="custom-control-label" for="video_watermark_text_enabled">Texto dinâmico (Anti-pirataria)</label>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-md-6 form-group">
                                        ...
                                        <select name="adsense_format" class="form-control">
                                            ...
                                            <option value="auto" {{ $adsFormat === 'auto' ? 'selected' : '' }}>Automático</option>
                                            <option value="fluid" {{ $adsFormat === 'fluid' ? 'selected' : '' }}>In-feed (Fluido)</option>
                    ...
                    <h5 class="text-primary mb-3"><i class="fas fa-credit-card mr-2"></i>Gateways de Pagamento</h5>
                            ...
                            <div class="card card-outline card-success collapsed-card">
                                ...
                                <div class="card-body" style="display: none;">
                                    <div class="form-group">
                                        ...
                                        <select name="mercadopago_env" class="form-control">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 form-group">
                                            ...
                                            <input name="mercadopago_sandbox_public_key" class="form-control" value="{{ $settings['mercadopago_sandbox_public_key'] ?? '' }}">
                                        </div>
                                        <div class="col-md-6 form-group">
                                            <label>Access Token (Sandbox)</label>
                                            <input name="mercadopago_sandbox_access_token" class="form-control" value="{{ $settings['mercadopago_sandbox_access_token'] ?? '' }}">
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-6 form-group">
                                            <label>Public Key (Produção)</label>
                                            <input name="mercadopago_prod_public_key" class="form-control" value="{{ $settings['mercadopago_prod_public_key'] ?? '' }}">
                                        </div>
                                        <div class="col-md-6 form-group">
                                            <label>Access Token (Produção)</label>
                                            <input name="mercadopago_prod_access_token" class="form-control" value="{{ $settings['mercadopago_prod_access_token'] ?? '' }}">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <div class="input-group-append">
                                                <button class="btn btn-default" type="button" onclick="navigator.clipboard.writeText(this.parentElement.previousElementSibling.value); toastr.success('Copiado!')"><i class="fas fa-copy"></i></button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="card card-outline card-warning collapsed-card">
                                ...
                                <div class="card-body" style="display: none;">
                                    <div class="form-group">
                                        <label>Ambiente</label>
                                        <select name="pagseguro_env" class="form-control">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 form-group">
                                            ...
                                            <input name="pagseguro_sandbox_token" class="form-control" value="{{ $settings['pagseguro_sandbox_token'] ?? '' }}">
                                        </div>
                                        <div class="col-md-6 offset-md-6 form-group">
                                            <label>Token (Produção)</label>
                                            <input name="pagseguro_prod_token" class="form-control" value="{{ $settings['pagseguro_prod_token'] ?? '' }}">
                                        </div>
                                    </div>
                                    <div class="form-group">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="custom-control custom-switch custom-switch-off-danger custom-switch-on-success mb-3">
                                        ...
                                        <input type="checkbox" class="custom-control-input" id="gateway_transparent_checkout" name="gateway_transparent_checkout" value="1" {{ ($settings['gateway_transparent_checkout'] ?? 0) ? 'checked' : '' }}>
                                        <label class="custom-control-label" for="gateway_transparent_checkout">Checkout Transparente (Manter usuário no site)</label>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select name="gateway_pass_tax_to_client" class="form-control">
                                        <option value="0" {{ ($settings['gateway_pass_tax_to_client'] ?? 0) == 0 ? 'selected' : '' }}>Não (Absorver taxas)</option>
                                        <option value="1" {{ ($settings['gateway_pass_tax_to_client'] ?? 0) == 1 ? 'selected' : '' }}>Sim (Acrescer ao total)</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="tab-pane fade" id="tab-smtp" role="tabpanel">
                            ...
                            <div class="row">
                                <div class="col-md-6 form-group">
                                    ...
                                    <input name="smtp_cc" class="form-control" value="{{ $settings['smtp_cc'] ?? '' }}" placeholder="email@exemplo.com">
                                </div>
                                <div class="col-md-6 form-group">
                                    <label>Cópia Oculta (BCC)</label>
                                    <input name="smtp_bcc" class="form-control" value="{{ $settings['smtp_bcc'] ?? '' }}" placeholder="auditoria@exemplo.com">
                                </div>
                            </div>
                        ...
                        <div class="tab-pane fade" id="tab-social" role="tabpanel">
                            ...
                            <div class="card card-outline card-danger collapsed-card">
                                <div class="card-header">
                                    <h3 class="card-title"><i class="fab fa-google mr-1"></i> Google</h3>
                                     <div class="card-tools">
                                        <button type="button" class="btn btn-tool" data-card-widget="collapse"><i class="fas fa-plus"></i></button>
                                    </div>
                                </div>
                            ...
                            <div class="card card-outline card-primary collapsed-card">
                                <div class="card-header">
                                    <h3 class="card-title"><i class="fab fa-facebook mr-1"></i> Facebook</h3>
                                    <div class="card-tools">
                                        <button type="button" class="btn btn-tool" data-card-widget="collapse"><i class="fas fa-plus"></i></button>
                                    </div>
                                </div>
                            ...
                            <div class="card card-outline card-info collapsed-card">
                                <div class="card-header">
                                    <h3 class="card-title"><i class="fab fa-twitter mr-1"></i> Twitter / X</h3>
                                     <div class="card-tools">
                                        <button type="button" class="btn btn-tool" data-card-widget="collapse"><i class="fas fa-plus"></i></button>
                                    </div>
                                </div>
                                <div class="card-body" style="display: none;">
                                     <div class="custom-control custom-switch mb-3">
                                        ...
                                        <label class="custom-control-label" for="social_twitter_enabled">Ativar Login com Twitter</label>
                                    </div>
                                    <div class="row">
                        ...
                        <div class="tab-pane fade" id="tab-system" role="tabpanel">
                            ...
                            <div class="row">
                               <div class="col-md-6 form-group">
                                   ...
                                   <input name="allowed_video_formats" class="form-control" value="{{ $settings['allowed_video_formats'] ?? implode(',', config('uploads.allowed_video_formats', [])) }}" placeholder="mp4,webm,mkv">
                               </div>
                               <div class="col-md-6 form-group">
                                   <label>Formatos de Documento Permitidos</label>
                                   <input name="allowed_document_formats" class="form-control" value="{{ $settings['allowed_document_formats'] ?? implode(',', config('uploads.allowed_document_formats', [])) }}" placeholder="pdf,docx,pptx">
                               </div>
                            </div>
                            ...
                            <div class="card card-body bg-light">
                                <div class="row">
                                    <div class="col-md-6 form-group"><label>S3 Key</label><input name="s3_key"
                                            class="form-control" value="{{ $settings['s3_key'] ?? '' }}"></div>

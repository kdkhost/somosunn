            ...
            <div class="card-body">
                <div class="tab-content">
                    ...
                    <div class="tab-pane fade" id="tab-player" role="tabpanel">
                        <h5 class="text-primary mb-3"><i class="fas fa-play-circle mr-2"></i>Configurações do Player (Plyr)
                        </h5>
                        <div class="custom-control custom-switch custom-switch-off-danger custom-switch-on-success mb-3">
                            ...
                            <div class="col-md-4 form-group">
                                ...
                                <div class="input-group colorpicker-element">
                                    <input name="video_plyr_color" class="form-control"
                                        value="{{ $settings['video_plyr_color'] ?? ($settings['site_color_primary'] ?? '#007bff') }}">
                                    <div class="input-group-append">
                                        <span class="input-group-text"><i class="fas fa-square"
                                                style="color: {{ $settings['video_plyr_color'] ?? '#007bff' }}"></i></span>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4 form-group">
                        ...
                        <hr>
                        <h5 class="text-primary mb-3"><i class="fas fa-closed-captioning mr-2"></i>Marca d'água no Vídeo
                        </h5>
                        <div class="row">
                            <div class="col-md-6">
                                <div
                                    ...
                                    <label class="custom-control-label" for="video_watermark_enabled">Exibir Marca
                                        d'água</label>
                                </div>
                                <div class="form-group">
                    ...
                    <div class="tab-pane fade" id="tab-gateway" role="tabpanel">
                        ...
                        <div class="form-group">
                            ...
                            <input name="mercadopago_access_token" class="form-control"
                                value="{{ $settings['mercadopago_access_token'] ?? '' }}">
                        </div>
                        <div class="form-group">
                            <label>PagSeguro Token</label>
                            <input name="pagseguro_token" class="form-control"
                    ...
                    <div class="tab-pane fade" id="tab-social" role="tabpanel">
                        ...
                        <div class="row mt-3">
                            <div class="col-md-6">
                                ...
                                <input name="social_facebook_app_id" class="form-control"
                                    value="{{ $settings['social_facebook_app_id'] ?? '' }}">
                            </div>
                            <div class="col-md-6">
                                <label>Facebook App Secret</label>
                                <input name="social_facebook_app_secret" class="form-control"
                                    value="{{ $settings['social_facebook_app_secret'] ?? '' }}">
                            </div>
                        </div>
                    </div>

        ...
        <div class="card card-primary card-outline">
            <div class="card-body">
                ...
                <div class="d-flex flex-wrap gap-2">
                    ...
                    <a href="{{ route('admin.invoices.pdf', $invoice) }}" class="btn btn-sm btn-outline-primary" target="_blank">
                    ...
                    <a href="#" class="btn btn-sm btn-danger btn-delete" data-action="{{ route('admin.invoices.destroy', $invoice) }}" data-redirect="{{ route('admin.invoices.index') }}">
            ...
            <div class="card-body table-responsive p-0">
                <table class="table table-hover text-nowrap">
                    ...
                    <tbody>
                        @forelse($invoice->items->sortBy('sort_order') as $item)
                            <tr>
                                <td>
                                    ...
                                    @if($item->item_type)
                                        <div class="text-muted small">Tipo: {{ $item->item_type }}@if($item->item_id) #{{ $item->item_id }}@endif</div>
                                    @endif
                                </td>
                        ...
                        @empty
                            <tr><td colspan="4" class="text-center text-muted py-4">Nenhum item.</td></tr>
                        @endforelse
                    </tbody>
                </table>
            </div>

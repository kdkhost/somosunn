        ...
        <div class="card-body">
            ...
            <form method="POST"
                ...
                <div class="form-row">
                    <div class="form-group col-md-3">
                        ...
                        <select id="type" name="type" class="form-control @error('type') is-invalid @enderror">
                            <option value="online" {{ old('type', $mentorship->type) === 'online' ? 'selected' : '' }}>Online
                            </option>
                    ...
                    <div class="form-group col-md-3 video-platform-group">
                        ...
                        <select id="video_platform" name="video_platform"
                            ...
                            <option value="google_meet" {{ old('video_platform', $mentorship->video_platform) === 'google_meet' ? 'selected' : '' }}>Google Meet</option>
                    ...
                    <div class="form-group col-md-6 video-link-group">
                ...
                <div class="form-group">
                    ...
                    <input id="demo_link" name="demo_link" class="form-control @error('demo_link') is-invalid @enderror"
                        value="{{ old('demo_link', $mentorship->demo_link) }}" placeholder="Link para gravação ou demo">
                ...
                <div class="form-group">
                    ...
                    @error('schedule_json')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                    <small class="form-text text-muted">Dica: valide o JSON antes de salvar para facilitar uso no site e
                        API.</small>
                </div>

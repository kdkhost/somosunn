...
<div class="container-fluid">
    ...
    <div class="card card-outline card-primary shadow-sm">
        <div class="card-header">
            <h3 class="card-title"><i class="fas fa-chalkboard-teacher mr-2"></i>Gestão de Mentorias</h3>
        ...
        <div class="card-body">
            <p class="text-muted mb-3"><i class="fas fa-info-circle mr-1"></i>Cadastre e organize mentorias para exibição no site.</p>
                ...
                <table class="table table-hover align-middle mb-0">
                    <thead class="bg-light">
                        <tr>
                            ...
                            <th><i class="fas fa-book text-muted mr-1"></i>Título</th>
                            ...
                            <th style="width: 130px;"><i class="fas fa-coins text-muted mr-1"></i>Preço</th>
                        ...
                        @forelse($items as $item)
                            <tr>
                                ...
                                <td>
                                    ...
                                    @else
                                        <span class="badge badge-secondary"><i class="fas fa-user-slash mr-1"></i>Não definido</span>
                                    @endif
                                </td>
                                <td>
                                    @if($item->slots)
                                ...
                                <td class="text-right">
                                    ...
                                    <form action="{{ route('admin.mentorships.destroy', $item) }}" method="POST"
                                        ...
                                        <button class="btn btn-sm btn-outline-danger rounded-pill elevation-1" data-confirm-delete
                                            ...
                                            data-confirm-text="Esta ação não pode ser desfeita." title="Excluir">

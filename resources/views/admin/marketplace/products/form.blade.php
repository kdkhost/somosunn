    ...
    <form action="{{ $product->exists ? route('admin.marketplace.products.update', $product) : route('admin.marketplace.products.store') }}" method="POST" enctype="multipart/form-data" id="seller-product-form">
        ...
        <div class="row">
            <div class="col-xl-8">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title font-weight-bold">Dados principais</h3>
                    </div>
                    <div class="card-body">
                        <div class="form-row">
                ...
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title font-weight-bold">Entrega e logistica</h3>
                    </div>
                    <div class="card-body">
                        <div class="form-row">
            ...
            <div class="col-xl-4">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title font-weight-bold">Capa do produto</h3>
                    </div>
                    <div class="card-body">
                        @if($product->cover_url)
                            <img src="{{ $product->cover_url }}" alt="Capa" class="img-fluid rounded border mb-3">
                        @endif
                        <div class="form-group mb-2">
                            <input type="file" name="cover" accept="image/*" class="form-control-file @error('cover') is-invalid @enderror">
                ...
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title font-weight-bold">Galeria</h3>
                    </div>
                    <div class="card-body">
                                    ...
                                    <div class="col-sm-6 mb-3">
                                        <div class="border rounded p-2 h-100">
                                            @if($media->media_type === 'video')
                                                <video src="{{ $media->file_url }}" controls class="w-100 rounded mb-2" style="height: 120px; object-fit: cover;"></video>
                                            @else
                                                <img src="{{ $media->file_url }}" alt="Midia" class="img-fluid rounded mb-2" style="height: 120px; width: 100%; object-fit: cover;">
                                            @endif
                                            <form action="{{ route('admin.marketplace.products.media.destroy', [$product, $media]) }}" method="POST">
                                                @csrf
                                                @method('DELETE')
                                                <button type="submit" class="btn btn-sm btn-outline-danger btn-block">Remover</button>
                                            </form>
                                        </div>
                                    </div>
                                @endforeach

    ...
    function renderPreview(){
        try {
            ...
            <div style="background-color: #ffffff; width: 100%; font-family: sans-serif; box-sizing: border-box; display: flex; flex-direction: column;">
                <div style="${config.headerStyle} padding: 25px 20px; text-align: center; flex-shrink: 0;">
                    <img src="${config.logo}" alt="${config.siteName}" style="max-height: 50px; max-width: 100%; height: auto;">
                </div>
                ...
                <div style="background-color: #f8f9fa; padding: 15px; text-align: center; color: #777777; font-size: 11px; border-top: 1px solid #eeeeee; flex-shrink: 0;">
                    <p style="margin: 2px 0;">&copy; ${config.year} ${config.siteName}.</p>
                    <p style="margin: 2px 0;"><a href="${config.siteUrl}" style="color: ${config.primaryColor}; text-decoration: none;">Visite nosso site</a></p>
                </div>
            </div>
            `);
        } catch(e) {

        ...
        <table class="table table-striped">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="{{ route('admin.mailtemplates.edit', $t) }}" class="btn btn-sm btn-secondary">Editar</a>
                        <a href="#" onclick="preview({{ $t->id }})" class="btn btn-sm btn-info">Pré-visualizar</a>
                        <form action="{{ route('admin.mailtemplates.destroy', $t) }}" method="POST" style="display:inline">
                            @csrf
                            @method('DELETE')

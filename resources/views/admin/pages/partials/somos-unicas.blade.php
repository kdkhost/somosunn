    ...
    <div class="col-md-12 mb-4">
        <div class="card card-outline card-pink shadow-sm">
            <div class="card-header bg-light">
                <h3 class="card-title text-pink font-weight-bold">
                        ...
                        <div class="form-group mb-0">
                            ...
                            <div class="input-group">
                                <input type="color" name="theme_color" class="form-control form-control-color w-100"
                                    value="{{ $data['theme_color'] ?? '#db2777' }}" style="height: 45px;">
                            </div>
                            <small class="text-muted d-block mt-2">
                                Esta cor define a essência da área Somos Únicas (botões, detalhes e gradientes).
                            </small>
                        </div>
                    </div>
                </div>

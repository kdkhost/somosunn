...
<div class="tab-pane fade" id="sec-hero">
    <div class="card card-outline card-primary">
        ...
        <div class="card-body">
            ...
            <div class="form-group">
                <label>Missão / Visão</label>
                <textarea name="vision" rows="4" class="form-control">{{ old('vision', $data['vision'] ?? '') }}</textarea>
            </div>
            <div class="form-row">
                <div class="form-group col-md-6">
                    <label>Botão principal</label>
                    <input type="text" name="cta_btn_primary" class="form-control" value="{{ old('cta_btn_primary', $data['cta_btn_primary'] ?? '') }}">
                </div>
                <div class="form-group col-md-6">
                    <label>Botão secundário</label>
                    <input type="text" name="cta_btn_secondary" class="form-control" value="{{ old('cta_btn_secondary', $data['cta_btn_secondary'] ?? '') }}">
                </div>
            </div>
...
<div class="tab-pane fade" id="sec-history">
    <div class="card card-outline card-secondary">
        ...
        <div class="card-body">
            <div class="form-group">
                ...
                <input type="text" name="history_title" class="form-control" value="{{ old('history_title', $data['history_title'] ?? '') }}">
            </div>
            <div class="form-group">
                <label>Lead</label>
...
<div class="tab-pane fade" id="sec-diff">
    <div class="card card-outline card-secondary">
        <div class="card-header">
        ...
        <div class="card-body">
            <div class="form-group">
                <label>Título da seção</label>
                <input type="text" name="diff_title" class="form-control" value="{{ old('diff_title', $data['diff_title'] ?? '') }}">
            </div>
            <hr>
            @foreach ([1,2,3] as $i)
            <div class="form-row">

...
<head>
    ...
    <style>
        ...
        * {
        ...
        /* Iframes de conteúdo (YouTube, Vimeo etc) ficam responsivos,
           mas iframes de SDKs de pagamento NÃO devem ter height:auto
           pois isso quebra o layout interno (MercadoPago Brick, etc.) */
        iframe:not([id*="mercadopago"]):not([id*="paymentBrick"]):not([name*="mp"]):not([src*="mercadopago"]) {
            max-width: 100%;
            height: auto;
        }

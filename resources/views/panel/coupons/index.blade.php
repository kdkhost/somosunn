    ...
    <div class="max-w-5xl mx-auto">
        ...
        <div class="mb-4 flex justify-end">
            <a href="{{ route('panel.coupons.create') }}"
                class="bg-blue-700 text-white px-4 py-2 rounded hover:bg-blue-800 transition">Novo Cupom</a>
        </div>
                ...
                <div class="bg-white rounded-lg shadow p-6 flex flex-col">
                    ...
                    <div class="flex gap-2 mt-4">
                        ...
                        <form action="{{ route('panel.coupons.destroy', $coupon) }}" method="POST"
                            onsubmit="return confirmAction(event, 'Excluir cupom?', 'Tem certeza que deseja excluir este cupom?')">
                            @csrf
                            @method('DELETE')

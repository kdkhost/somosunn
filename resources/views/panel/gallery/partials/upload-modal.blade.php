<div id="gallery-upload-modal" class="fixed inset-0 z-[90] hidden">
    ...
    <div class="relative flex min-h-full items-center justify-center p-4 md:p-8">
        <div class="gallery-modal-panel relative w-full max-w-3xl overflow-hidden rounded-[2.2rem] border border-slate-200 bg-white shadow-[0_30px_80px_rgba(15,23,42,0.28)] dark:border-slate-800 dark:bg-slate-900">
            ...
            <form id="gallery-upload-form"
                        ...
                        <div id="gallery-dropzone"
                            ...
                            <div class="flex flex-col items-center justify-center text-center">
                                ...
                                <p class="mt-2 max-w-xl text-sm leading-7 text-slate-500 dark:text-slate-400">
                                    Clique na area abaixo ou solte varias imagens de uma vez. O envio suporta JPG, PNG e WEBP com ate 10 MB por arquivo.
                                </p>
                            ...
                            <div class="mt-6 hidden rounded-[1.4rem] border border-slate-200 bg-white p-4 dark:border-slate-800 dark:bg-slate-900" id="gallery-selected-files">
                                ...
                                <div id="gallery-selected-list" class="mt-4 grid gap-2 text-sm text-slate-500 dark:text-slate-400"></div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="rounded-[1.8rem] border border-slate-200 bg-slate-50 p-5 dark:border-slate-800 dark:bg-slate-950">
                            ...
                            <ul class="mt-4 space-y-3 text-sm leading-6 text-slate-500 dark:text-slate-400">
                                ...
                                <li class="flex gap-3">
                                    ...
                                    Cada arquivo aceita ate 10 MB no fluxo atual da galeria.
                                </li>
                                <li class="flex gap-3">
                                    <span class="mt-1 inline-flex h-5 w-5 items-center justify-center rounded-full bg-emerald-100 text-[10px] text-emerald-600 dark:bg-emerald-900/20 dark:text-emerald-300">
                                        <i class="fas fa-check"></i>
                ...
                <div class="mt-8 flex flex-col gap-3 border-t border-slate-100 pt-6 dark:border-slate-800 sm:flex-row sm:items-center sm:justify-end">
                    <button type="button"
                        data-gallery-close-upload

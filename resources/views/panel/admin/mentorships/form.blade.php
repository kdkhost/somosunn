    ...
    <div x-data="{ tab: 'general' }" class="space-y-6">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
                ...
                <p class="text-sm text-slate-500 mt-1">Configure os detalhes, preços e agenda da sua mentoria.</p>
            </div>
        ...
        <div class="bg-white p-1 rounded-2xl shadow-sm border border-slate-200 inline-flex items-center gap-1">
            ...
            <button @click="tab = 'schedule'"
                :class="tab === 'schedule' ? 'bg-blue-50 text-blue-600' : 'text-slate-500 hover:bg-slate-50 hover:text-slate-700'"
                class="px-4 py-2 rounded-xl text-sm font-semibold transition-all flex items-center gap-2">
            ...
            <div x-show="tab === 'general'" class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                <div class="lg:col-span-2 space-y-6">
                    <div class="bg-white p-8 rounded-3xl shadow-sm border border-slate-200 space-y-6">
                        <div>
                            <label class="block text-xs font-bold text-slate-400 uppercase mb-2">Título da Mentoria</label>
                        ...
                        <div>
                            ...
                            <textarea name="description" rows="10"
                                class="w-full px-4 py-3 bg-slate-50 border border-slate-200 rounded-2xl focus:ring-4 focus:ring-blue-500/10 focus:border-blue-500 outline-none transition-all text-slate-900 font-medium">{{ old('description', $mentorship->description) }}</textarea>
                        </div>
                    </div>
                </div>
                ...
                <div class="space-y-6">
                    ...
                    <div class="bg-white p-8 rounded-3xl shadow-sm border border-slate-200">
                        <label class="block text-xs font-bold text-slate-400 uppercase mb-4">Capa da Mentoria</label>
                        <div class="space-y-4">
                            <div
                    ...
                    {{-- Mentor Selection --}}
                    <div class="bg-white p-8 rounded-3xl shadow-sm border border-slate-200">
                        <label class="block text-xs font-bold text-slate-400 uppercase mb-4">Mentor Responsável</label>
            ...
            <div x-show="tab === 'pricing'" class="max-w-3xl space-y-6">
                <div class="bg-white p-8 rounded-3xl shadow-sm border border-slate-200">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            <label class="block text-xs font-bold text-slate-400 uppercase mb-2">Preço Normal (R$)</label>
                            <div class="relative">
                        ...
                        <div>
                            <label class="block text-xs font-bold text-slate-400 uppercase mb-2">Vagas Disponíveis</label>
                            <input type="number" name="slots" value="{{ old('slots', $mentorship->slots) }}"
                                class="w-full px-4 py-3 bg-slate-50 border border-slate-200 rounded-2xl focus:ring-4 focus:ring-blue-500/10 focus:border-blue-500 outline-none transition-all text-slate-900 font-bold text-lg"
                                placeholder="Ex: 10">
                        </div>
                    </div>

                    <div class="mt-8 p-6 bg-emerald-50 rounded-2xl border border-emerald-100 space-y-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                <label class="block text-xs font-bold text-emerald-600 uppercase mb-2">Preço
                                    Promocional</label>
                                <div class="relative">
                                    <span
                                        class="absolute left-4 top-1/2 -translate-y-1/2 text-emerald-400 font-bold">R$</span>
                                    <input type="text" name="flash_sale_price"
                                        ...
                                        class="mask-money w-full pl-12 pr-4 py-3 bg-white border border-emerald-200 rounded-2xl focus:ring-4 focus:ring-emerald-500/10 focus:border-emerald-500 outline-none transition-all text-emerald-900 font-bold text-lg">
                                </div>
                            </div>
                            <div>
                ...
                <div class="bg-white p-8 rounded-3xl shadow-sm border border-slate-200 space-y-8">
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        <div x-show="type === 'online'">
                            <label class="block text-xs font-bold text-slate-400 uppercase mb-2">Plataforma</label>
                        ...
                        <div x-show="type === 'online'" class="md:col-span-1">
                            <label class="block text-xs font-bold text-slate-400 uppercase mb-2">Link da Chamada</label>
                    ...
                    <div>
                        <label class="block text-xs font-bold text-slate-400 uppercase mb-2">Agenda (JSON)</label>
                        <textarea name="schedule_json" rows="8"
                            class="w-full px-4 py-3 bg-slate-50 border border-slate-200 rounded-2xl font-mono text-sm focus:ring-4 focus:ring-blue-500/10 focus:border-blue-500 outline-none transition-all text-slate-700"
                        ...
                        <p class="text-[10px] text-slate-400 mt-2 italic">* Use este campo para definir datas e horários
                            fixos das sessões.</p>
                    </div>
                </div>
            </div>
                        ...
                        <div class="space-y-6">
                            <div class="bg-white p-8 rounded-3xl shadow-sm border border-slate-200">
                                ...
                                <div class="space-y-6">
                                    ...
                                    <div>
                                        <label class="block text-xs font-bold text-slate-400 uppercase mb-2">Imagem de
                                            Fundo</label>
                                    ...
                                    <div>
                                        <label class="block text-xs font-bold text-slate-400 uppercase mb-2">Assinatura do
                                            Mentor</label>

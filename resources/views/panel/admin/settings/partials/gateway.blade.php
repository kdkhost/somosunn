<div class="space-y-6">
    ...
    <div class="border border-slate-200 rounded-3xl overflow-hidden">
        <div class="bg-slate-50 px-6 py-4 flex items-center justify-between cursor-pointer" onclick="toggleCard('mercadopago_card')">
            <h3 class="font-bold text-slate-800 flex items-center gap-2">
                <i class="fas fa-handshake text-blue-500"></i> MercadoPago
            </h3>
            <i class="fas fa-chevron-down text-slate-400 transition-transform" id="mercadopago_card_icon"></i>
        </div>
        <div id="mercadopago_card" class="hidden p-6 border-t border-slate-200">
            <div class="mb-6">
                <label class="block text-sm font-medium text-slate-700 mb-1">Ambiente de Execução</label>
                <select name="mercadopago_env" class="gateway-env-select w-full rounded-2xl border-slate-200 focus:border-blue-500 focus:ring-blue-500" data-gateway="mercadopago">
    ...
    <!-- PagSeguro -->
    <div class="border border-slate-200 rounded-3xl overflow-hidden">
        <div class="bg-slate-50 px-6 py-4 flex items-center justify-between cursor-pointer" onclick="toggleCard('pagseguro_card')">
            <h3 class="font-bold text-slate-800 flex items-center gap-2">
                <i class="fas fa-money-bill-wave text-green-500"></i> PagSeguro
            </h3>
            <i class="fas fa-chevron-down text-slate-400 transition-transform" id="pagseguro_card_icon"></i>
        </div>

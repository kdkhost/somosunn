<div class="grid grid-cols-1 md:grid-cols-2 gap-6">
    ...
    <div>
        <label class="block text-sm font-bold text-slate-700 dark:text-slate-300 mb-1 transition-colors">Razão Social /
            Nome da
            Empresa</label>
    ...
    <div>
        <label class="block text-sm font-bold text-slate-700 dark:text-slate-300 mb-1 transition-colors">Telefone /
            WhatsApp</label>
        <div class="relative">
    ...
    <div>
        <label class="block text-sm font-bold text-slate-700 dark:text-slate-300 mb-1 transition-colors">E-mail de
            Contato</label>
        <div class="relative">
            <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">

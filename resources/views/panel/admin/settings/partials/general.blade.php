<div class="grid grid-cols-1 md:grid-cols-2 gap-6">
    ...
    <div>
        <label class="block text-sm font-bold text-slate-700 mb-1">Nome do Site (App Name)</label>
    ...
    <div>
        <label class="block text-sm font-bold text-slate-700 mb-1">Razão Social / Nome da Empresa</label>
    ...
    <div>
        ...
        <div class="relative">
            ...
            <input type="text" name="company_phone" value="{{ $settings['company_phone'] ?? '' }}"
                ...
                class="pl-10 w-full rounded-2xl border-slate-400 bg-slate-50 focus:border-blue-600 focus:ring-2 focus:ring-blue-100 transition-all font-medium text-slate-800">
        </div>
    </div>

    <div>
        <label class="block text-sm font-bold text-slate-700 mb-1">E-mail de Contato</label>
        <div class="relative">
            <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
    ...
    <div class="md:col-span-2 grid grid-cols-1 md:grid-cols-3 gap-6">
        <div class="md:col-span-2">
            <label class="block text-sm font-bold text-slate-700 mb-1">Endereço (Rua/Av)</label>
    ...
    <div class="md:col-span-2 grid grid-cols-1 md:grid-cols-2 gap-6">
        <div>
            <label class="block text-sm font-bold text-slate-700 mb-1">Complemento</label>
            <input type="text" name="company_complement" value="{{ $settings['company_complement'] ?? '' }}"
                class="w-full rounded-2xl border-slate-400 bg-slate-50 focus:border-blue-600 focus:ring-2 focus:ring-blue-100 transition-all font-medium text-slate-800">
        </div>
        <div>
            <label class="block text-sm font-bold text-slate-700 mb-1">Bairro</label>
    ...
    <div class="md:col-span-2 grid grid-cols-1 md:grid-cols-2 gap-6">
        <div>
            <label class="block text-sm font-bold text-slate-700 mb-1">Cidade</label>
            <input type="text" name="company_city" value="{{ $settings['company_city'] ?? '' }}"
                class="w-full rounded-2xl border-slate-400 bg-slate-50 focus:border-blue-600 focus:ring-2 focus:ring-blue-100 transition-all font-medium text-slate-800">
        </div>
        <div>
            <label class="block text-sm font-bold text-slate-700 mb-1">Estado (UF)</label>

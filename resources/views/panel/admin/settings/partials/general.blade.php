<div class="grid grid-cols-1 md:grid-cols-2 gap-6">
    ...
    <div>
        <label class="block text-sm font-medium text-slate-700 mb-1">Nome do Site (App Name)</label>
    ...
    <div>
        <label class="block text-sm font-medium text-slate-700 mb-1">Razão Social / Nome da Empresa</label>
    ...
    <div>
        ...
        <div class="relative">
            ...
            <input type="text" name="company_phone" value="{{ $settings['company_phone'] ?? '' }}"
                ...
                class="pl-10 w-full rounded-2xl border-slate-200 focus:border-blue-500 focus:ring-blue-500">
        </div>
    </div>

    <div>
        <label class="block text-sm font-medium text-slate-700 mb-1">E-mail de Contato</label>
        <div class="relative">
            <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
    ...
    <div class="md:col-span-2 grid grid-cols-1 md:grid-cols-3 gap-6">
        <div class="md:col-span-2">
            <label class="block text-sm font-medium text-slate-700 mb-1">Endereço (Rua/Av)</label>

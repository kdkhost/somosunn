    ...
    <div class="bg-white dark:bg-slate-900 rounded-3xl shadow-sm border border-slate-100 dark:border-slate-800 p-8 space-y-6">
        <div class="flex items-center justify-between">
            <div class="flex items-center gap-3">
                ...
                <div>
                    <h3 class="font-bold text-slate-800 dark:text-white text-lg">Monetizacao (Anuncios)</h3>
                    <p class="text-xs text-slate-500 dark:text-slate-400 text-sm">Gerencie Adsense e codigos personalizados.</p>
                </div>
            </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8 pt-4">
            <div class="p-6 rounded-3xl bg-slate-50 dark:bg-slate-950 border border-slate-100 dark:border-slate-800 space-y-6">
                ...
                <div class="space-y-4">
                    <div>
                        <label class="block text-xs font-bold text-slate-500 uppercase tracking-wider mb-2">Publisher ID (Pub-ID)</label>
            ...
            <div class="p-6 rounded-3xl bg-slate-50 dark:bg-slate-950 border border-slate-100 dark:border-slate-800 space-y-4">
                <h4 class="font-bold text-slate-800 dark:text-white flex items-center gap-2">
                    <i class="fas fa-code text-blue-500"></i> Codigo personalizado
                </h4>
                <div class="h-full pb-8">
                    <textarea rows="9" placeholder="<!-- Cole aqui o script do seu ad network -->"
                        data-encoded-target="ads_code_html_encoded"
                        class="w-full h-full px-4 py-3 rounded-2xl border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-950 focus:border-blue-600 focus:ring-4 focus:ring-blue-500/10 outline-none transition-all font-mono text-xs text-slate-800 dark:text-slate-300 js-encoded-setting-source">{{ $settings['ads_code_html'] ?? '' }}</textarea>
    ...
    <div class="bg-white dark:bg-slate-900 rounded-3xl shadow-sm border border-slate-100 dark:border-slate-800 p-8 space-y-6">
        <div class="flex items-center justify-between">
            <div class="flex items-center gap-3">
                ...
                <h3 class="font-bold text-slate-800 dark:text-white text-lg">Anuncios no feed (Comunidade)</h3>
            </div>
            <div class="relative inline-flex items-center cursor-pointer">
                <input type="hidden" name="ads_inter_feed_enabled" value="0">
                <input type="checkbox" name="ads_inter_feed_enabled" id="ads_inter_feed_enabled" value="1" class="sr-only peer" {{ ($settings['ads_inter_feed_enabled'] ?? 0) ? 'checked' : '' }}>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div>
                <label class="block text-sm font-bold text-slate-700 dark:text-slate-300 mb-2">Frequencia (a cada X posts)</label>
            ...
            <div class="md:col-span-2">
                <label class="block text-sm font-bold text-slate-700 dark:text-slate-300 mb-2">Codigo para o feed (Opcional)</label>
                <textarea rows="2" placeholder="Se vazio, usara o global configurado acima."
                    data-encoded-target="ads_inter_feed_code_encoded"
                    class="w-full px-4 py-3 rounded-2xl border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-950 focus:border-blue-600 focus:ring-4 focus:ring-blue-500/10 outline-none transition-all font-mono text-xs text-slate-800 dark:text-slate-300 js-encoded-setting-source">{{ $settings['ads_inter_feed_code'] ?? '' }}</textarea>

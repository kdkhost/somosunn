<div class="space-y-8">
    ...
    <div
        ...
        <div class="rounded-3xl border border-blue-100 dark:border-blue-900/30 bg-blue-50/60 dark:bg-blue-900/10 p-6">
            <p class="text-sm font-semibold text-slate-800 dark:text-white">Armazenamento remoto desativado.</p>
            <p class="mt-2 text-sm text-slate-600 dark:text-slate-400">
                O sistema utiliza apenas armazenamento local em <code>public/storage</code> para todos os uploads.
            </p>
        </div>
    </div>

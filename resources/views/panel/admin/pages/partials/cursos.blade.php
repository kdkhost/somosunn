{{-- Partial: cursos (Tailwind Version) --}}
    ...
    <div class="p-8 space-y-6">
        <div class="space-y-2">
            ...
            <input type="text" name="hero_badge" value="{{ old('hero_badge', $data['hero_badge'] ?? '') }}"
                class="w-full bg-slate-50 dark:bg-slate-950 border-slate-200 dark:border-slate-800 rounded-2xl px-5 py-3 text-sm focus:ring-2 focus:ring-amber-500 transition-all font-bold text-amber-600 dark:text-amber-400 uppercase tracking-widest"
        ...
        <div class="space-y-2">
            ...
            <input type="text" name="hero_title" value="{{ old('hero_title', $data['hero_title'] ?? '') }}"
                class="w-full bg-slate-50 dark:bg-slate-950 border-slate-200 dark:border-slate-800 rounded-2xl px-5 py-3 text-sm focus:ring-2 focus:ring-amber-500 transition-all font-black uppercase tracking-tight"
        ...
        <div class="space-y-2">
            ...
            <textarea name="hero_subtitle" rows="4"
                class="w-full bg-slate-50 dark:bg-slate-950 border-slate-200 dark:border-slate-800 rounded-2xl px-5 py-3 text-sm focus:ring-2 focus:ring-amber-500 transition-all font-medium leading-relaxed"
        ...
        <div class="space-y-3 pt-4">
            <label class="text-sm font-bold text-slate-600 dark:text-slate-400 px-1 italic">Imagem de Destaque <small
                    class="text-slate-400 font-normal">(Thumbnail padrão)</small></label>

        ...
        <div class="space-y-6">
            ...
            <div class="flex justify-between items-center">
                <div>
                    ...
                    <p class="text-slate-500 text-sm">Gerencie as informações e permissões de acesso.</p>
                </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div class="lg:col-span-2 space-y-6">
                    <div class="bg-white rounded-3xl shadow-sm border border-slate-100 p-6 space-y-6">
                        <h3 class="font-bold text-lg text-slate-800 border-b border-slate-100 pb-2 mb-4">Dados Pessoais</h3>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                            ...
                            <div>
                                <label class="block text-sm font-bold text-slate-700 mb-1">
                                    Senha 
                                    @if($user->id) <span class="font-normal text-slate-400 text-xs ml-1">(deixe em branco para manter)</span> @endif
                                </label>
                    ...
                    <div class="bg-white rounded-3xl shadow-sm border border-slate-100 p-6">
                        <h3 class="font-bold text-lg text-slate-800 border-b border-slate-100 pb-2 mb-4">
                            ...
                            <span class="text-xs font-normal text-slate-400 ml-2">Liberar acesso individual a funcionalidades</span>
                        </h3>
                        
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                            @foreach($userFeatures as $key => $label)
                                <label class="flex items-start gap-3 p-3 rounded-xl border border-slate-200 hover:bg-slate-50 transition cursor-pointer group">
                                    ...
                                    <div class="flex flex-col">
                                        <span class="text-sm font-bold text-slate-700 group-hover:text-blue-700 transition">{{ $label }}</span>
                ...
                <div class="space-y-6">
                    ...
                    <div class="bg-white rounded-3xl shadow-sm border border-slate-200 p-6 space-y-4">
                        <h3 class="font-bold text-slate-800 mb-2">Controle de Acesso</h3>
                        
                        <div>
                            <label class="block text-sm font-bold text-slate-700 mb-1">Função (Role)</label>
                            <select name="role" class="w-full rounded-xl border-slate-400 bg-slate-50 focus:border-blue-600 focus:ring-2 focus:ring-blue-100 transition-all font-medium text-slate-800">
                            ...
                            <p class="text-xs text-slate-500 mt-1">Define o nível hierárquico no sistema.</p>
                        </div>

                        <div>
                            <label class="block text-sm font-bold text-slate-700 mb-1">Nível (Gamification)</label>
                            <select name="level" class="w-full rounded-xl border-slate-400 bg-slate-50 focus:border-blue-600 focus:ring-2 focus:ring-blue-100 transition-all font-medium text-slate-800">
                    ...
                    <!-- Plan Control -->
                    <div class="bg-white rounded-3xl shadow-sm border border-slate-200 p-6 space-y-4">
                        <h3 class="font-bold text-slate-800 mb-2">Plano e Assinatura</h3>
                        
                        <div>
                            <label class="block text-sm font-bold text-slate-700 mb-1">Plano Ativo</label>
                            <select name="plan_id" class="w-full rounded-xl border-slate-400 bg-slate-50 focus:border-blue-600 focus:ring-2 focus:ring-blue-100 transition-all font-medium text-slate-800">
                        ...
                        <div>
                            <label class="block text-sm font-bold text-slate-700 mb-1">Expira em</label>

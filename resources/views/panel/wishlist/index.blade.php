...
<div class="space-y-6">
    ...
    <div class="bg-white dark:bg-slate-900 rounded-3xl shadow-sm border border-slate-100 dark:border-slate-800 p-6 md:p-8">
        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <div>
                <p class="text-xs font-black uppercase tracking-[0.25em] text-slate-400">FAVORITOS</p>
                <h1 class="mt-2 text-2xl md:text-3xl font-black text-slate-900 dark:text-white">Minha Lista de Desejos</h1>
                <p class="mt-2 text-sm text-slate-500 dark:text-slate-400">Cursos que você salvou para ver depois.</p>
            </div>

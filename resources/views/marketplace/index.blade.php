            ...
            <div class="bg-white rounded-3xl border border-slate-100 shadow-sm p-5 md:p-6">
                <div class="flex flex-col lg:flex-row gap-4 lg:items-center lg:justify-between">
                    <div class="flex items-center gap-3">
                        <div
                            class="w-11 h-11 rounded-2xl btn-primary text-white flex items-center justify-center shadow-md">
                            <i class="fas fa-store"></i>
                        </div>
                        <div>
                            <div class="text-xl md:text-2xl font-black text-slate-900 leading-tight">Marketplace UNN</div>
                            <div class="text-xs md:text-sm text-slate-500 leading-tight">Produtos digitais de membros e
                                criadores</div>
                        </div>
                    </div>
                        ...
                        @if($q !== '')
                            <div class="mt-2 flex items-center justify-between gap-3 text-xs text-slate-500">
                                ...
                                <a href="{{ route('marketplace.index') }}"
                                    class="font-bold text-blue-700 hover:text-blue-800">Limpar busca</a>
                            </div>
                        @endif
                    </form>
                ...
                <div class="mt-4 flex flex-wrap gap-2">
                    ...
                    <a href="{{ route('courses.index') }}"
                        class="inline-flex items-center gap-2 rounded-full px-4 py-2 text-sm font-bold text-white btn-primary">
                    ...
                    <div class="mt-4 rounded-2xl border border-amber-200 bg-amber-50 p-4 text-amber-900">
                        ...
                        @if($isAdmin)
                            <div class="mt-2 text-xs text-amber-800">
                                Dica (admin): verifique as configurações em <span class="font-bold">Configurações &gt;
                                    Pagamentos</span>.
                            </div>
                        @endif
                    </div>
                ...
                <div class="bg-white md:rounded-3xl md:border border-slate-100 shadow-sm overflow-hidden">
                    @if($marketplaceHeroEnabled)
                        <div class="relative" data-marketplace-hero data-animation="{{ $marketplaceHeroAnimation }}"
                            data-autoplay="{{ $marketplaceHeroAutoplay ? 1 : 0 }}"
                            ...
                            @if($marketplaceHeroAnimation === 'fade')
                                ...
                                <div class="relative overflow-hidden">
                                    ...
                                    <div aria-hidden="true" class="block md:hidden" style="height:320px;"></div>
                                    ...
                                    @foreach($marketplaceHeroSlides as $idx => $slide)
                                        <div class="mp-hero-slide absolute inset-0 transition-opacity duration-700 ease-out {{ $idx === 0 ? 'opacity-100' : 'opacity-0 pointer-events-none' }}"
                                            ...
                                            <div class="block md:hidden h-full overflow-hidden px-3 pt-3">
                                                <div class="rounded-2xl overflow-hidden shadow-lg h-full flex flex-col"
                                                    style="border:1px solid rgba(59,130,246,0.2); background: linear-gradient(145deg, #ffffff 0%, #eff6ff 100%);">
                                                    @if(($slide['image'] ?? '') !== '')
                                                        <div style="height:170px; flex-shrink:0; overflow:hidden;">
                                                            <picture>
                                                    ...
                                                    <div class="px-4 pt-3 pb-4 flex flex-col flex-1">
                                                        @if(($slide['title'] ?? '') !== '')
                                                            <div class="text-lg font-black leading-tight mb-1" style="color:#0f2d6b;">
                                                                {{ $slide['title'] }}
                                                            </div>
                                                        @endif
                                                        @if(($slide['subtitle'] ?? '') !== '')
                                                            <div class="text-slate-500 text-sm mb-3 leading-snug flex-1">
                                                                {{ $slide['subtitle'] }}
                                                            </div>
                                                        @endif
                                                        @if(($slide['button_text'] ?? '') !== '' && ($slide['button_url'] ?? '') !== '')
                                                            <a href="{{ $slide['button_url'] }}"
                                                                class="block w-full text-center text-white font-black py-2.5 rounded-xl transition-all active:scale-95 text-sm"
                                                                style="background: linear-gradient(135deg, var(--unn-azul-1), var(--unn-azul-3)); box-shadow: 0 4px 12px rgba(59,130,246,0.35);">
                                                                {{ $slide['button_text'] }}
                                                            </a>
                                                        @endif
                                                    </div>
                                                ...
                                                @if(($slide['image'] ?? '') !== '')
                                                    <div class="absolute inset-0 liquid-bg-animate" style="z-index:0;">
                                                        <div class="absolute inset-0"
                                                            style="background-image: url('{{ $slide['image'] }}'); background-size:cover; background-position:center; filter:blur(80px); opacity:0.4; transform:scale(1.2);">
                                                        </div>
                                                    </div>
                                                @else
                                                    <div class="absolute inset-0"
                                    ...
                                    <div class="relative overflow-hidden">
                                        ...
                                        <div
                                                ...
                                                <div class="mp-hero-slide relative shrink-0 h-full"
                                                    ...
                                                    <div class="block md:hidden h-full overflow-hidden px-3 pt-3">
                                                        <div class="rounded-2xl overflow-hidden shadow-lg h-full flex flex-col"
                                                            ...
                                                            <div class="px-4 pt-3 pb-4 flex flex-col flex-1">
                                                                @if(($slide['title'] ?? '') !== '')
                                                                    <div class="text-lg font-black leading-tight mb-1" style="color:#0f2d6b;">{{ $slide['title'] }}</div>
                                                                @endif
                                                                @if(($slide['subtitle'] ?? '') !== '')
                                                                    <div class="text-slate-500 text-sm mb-3 leading-snug flex-1">{{ $slide['subtitle'] }}</div>
                                                                @endif
                                                                @if(($slide['button_text'] ?? '') !== '' && ($slide['button_url'] ?? '') !== '')
                                                                    <a href="{{ $slide['button_url'] }}"
                                                                        class="block w-full text-center text-white font-black py-2.5 rounded-xl transition-all active:scale-95 text-sm"
                                            ...
                                            @if(count($marketplaceHeroSlides) > 1)
                                                ...
                                                {{-- Dots DESKTOP: absolute no banner --}}
                                                <div
                                                    class="hidden md:flex absolute bottom-4 left-1/2 -translate-x-1/2 items-center gap-2 rounded-full bg-black/30 px-3 py-2 backdrop-blur">
                                                    @foreach($marketplaceHeroSlides as $idx => $slide)
                                                ...
                                                {{-- Dots MOBILE: em flow, abaixo do carrossel (não sobrepõe o card) --}}
                                                <div class="flex md:hidden items-center justify-center gap-2 py-2 mt-1">
                                                    @foreach($marketplaceHeroSlides as $idx => $slide)
                                                        <button type="button" data-hero-dot="{{ $idx }}"
                                                            class="w-2 h-2 rounded-full transition-all {{ $idx === 0 ? 'bg-blue-600 scale-110' : 'bg-slate-300' }}"
                                                            aria-label="Ir para o slide {{ $idx + 1 }}"></button>
                                                    @endforeach
                                                </div>
                                            @endif
                                ...
                                <div class="lg:col-span-3">
                                    ...
                                    <div class="mt-4">
                                        <a href="#marketplace-courses"
                                            class="inline-flex items-center gap-2 text-sm font-black text-blue-700 hover:text-blue-800">
                    ...
                    <section class="mt-6">
                        <div class="grid md:grid-cols-3 gap-4">
                            <div class="bg-white rounded-3xl border border-slate-100 shadow-sm p-6">
                                <div class="flex items-center gap-3">
                                    <div
                                        class="w-11 h-11 rounded-2xl bg-slate-50 border border-slate-200 text-blue-700 flex items-center justify-center">
                    ...
                    <section id="marketplace-courses" class="mt-10">
                        <div class="flex items-end justify-between gap-4 mb-4">
                            ...
                            <a href="{{ route('courses.index') }}" class="text-sm font-black text-blue-700 hover:text-blue-800">Ver
                                todos</a>
                        </div>
                                        ...
                                        <div class="aspect-[16/9] bg-slate-100 relative">
                                            ...
                                            @else
                                                ...
                                                <div class="relative w-full h-full flex items-center justify-center">
                                                    <div
                                                        class="w-16 h-16 rounded-2xl bg-white shadow flex items-center justify-center text-slate-400">
                    ...
                    <section id="marketplace-events" class="mt-12">
                        <div class="flex items-end justify-between gap-4 mb-4">
                            ...
                            <a href="{{ route('events.index') }}" class="text-sm font-black text-blue-700 hover:text-blue-800">Ver
                                todos</a>
                        </div>
                                ...
                                @if($marketplaceExitCoupon !== '')
                                    <div class="mt-5 rounded-2xl border border-emerald-200 bg-emerald-50 p-4">
                                        ...
                                        <div class="mt-2 flex items-center gap-2">
                                            <div
                                                class="flex-1 font-black text-emerald-900 bg-white rounded-xl border border-emerald-200 px-4 py-2">
                                ...
                                <div class="mt-6 flex flex-col sm:flex-row gap-2">
                                    @if($marketplaceExitButtonUrl !== '')
                                        <a href="{{ $marketplaceExitButtonUrl }}"
                                            ...
                                            {{ $marketplaceExitButtonText !== '' ? $marketplaceExitButtonText : 'Ver ofertas' }}
                                        </a>
                                    @endif
                                    <button type="button" data-exit-close

                    ...
                    @if($marketplaceHeroEnabled)
                        <div class="relative" data-marketplace-hero data-animation="{{ $marketplaceHeroAnimation }}"
                                                    ...
                                                    <div class="p-5">
                                                        ...
                                                        @if(($slide['button_text'] ?? '') !== '' && ($slide['button_url'] ?? '') !== '')
                                                            <a href="{{ $slide['button_url'] }}"
                                                                class="block w-full text-center bg-slate-900 text-white font-black py-3 rounded-xl transition-all active:scale-95 hover:bg-slate-700">
                                                                {{ $slide['button_text'] }}
                                                            </a>
                                                        @endif
                                                    </div>
                            ...
                            @if(count($marketplaceHeroSlides) > 1)
                                ...
                                <div
                                    class="absolute bottom-4 left-1/2 -translate-x-1/2 flex items-center gap-2 rounded-full bg-black/30 px-3 py-2 backdrop-blur">
                                    @foreach($marketplaceHeroSlides as $idx => $slide)

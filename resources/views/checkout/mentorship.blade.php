...
<div class="min-h-screen bg-slate-50 pt-28 pb-20 px-4">
    <div class="max-w-4xl mx-auto">
        <a href="{{ route('mentorships.show', $mentorship) }}" class="inline-flex items-center gap-2 text-gray-600 hover:text-blue-700 mb-6">
        ...
        <div class="grid md:grid-cols-3 gap-8">
            ...
            <div class="md:col-span-2">
                <div class="bg-white rounded-2xl shadow-lg p-6 md:p-8">
                    ...
                    <form action="{{ route('mentorships.checkout.process', $mentorship) }}" method="POST" class="space-y-6">
                        @csrf

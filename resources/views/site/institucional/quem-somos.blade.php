    ...
    <div class="bg-gradient-to-br from-slate-50 to-blue-50 min-h-screen">
        ...
        <section class="py-16 px-6 md:px-12 lg:px-24">
            <div class="max-w-7xl mx-auto">
                <h2 class="text-3xl font-black text-gray-900 mb-12 text-center">{{ $foundersTitle }}</h2>

                <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                    @foreach($foundersItems as $founder)
                        <div class="bg-white rounded-3xl shadow-lg overflow-hidden text-center">
                            ...
                            <div class="p-6">
                                <h3 class="text-xl font-bold text-gray-900 mb-1">{{ $founder['name'] ?? '' }}</h3>
                                <p class="text-sm mb-3" style="color: var(--unn-azul-1)">{{ $founder['role'] ?? '' }}</p>
                                <p class="text-gray-600 text-sm">{{ $founder['bio'] ?? '' }}</p>
                            </div>
                        </div>
                    @endforeach
                </div>
        ...
        <section class="py-16 px-6 md:px-12 lg:px-24 bg-white">
            <div class="max-w-7xl mx-auto">
                <h2 class="text-3xl font-black text-gray-900 mb-12 text-center">{{ $teamTitle }}</h2>
        ...
        <section class="py-16 px-4 md:px-12 lg:px-24">
            <div class="max-w-7xl mx-auto">
                <h2 class="text-3xl font-black text-gray-900 mb-8 md:mb-12 text-center">{{ $numbersTitle }}</h2>

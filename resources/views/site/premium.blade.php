...
<div class="bg-gradient-to-br from-slate-50 to-blue-50 min-h-screen">
            ...
            <div class="grid lg:grid-cols-2 gap-12 items-center">
                <div>
                    ...
                    <p class="text-xl text-gray-600 leading-relaxed mb-8">
                        Escolha o plano ideal para você e desbloqueie todo o potencial da maior comunidade de networking do Brasil.
                    </p>
    ...
    <section class="py-16 px-6 md:px-12 lg:px-24" id="planos">
        <div class="max-w-7xl mx-auto">
            <div class="text-center mb-12">
                ...
                <p class="text-gray-600 max-w-2xl mx-auto">Todos os planos incluem acesso à comunidade. Quanto maior o plano, mais recursos exclusivos.</p>
            </div>
            ...
            <div class="grid md:grid-cols-3 gap-8">
                ...
                <div class="bg-white rounded-3xl p-6 md:p-8 shadow-lg">
                    ...
                    <p class="text-gray-500 mb-8">Para quem quer conhecer a comunidade</p>
                    ...
                    <ul class="space-y-4 mb-8">
                        ...
                        <li class="flex items-center gap-3 text-gray-400">
                            ...
                            <span class="line-through">Mentorias exclusivas</span>
                        </li>
                        <li class="flex items-center gap-3 text-gray-400">
                            <i class="fas fa-times"></i>
                            <span class="line-through">Cursos premium</span>
                        </li>
                    </ul>
                    
                    <a href="{{ route('register') }}" class="block w-full text-center py-4 rounded-xl font-bold border-2 transition hover:bg-slate-50" style="border-color: var(--unn-azul-1); color: var(--unn-azul-1)">
                        Começar grátis
                    </a>
                </div>
                ...
                <div class="bg-white rounded-3xl p-6 md:p-8 shadow-2xl ring-2 relative" style="--tw-ring-color: var(--unn-azul-1)">
                    ...
                    <div class="mb-2">
                        <span class="text-5xl font-black" style="color: var(--unn-azul-1)">R$ 97</span>
                        <span class="text-gray-500">/mês</span>
                    </div>
                    <p class="text-xs text-gray-400 mb-6">ou R$ 970/ano (economize 2 meses)</p>
                    <p class="text-gray-500 mb-8">Para empreendedores em crescimento</p>
                    ...
                    <a href="{{ route('register') }}" class="block w-full text-center py-4 btn-primary text-white rounded-xl font-bold shadow-lg hover:shadow-xl transition">
                        Assinar Premium
                    </a>
                </div>
                ...
                <div class="bg-white rounded-3xl p-6 md:p-8 shadow-lg">
                    ...
                    <p class="text-xs text-gray-400 mb-6">ou R$ 2.970/ano (economize 2 meses)</p>
                    <p class="text-gray-500 mb-8">Para empresas e times</p>
                    ...
                    <ul class="space-y-4 mb-8">
                        ...
                        <li class="flex items-center gap-3 text-gray-600">
                            <i class="fas fa-check text-green-500"></i>
                            <strong>5 usuários inclusos</strong>
                        </li>
                        <li class="flex items-center gap-3 text-gray-600">
                            <i class="fas fa-check text-green-500"></i>
                            Mentoria 1:1 mensal
                    ...
                    <a href="{{ route('contato') }}" class="block w-full text-center py-4 rounded-xl font-bold border-2 transition hover:bg-slate-50" style="border-color: var(--unn-azul-1); color: var(--unn-azul-1)">
                        Falar com vendas
                    </a>
                </div>
            </div>
                ...
                <table class="w-full">
                    <thead>
                        <tr class="border-b border-gray-100">
                            ...
                            <th class="text-center p-6 font-bold" style="background: var(--unn-azul-1); color: white">Premium</th>
                    ...
                    <tbody class="text-sm">
                        <tr class="border-b border-gray-50">
                            ...
                            <td class="text-center p-4" style="background: var(--unn-azul-1)10"><i class="fas fa-check text-green-500"></i></td>
                            <td class="text-center p-4"><i class="fas fa-check text-green-500"></i></td>
                        </tr>
                        <tr class="border-b border-gray-50">
                            <td class="p-4 text-gray-700">Conexões por mês</td>
                            <td class="text-center p-4 text-gray-500">5</td>
                            <td class="text-center p-4 font-bold" style="background: var(--unn-azul-1)10">Ilimitadas</td>
                        ...
                        <tr class="border-b border-gray-50">
                            ...
                            <td class="text-center p-4"><i class="fas fa-times text-gray-300"></i></td>
                            <td class="text-center p-4" style="background: var(--unn-azul-1)10"><i class="fas fa-times text-gray-300"></i></td>
    ...
    <section class="py-16 px-6 md:px-12 lg:px-24" style="background: linear-gradient(135deg, var(--unn-azul-1), var(--unn-azul-3))">
        <div class="max-w-4xl mx-auto text-center text-white">
            ...
            <p class="text-lg opacity-90 mb-8">Junte-se a milhares de empreendedores que já transformaram seus negócios.</p>
            <div class="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <a href="#planos" class="inline-flex items-center justify-center gap-2 border-2 border-white text-white px-8 py-4 rounded-full font-bold hover:bg-white/10 transition">
                    Ver todos os planos
                </a>
            </div>
        </div>

...
- **Preview de E-mail em Tempo Real (24/03):** Implementada a funcionalidade de pré-visualização instantânea no editor de modelos de e-mail do painel moderno (Tailwind). Ambos os painéis (Moderno e Legado) agora utilizam a nova lógica de design dinâmico (Sólido/Degradê) para renderizar o e-mail no ato da edição, garantindo paridade visual total com o e-mail final disparado pelo sistema.
